...
export const PLANT_TRANSLATIONS = {
  ar: {
    ...
    eucalyptus: {
      ...
      shortDescription: 'أوراق يوكاليبتوس غنية بـ 1،8-سينيول (إيكاليبتول) بتأثير ثلاثي: حالّ للمخاط ومزيل للاحتقان ومضاد للميكروبات؛ يُرقّق المخاط، يُسرّع التخليص الهدبي، ويُخفّف احتقان الأنف وضغط الجيوب الأنفية.',
      activeConstituents: [
        { name: '1،8-سينيول (الإيكاليبتول)', detail: 'يعمل كعامل حالّ للمخاط ومُوسِّع للأوعية. يُرقِّق المخاط، ويزيد تردد ضربات الأهداب لتسريع التخليص الهدبي للمخاط، ويمتلك خصائص مضادة للالتهاب وخفيفة مضادة للميكروبات.' },
      ],
      moa: [
        { title: 'عامل حالّ للمخاط ومُوسِّع للأوعية', detail: 'يُرقِّق المخاط ويزيد تردد ضربات الأهداب لتسريع التخليص الهدبي للمخاط.' },
        { title: 'مضاد للالتهاب ومضاد للميكروبات', detail: 'يمتلك خصائص مضادة للالتهاب وخفيفة مضادة للميكروبات.' },
      ],
      uses: ['التخفيف العرضي من احتقان الأنف وضغط الجيوب الأنفية والنزلة الحادة في الجهاز التنفسي العلوي.'],
      howToUse: [
        { method: 'الاستنشاق', instruction: 'استنشاق الزيت الأساسي (3-12 قطرة في ماء متبخر).' },
        { method: 'الفموي', instruction: 'عن طريق الفم عبر كبسولات معوية موحَّدة.' },
      ],
      suitableAgeGroups: [
        { group: 'البالغون', notes: 'آمن بشكل عام للاستخدام الموضعي والاستنشاق والفموي عند التخفيف الصحيح.' },
        { group: 'الأطفال', notes: 'مُحظَر على الأطفال أقل من سنتين بسبب خطر التشنج الحنجري أو القصبي. الاستنشاق بالبخار غير موصى به للأطفال أقل من 12 سنة دون إشراف طبي.' },
        { group: 'الحمل والرضاعة', notes: 'غير موصى به. لم تثبت السلامة سريرياً أثناء الحمل والرضاعة؛ تجنبي الاستخدام دون مشورة طبية صريحة.' },
        { group: 'الأمراض المزمنة', notes: 'يُستخدم بحذر لدى مرضى الربو أو فرط تحسس مجاري التنفس الشديد.' },
      ],
      dosage: { standard: 'فموياً: 100-200 ملغ من سينيول 2-3 مرات يومياً. استنشاقاً: 3-12 قطرة من الزيت الأساسي النقي في ماء متبخر، حتى 3 مرات يومياً.' },
      overdose: {
        intro: 'ابتلاع الزيت الأساسي النقي غير المُخفَّف شديد السمية.',
        symptoms: [
          'اضطرابات معدية معوية (حرقان شرسوفي، غثيان، قيء، إسهال).',
          'اكتئاب الجهاز العصبي المركزي (دوار، نعاس، رنح، غيبوبة).',
          'اكتئاب تنفسي.',
          'تقبُّض الحدقة (حدقة دبوسية).',
        ],
        management: ['الرعاية الطبية الفورية إلزامية. تشمل الإدارة الدعم العرضي ومراقبة العناية المركزة وغسل المعدة إذا أُمسك مبكراً.'],
      },
      sideEffects: [
        'غثيان أو قيء أو إسهال (عند الإعطاء الفموي).',
        'تهيج جلدي موضعي أو تفاعلات فرط حساسية (عند التطبيق الموضعي).',
      ],
      contraindications: [
        'فرط الحساسية لزيت اليوكاليبتوس.',
        'الأطفال أقل من سنتين.',
        'الأمراض الالتهابية للجهاز الهضمي أو المرارة (اضطرابات صفراوية).',
        'أمراض الكبد الشديدة.',
      ],
      drugInteractions: [],
      storage: {
        forms: [{ form: 'التخزين', instructions: 'يُخزَّن في حاويات زجاجية محكمة مقاومة للضوء في مكان بارد، بعيداً عن متناول الأطفال.' }],
      },
      benefits: [],
      factsAndMyths: [
        {
          fact: '1،8-سينيول مُثبَت سريرياً (استخدام راسخ من وكالة الدواء الأوروبية) في تقليل صداع الجيوب الأنفية وانسداد الأنف والإفرازات بشكل ملحوظ.',
          myth: 'الكميات الأكبر أفضل؛ وضع زيت اليوكاليبتوس النقي غير المُخفَّف مباشرةً في فتحتي الأنف قد يُسبب حروقاً كيميائية حادة للغشاء المخاطي الدقيق للأنف ويُشلّ الأهداب.',
        },
      ],
      botanicalFacts: {
        family: 'الآسية (Myrtaceae)',
        activeCompounds: '1،8-سينيول (الإيكاليبتول)',
      ...
      references: [
        { text: 'European Medicines Agency (EMA) – Committee on Herbal Medicinal Products (HMPC). (2014). European Union herbal monograph on Eucalyptus globulus Labill., aetheroleum. (EMA/HMPC/307781/2012).' },
      ],
    },
    'ginger-cold': {
      name: 'الزنجبيل',

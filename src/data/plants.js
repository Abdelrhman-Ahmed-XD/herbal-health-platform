...
export const PLANTS = {
  ...
  'rocket': {
    ...
    activeConstituents: [
      ...
      { name: 'Flavonoids (Quercetin, Kaempferol, Isorhamnetin)', percentage: '', effect: 'Antioxidant protection of follicular cells; reduce oxidative stress linked to hair loss; anti-inflammatory modulation within the scalp microenvironment' },
    ],
    moa: [
    ...
    references: [
      { text: 'Nurzynska-Wierdak, R. (2022). Bioactive compounds of Brassicaceae plants and their potential health benefits. Molecules.' },
  ...
  'garlic': {
    ...
    references: [
      ...
      { text: 'Martins, N., et al. (2016). Chemical composition and biological properties of garlic as affected by cooking methods. Food and Chemical Toxicology, 93, 42–53.' },
      { text: 'World Health Organization (WHO). WHO Monographs on Selected Medicinal Plants, Volume 1: Bulbus Allii Sativi.' },
      { text: 'Benavides, G. A., et al. (2007). Hydrogen sulfide mediates the vasoactivity of garlic. Proceedings of the National Academy of Sciences (PNAS), 104(46), 17977–17982.' },
      ...
      { text: 'Borrelli, F., et al. (2007). Garlic (Allium sativum L.): Adverse effects and drug interactions in humans. Molecular Nutrition & Food Research, 51(11), 1386–1397.' },
      { text: 'PubMed Central — Garlic and urinary tract.', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC7146530' },
      ...
      { text: 'Drugs.com — Garlic.', url: 'https://www.drugs.com/mtm/garlic.html' },
    ],
  },
  ...
  'thyme': {
    ...
    warnings: [
      'Pure thyme essential oil is highly concentrated: always dilute before use; never ingest undiluted essential oil.',
      'Thyroid conditions: thyme volatile compounds may interfere with thyroid hormone metabolism: use with caution and monitor.',
      'Pregnancy: culinary amounts are safe; concentrated therapeutic extracts and essential oil should be avoided.',
      'Allergy to Lamiaceae family (mint, rosemary, lavender, oregano): cross-reactivity to thymol possible.',
    ],
    activeConstituents: [
      { name: 'Thymol (30–70% of essential oil)', effect: 'Primary phenolic monoterpene; disrupts bacterial and fungal cell membranes; enhances mucociliary clearance; bronchospasmolytic via calcium channel blockade.' },
      { name: 'Carvacrol (3–15%), p-Cymene, Linalool', effect: 'Supplementary antimicrobial, anti-inflammatory, and antispasmodic terpenes that synergize with thymol.' },
      { name: 'Flavonoids (Luteolin, Apigenin, Thymonin, Eriodictyol)', effect: 'Anti-inflammatory and antioxidant polyphenols; bronchospasmolytic activity independent of volatile oil fraction.' },
      { name: 'Rosmarinic Acid (Phenolic Acid)', effect: 'Potent antioxidant and anti-inflammatory; inhibits pro-inflammatory leukotrienes and prostaglandins in the respiratory mucosa.' },
      { name: 'Saponins', effect: 'Contribute to secretolytic (mucolytic) activity; reduce mucus surface tension aiding expectoration.' },
    ],
    moa: [
      { title: 'Spasmolytic & Bronchodilatory', detail: 'Thymol and flavonoids relax bronchial smooth muscle via dual mechanisms: calcium channel blockade and mild beta-2 adrenergic agonism, reducing cough-triggering bronchoconstriction and airway resistance.' },
      { title: 'Secretomotoric & Mucolytic (Expectorant)', detail: 'Stimulates bronchial gland secretion, increases the fluid content of mucus, and reduces viscosity, facilitating productive cough to clear airways. Saponins reduce mucus surface tension, aiding expectoration via mucociliary escalator.' },
      { title: 'Antiseptic (Membrane Disruption)', detail: 'Thymol and carvacrol disrupt bacterial and fungal cell membranes, providing broad-spectrum antimicrobial activity against respiratory pathogens including Streptococcus pyogenes, Haemophilus influenzae, and Klebsiella pneumoniae.' },
    ],
    uses: [
      'Acute bronchitis and productive cough: primary evidence-based indication (EMA-approved traditional herbal medicine)',
      'Upper respiratory tract infections (colds, pharyngitis, laryngitis)',
      'Whooping cough (pertussis): adjunct supportive traditional use',
      'Oral hygiene: thymol is an active ingredient in antiseptic mouthwashes (e.g., Listerine)',
    ],
    howToUse: [
      { method: 'Thyme Tea (Aqueous Infusion)', instruction: 'Steep 1–2 g dried thyme leaves in 150 mL boiling water for 10 minutes, covered. Drink 3–4 times daily. Add honey and lemon to enhance the soothing and antimicrobial effect.' },
      { method: 'Standardized Syrup / Liquid Extract', instruction: 'Adults and adolescents (>12 years): 1–2 mL standardized liquid extract, 2–3 times daily, or as indicated on the product label (e.g., Thymotal, Thymy Syrup). Children (4–12 years): 2.5–5 mL pediatric syrup, 3 times daily.' },
    ],
    suitableAgeGroups: [
      { group: 'Adults & Adolescents (>12 years)', notes: 'Well-tolerated at therapeutic doses: 1–2 g infusion or 1–2 mL liquid extract, 3–4× daily.' },
      { group: 'Children (4–12 years)', notes: 'Pediatric syrups (e.g., Thymy Syrup): 2.5–5 mL 3× daily under supervision. Diluted mild infusions also appropriate.' },
      { group: 'Children (<4 years)', notes: 'Avoid concentrated therapeutic preparations; culinary thyme in food is safe.' },
      { group: 'Pregnancy', notes: 'Culinary amounts safe. Concentrated extracts and essential oil avoided as precaution.' },
    ],
    dosage: {
      standard: 'Adults: 1–2 g dried herb per 150 mL infusion, 3–4× daily; or 1–2 mL liquid extract 3× daily. Children (4–12 years): 2.5–5 mL pediatric syrup 3× daily.',
      forms: [
        { form: 'Dried Herb Infusion (Adults)', dose: '1–2 g steeped 10 min (covered) in 150 mL boiling water, 3–4× daily.' },
        { form: 'Standardized Liquid Extract (Adults)', dose: '1–2 mL, 3× daily.' },
        { form: 'Pediatric Syrup (Children 4–12 years)', dose: '2.5–5 mL, 3× daily.' },
      ],
    },
    overdose: {
      symptoms: [
        'GI irritation, nausea, and vomiting at high doses of essential oil or concentrated extract.',
        'Rare: thyroid function disruption with excessive prolonged use of high-dose volatile oil preparations.',
        'Allergic contact reactions in Lamiaceae-sensitive individuals.',
      ],
      management: [
        'Discontinue immediately. Symptomatic support and oral hydration.',
        'Seek medical advice if GI symptoms are severe or if thyroid symptoms develop with long-term use.',
      ],
    },
    sideEffects: [
      'GI irritation or mild heartburn at high doses',
      'Rare allergic skin reactions (urticaria, contact dermatitis) in Lamiaceae-sensitive individuals',
      'Potential mild thyroid effects with excessive prolonged intake',
    ],
    contraindications: [
      'Known hypersensitivity to Thymus vulgaris or other Lamiaceae family members',
      'Active uncontrolled thyroid conditions: monitor thyroid function',
      'Children under 4 years: avoid concentrated therapeutic preparations',
    ],
    drugInteractions: [
      'Thyroid medications (levothyroxine): potential interaction at high doses: monitor thyroid function.',
      'Anticoagulants (Warfarin): theoretical mild antiplatelet effect at therapeutic doses: standard monitoring recommended.',
    ],
    storage: {
      forms: [
        { form: 'Dried Herb', storage: 'Airtight containers in cool, dark place below 25°C to preserve volatile thymol content.' },
        { form: 'Essential Oil / Liquid Extract', storage: 'Hermetically sealed dark amber glass bottles to prevent thymol oxidation.' },
      ],
    },
    marketedProducts: [
    ...
    benefits: [
      { icon: 'air', title: 'Triple-Action Bronchodilatory', desc: 'Simultaneously acts as bronchodilator (Ca channel + β2 agonism), mucolytic (reduces mucus viscosity), and antiseptic, addressing the full cough-bronchitis cycle in one plant.' },
      { icon: 'water_drop', title: 'Secretomotoric Expectorant', desc: 'Stimulates bronchial gland secretion and reduces mucus surface tension via saponins, enabling productive cough to clear airways efficiently without sedation.' },
      { icon: 'shield', title: 'Broad-Spectrum Antimicrobial', desc: 'Thymol disrupts the membranes of Streptococcus, Haemophilus, and Klebsiella, reducing respiratory bacterial load while flavonoids suppress mucosal inflammation simultaneously.' },
    ],
    botanicalFacts: {
      origin: 'Native to the Mediterranean region and southern Europe. Naturalized worldwide as a culinary and medicinal herb.',
  ...
  'anise': {
    ...
    warnings: [
      'Anise oil (pure essential oil) is neurotoxic at high doses: can cause epileptiform seizures and CNS excitation. Never ingest undiluted anise essential oil.',
      'Apiaceae/anethole allergies: may cross-react with fennel, sweet fennel, carrot, celery, and parsley.',
      'Pregnancy: avoid concentrated therapeutic doses and essential oil: mild uterine stimulant at high doses.',
      'Infants and children under 4 years: do not give concentrated anise preparations: potential CNS and respiratory effects from anethole.',
    ],
    activeConstituents: [
      { name: 'Trans-anethole (80–90% of volatile oil)', effect: 'Primary secretolytic and antispasmodic compound; stimulates ciliated bronchial epithelial cells; mild estrogenic properties at very high doses.' },
      { name: 'Estragole (Methyl Chavicol, 1–5%), Pseudoisoeugenol, Phenylpropanoids', effect: 'Antispasmodic and antimicrobial secondary phenylpropanoids complementing anethole.' },
      { name: 'Flavonoid Glycosides (Quercitrin, Rutin, Isoquercitrin, Luteolin)', effect: 'Anti-inflammatory and antioxidant polyphenols; contribute additional bronchospasmolytic activity.' },
      { name: 'Coumarins (Umbelliferone, Scopoletin)', effect: 'Antispasmodic and mild bronchodilatory activity; umbelliferone also has antimicrobial properties.' },
    ],
    moa: [
      { title: 'Secretolytic (Stimulates Ciliated Epithelium)', detail: 'Trans-anethole stimulates ciliated bronchial epithelial cells to increase mucus secretion and fluid content, reducing viscosity and facilitating expectoration via the mucociliary escalator.' },
      { title: 'Antispasmodic (Smooth Muscle Relaxant)', detail: 'Anethole and coumarins relax bronchial and intestinal smooth muscle via calcium channel blockade and mild beta-2 adrenergic agonism, reducing cough-associated bronchospasm and intestinal cramping.' },
      { title: 'Demulcent (Mucosal Coating)', detail: 'Volatile oil components form a thin soothing layer over the pharyngeal and bronchial mucosa, reducing irritation at cough receptor level and alleviating dry or irritative cough.' },
    ],
    uses: [
      'Secretolytic expectorant for productive cough and acute bronchitis (EMA-recognized traditional indication)',
      'Symptomatic relief of upper respiratory tract infections and bronchospasm',
      'Carminative for bloating, flatulence, and GI smooth muscle spasms',
    ],
    howToUse: [
      { method: 'Anise Infusion (Yansoon Tea)', instruction: 'Crush 1–3.5 g anise seeds lightly. Steep in 150 mL boiling water, covered, for 10–15 minutes. Strain and sweeten with honey. Drink 3 times daily. Inhale the steam during brewing for added airway benefit. Children (4–12 years): 0.5–1 g per cup, 2–3 times daily.' },
      { method: 'Standardized Syrup', instruction: 'Adults: as directed on product label, typically 10–15 mL 2–3× daily. Observe label instructions for pediatric dosing of anise-containing syrups (e.g., Anisron, Pentamix).' },
    ],
    suitableAgeGroups: [
      { group: 'Adults', notes: 'Appropriate at standard therapeutic doses: 1–3.5 g seed infusion, 3× daily.' },
      { group: 'Children (4–12 years)', notes: 'Mild infusion: 0.5–1 g per cup, 2–3× daily. Standardized pediatric syrups under supervision. Do not give anise essential oil to children.' },
      { group: 'Infants (<4 years)', notes: 'Avoid all concentrated anise preparations. Culinary trace amounts in food are safe.' },
      { group: 'Pregnancy', notes: 'Culinary amounts safe. Concentrated therapeutic doses and essential oil strictly avoided.' },
    ],
    dosage: {
      standard: 'Adults: 1–3.5 g crushed seeds per 150 mL infusion, 3× daily. Children (4–12 years): 0.5–1 g per cup, 2–3× daily.',
      forms: [
        { form: 'Crushed Seed Infusion (Adults)', dose: '1–3.5 g crushed seeds steeped 10–15 min (covered), 3× daily.' },
        { form: 'Crushed Seed Infusion (Children 4–12 years)', dose: '0.5–1 g per 150 mL, 2–3× daily.' },
        { form: 'Standardized Syrup', dose: 'Adults: as per product label (e.g., Anisron Syrup 120 mL). Follow pediatric label instructions for children.' },
      ],
    },
    overdose: {
      symptoms: [
        'High doses of pure anise essential oil: neurotoxic epileptiform effects including convulsions, CNS excitation, nausea, and vomiting.',
        'GI irritation, nausea, and abdominal cramping at very high infusion doses.',
        'Mild estrogenic effects at extremely prolonged high-dose intake (anethole).',
      ],
      management: [
        'Essential oil overdose: immediate medical emergency. Do not induce vomiting. Support airway. Seek emergency care for seizure management.',
        'Infusion overdose: discontinue. Symptomatic support, oral hydration.',
      ],
    },
    sideEffects: [
      'GI irritation at high doses',
      'Rare allergic reactions in Apiaceae-sensitive individuals (urticaria, contact dermatitis)',
      'Theoretical mild estrogenic effects at very prolonged high doses (anethole)',
    ],
    contraindications: [
      'Known hypersensitivity to Pimpinella anisum or Apiaceae family (carrots, celery, fennel, parsley)',
      'Estrogen-sensitive conditions (e.g., estrogen-receptor positive tumors): theoretical mild estrogenic effect of anethole at therapeutic doses',
      'Epilepsy or seizure disorders: anise essential oil is neurotoxic at high doses',
    ],
    drugInteractions: [
      'Anticoagulants (Warfarin): theoretical mild anticoagulant interaction at high doses: standard monitoring.',
      'Estrogen therapies / oral contraceptives: theoretical mild additive estrogenic effect at very high doses.',
    ],
    storage: {
      forms: [
        { form: 'Whole/Crushed Seeds', storage: 'Airtight containers in cool, dark place below 25°C to preserve volatile anethole content.' },
        { form: 'Essential Oil', storage: 'Hermetically sealed dark glass bottles, away from heat and light.' },
      ],
    },
    marketedProducts: [
    ...
    benefits: [
      { icon: 'air', title: 'Secretolytic Expectorant', desc: 'Trans-anethole stimulates ciliated bronchial epithelial cells to produce thinner, more fluid mucus while enhancing mucociliary beat frequency, facilitating productive cough to clear airways.' },
      { icon: 'spa', title: 'Dual Respiratory and Digestive Antispasmodic', desc: 'Uniquely addresses both bronchial and GI smooth muscle spasms: relieving cough-associated bronchospasm and simultaneously treating bloating and flatulence, the most common companion complaints.' },
      { icon: 'water_drop', title: 'Demulcent Mucosal Protection', desc: 'Volatile oil components coat the pharyngeal and bronchial mucosa, soothing irritation at cough receptor level. Effective for both productive and dry irritative cough.' },
    ],
    botanicalFacts: {
      ...
      history: 'One of the oldest documented medicinal plants: referenced in the ancient Egyptian Ebers Papyrus. Used in ancient Greek medicine by Hippocrates and Dioscorides. Still widely consumed in the Arab world as Yansoon tea.',
    },
    preparation: [
  ...
  'pelargonium': {
    ...
    suitableAgeGroups: [
      { group: 'Adults', notes: 'Standard dose: 30 drops × 3/day or 20 mg tablets × 3/day for 7–10 days.' },
      { group: 'Children (6–12 years)', notes: '20 drops × 3/day under medical guidance.' },
      { group: 'Children (<6 years)', notes: 'Not recommended: insufficient safety and efficacy data.' },
      { group: 'Pregnancy & Lactation', notes: 'Not recommended: insufficient clinical data.' },
      { group: 'Severe hepatic/renal disease', notes: 'Avoid use.' },
    ],
    dosage: {
      standard: '30 drops liquid extract 3× daily (~4.5 mL/day) or 20 mg tablets 3× daily for 7–10 days.',
      forms: [
        { form: 'EPs 7630 Liquid Extract', dose: 'Adults: 30 drops × 3/day. Children 6–12: 20 drops × 3/day.' },
        { form: 'Standardized Tablets (20 mg)', dose: 'Adults: 20 mg × 3/day for 7–10 days.' },
      ],
    },
    overdose: {
    ...
    marketedProducts: [
      { name: 'Kaloba (EPs 7630 tablets)', image: '/images/Picture311.jpeg' },
      { name: 'Umcka / Umckaloabo (EPs 7630 liquid extract)', image: '/images/Picture312.jpeg' },
    ],
    benefits: [
    ...
    references: [
      ...
      { text: 'National Institutes of Health — Pelargonium.', url: 'https://share.google/FxvhgrbV49wZAivOw' },
      { text: 'National Institutes of Health — Pelargonium clinical evidence.', url: 'https://share.google/4PBaL8929gRtE03if' },
    ],
  },
  ...
  'black-elderberry': {
    ...
    description: 'Black Elderberry (Sambucus nigra) belongs to the Adoxaceae family (also classified under Viburnaceae). Its berry extract is rich in anthocyanins (cyanidins) that block viral hemagglutinin, preventing influenza virus attachment to host cell receptors. Clinical meta-analyses confirm reduced influenza duration and severity. The raw plant contains sambunigrin (cyanogenic glycoside): properly processed berries only should be used. Important pharmacognostical distinction: Sinupret (a widely used multi-herbal formula for sinusitis) contains Sambuci flos (elder flower), which acts as a secretolytic and diaphoretic — this is not the same as the standardized elderberry fruit extract used for antiviral effects.',
    ...
    activeConstituents: [
      ...
      { name: 'Ribosome-inactivating proteins / Lectins (Sambucus nigra agglutinins – SNA)', detail: 'Bind viral surface proteins, contributing to anti-adhesion and antiviral activity.' },
    ],
    moa: [
    ...
    marketedProducts: [
      { name: 'Sambucol Black Elderberry Syrup', image: '/images/Picture314.jpeg' },
  ...
  'guava': {
    ...
    warnings: [
      'Patients with diabetes: guava leaf extract significantly lowers blood glucose: monitor blood sugar closely.',
      'Pregnancy: avoid concentrated leaf extracts: insufficient safety data in therapeutic quantities.',
      'High doses cause constipation and nausea from ellagitannin astringency: do not exceed recommended doses.',
    ],
    activeConstituents: [
      { name: 'Quercetin & Quercetin Glycosides (Guajaverin)', effect: 'Primary flavonoids; COX-2 and LOX inhibition reduces airway inflammation and pharyngeal pain; quercetin has direct antiviral activity against respiratory viruses.' },
      { name: 'Ellagitannins (Pedunculagin, Casuarinin) & Condensed Tannins', effect: 'Astringent compounds regulating mucus production; potent antimicrobial activity against respiratory pathogens; anti-diarrheal via bowel astringency.' },
      { name: 'Volatile Oils (β-Caryophyllene, Limonene, Alpha-Pinene)', effect: 'Anti-inflammatory sesquiterpene (β-caryophyllene via CB2 receptor agonism); monoterpenes with additional antimicrobial and airway-soothing activity.' },
      { name: 'Vitamins C and A', effect: 'High-concentration antioxidant vitamins supporting immune function, mucosal repair, and reducing oxidative damage in inflamed respiratory tissues.' },
    ],
    moa: [
      { title: 'Peripheral Antitussive', detail: 'Quercetin glycosides and tannins suppress the cough reflex via peripheral mechanisms at airway sensory nerve endings (afferent C-fibers and Aδ-fibers), reducing cough frequency without central CNS depression.' },
      { title: 'COX and LOX Inhibition (Anti-inflammatory)', detail: 'Quercetin selectively inhibits both COX-2 (prostaglandins) and 5-LOX (leukotrienes), reducing the dual-pathway inflammatory cascade driving airway edema, pharyngeal pain, and mucus hypersecretion.' },
      { title: 'Astringent Mucus Regulation', detail: 'Ellagitannins (pedunculagin, casuarinin) exert astringent action on airway mucosal cells, normalizing excessive mucus production and reducing sputum volume without impairing mucociliary clearance.' },
      { title: 'Antimicrobial', detail: 'Tannins and quercetin exhibit activity against common respiratory pathogens including Staphylococcus aureus, Streptococcus pyogenes, and Klebsiella pneumoniae, reducing secondary bacterial infection in viral respiratory illnesses.' },
    ],
    uses: [
      'Cough: traditional antitussive widely used in tropical pharmacopoeia and validated pharmacologically',
      'Sore throat and upper respiratory tract infections',
      'Oral ulcers and gum inflammation (leaf decoction gargle)',
      'Adjunct anti-diarrheal (tannin-mediated bowel astringency)',
    ],
    howToUse: [
      { method: 'Guava Leaf Decoction (Tea)', instruction: 'Adults: Boil 4–5 fresh or dried guava leaves in 500 mL water for 10–15 minutes. Strain, cool slightly. Drink 2–3 cups daily for cough, or gargle warm decoction for sore throat. Children (>2 years): ½ the adult preparation, 2× daily.' },
      { method: 'Standardized Guava Syrup', instruction: 'Adults: 10 mL 3–4 times daily. Children (>2 years): 5 mL 2–3 times daily, as directed on the product label (e.g., Guava Syrup, Pentamix Syrup, Fast Syrup).' },
    ],
    suitableAgeGroups: [
      { group: 'Adults', notes: 'Standard leaf decoction or syrup doses well-tolerated.' },
      { group: 'Children (>2 years)', notes: 'Mild leaf decoction (diluted) or 5 mL pediatric syrup 2–3× daily under supervision. Decoction most suitable over 6 years.' },
      { group: 'Infants (<2 years)', notes: 'Avoid concentrated guava leaf preparations.' },
      { group: 'Pregnancy', notes: 'Culinary guava fruit is safe; concentrated leaf extracts avoided as a precaution due to insufficient safety data.' },
    ],
    dosage: {
      standard: 'Adults: leaf decoction 2–3 cups daily; or syrup 10 mL 3–4× daily. Children (>2 years): syrup 5 mL 2–3× daily.',
      forms: [
        { form: 'Leaf Decoction (Adults)', dose: '4–5 leaves in 500 mL water, boiled 10–15 min; 2–3 cups daily.' },
        { form: 'Standardized Syrup (Adults)', dose: '10 mL, 3–4× daily.' },
        { form: 'Standardized Syrup (Children >2 years)', dose: '5 mL, 2–3× daily.' },
      ],
    },
    overdose: {
      symptoms: [
        'Constipation and nausea from excessive ellagitannin astringency at very high doses.',
        'Hypoglycemia risk in diabetic patients taking concurrent antidiabetic medications at high doses.',
      ],
      management: [
        'Reduce or stop dose. Increase fluid intake and dietary fiber for constipation.',
        'Monitor blood glucose in diabetic patients; adjust antidiabetic medication if needed.',
      ],
    },
    sideEffects: [
      'Constipation with high doses (astringent ellagitannin content)',
      'Mild GI discomfort or nausea at high doses',
      'Possible hypoglycemia in diabetic patients on concurrent antidiabetic medications',
    ],
    contraindications: [
      'Poorly controlled diabetes without blood glucose monitoring: significant hypoglycemia risk',
      'Pregnancy: concentrated leaf extracts avoided',
    ],
    drugInteractions: [
      'Antidiabetic medications (Insulin, Metformin, Sulfonylureas): additive glucose-lowering effect: monitor blood sugar closely and adjust medication as needed.',
    ],
    storage: {
      forms: [
        { form: 'Fresh Guava Leaves', storage: 'Refrigerate and use within 3–5 days.' },
        { form: 'Dried Guava Leaves', storage: 'Airtight container in cool, dry, dark place; shelf life up to 12 months.' },
      ],
    },
    marketedProducts: [
    ...
    benefits: [
      { icon: 'air', title: 'Non-Sedating Peripheral Antitussive', desc: 'Quercetin glycosides and tannins suppress cough reflexes at airway sensory nerve endings, reducing cough frequency without the sedation, constipation, or addiction risk of opioid antitussives.' },
      { icon: 'shield', title: 'Dual COX/LOX Anti-inflammatory', desc: 'Quercetin simultaneously inhibits both COX-2 (prostaglandins) and 5-LOX (leukotrienes), providing more complete airway anti-inflammatory coverage than COX-selective drugs alone.' },
      { icon: 'nutrition', title: 'High-Concentration Vitamin C & Quercetin', desc: 'Guava leaves combine the highest natural vitamin C and quercetin concentrations of any commonly used herb, delivering antioxidant immune enhancement alongside direct antiviral activity.' },
    ],
    botanicalFacts: {
...
export const CATEGORIES = [
  ...
  },
  {
    ...
    subcategories: [
      { id: 'anti-septic', name: 'Anti-Septic Plants',  description: 'Antimicrobial botanicals for urinary tract antisepsis.',         image: '/images/categories/sub-antiseptic.jpeg', plants: ['clove', 'garlic', 'witch-hazel'] },

...
export const TRANSLATIONS = {
  en: {
    ...
    search_placeholder: 'Search plants & categories...', search_plants: 'Plants', search_categories: 'Categories',
    search_no_results: 'No results found for', search_browse_all: 'Browse all categories',
    search_quick_access: 'Quick Access', search_hint: 'Try "ginger", "immunity" or "skin care"',
    ...
    home_featured_overline: 'Explore the Collection', home_featured_title: 'Featured Plants', home_featured_link: 'View All Plants',
    home_egyptian_overline: 'Historical Medicine', home_egyptian_title: 'Ancient Egyptian Medicine',
    ...
    plant_myth: 'Myth',
    plant_fact: 'Fact',
    plant_clinical_notes: 'Clinical Notes for Pharmacists',
    // ── New questionnaire keys ────────────────────────────────────────────
    opt_digestive_soon: 'Digestive Health', opt_digestive_soon_desc: 'Gut comfort & function',
    opt_digestive: 'Digestive Health', opt_digestive_desc: 'Gut comfort, constipation, diarrhea & IBS',
    opt_uti: 'Urinary Health', opt_uti_desc: 'Bladder, kidney & prostate support',
    ...
    opt_wh_hair: 'Hair Care', opt_wh_hair_desc: 'Scalp health, growth & strength',
    ...
    opt_wh_pregnancy: 'Pregnancy Support', opt_wh_pregnancy_desc: 'Nausea, constipation & UTI during pregnancy',
    opt_resp_cold: 'Cold & Flu', opt_resp_cold_desc: 'Fever, sore throat, runny nose',
    opt_resp_cough: 'Cough & Bronchitis', opt_resp_cough_desc: 'Productive cough & respiratory irritation',
    opt_resp_rhinitis: 'Rhinitis / Allergies', opt_resp_rhinitis_desc: 'Nasal congestion & seasonal allergies',
    opt_resp_sinusitis: 'Sinusitis', opt_resp_sinusitis_desc: 'Sinus congestion & inflammation',
    ...
    opt_imm_antiinflammatory: 'Anti-inflammatory', opt_imm_antiinflammatory_desc: 'Joint pain, chronic inflammation & arthritis',
    ...
    opt_dig_constipation: 'Constipation', opt_dig_constipation_desc: 'Sluggish bowel & hard stools',
    opt_dig_diarrhea: 'Diarrhea', opt_dig_diarrhea_desc: 'Loose stools & bowel irritation',
    opt_dig_dyspepsia: 'Dyspepsia', opt_dig_dyspepsia_desc: 'Indigestion, bloating & stomach discomfort',
    opt_dig_ibs: 'IBS', opt_dig_ibs_desc: 'Irritable bowel syndrome & cramping',
    opt_uti_antiseptic: 'UTI / Urinary Infection', opt_uti_antiseptic_desc: 'Bacterial infection & recurrence prevention',
    opt_uti_diuretics: 'Fluid & Kidney Flushing', opt_uti_diuretics_desc: 'Edema, water retention & urinary flushing',
    opt_uti_bph: 'Prostate Health (BPH)', opt_uti_bph_desc: 'Benign prostatic hyperplasia & urine flow',
    ...
    team_role: 'Pharmacist', team_supervisor: 'Project Supervisor', team_member: 'Team Member',
    ...
    // ── Egyptian Medicine Section ────────────────────────────────────────────
    egyptian_badge: 'Ancient Egyptian Medicine',
    egyptian_year: '1550 BCE',
    egyptian_papyrus_label: 'Ebers Papyrus',
    egyptian_recipe_label: 'The Recipe',
    egyptian_refs_label: 'References',
    egyptian_intro1: 'Ancient Egyptians possessed considerable medical knowledge, including the use of medicinal plants. Papyri and artifacts indicate their awareness of the preservative properties of herbs for embalming, and plant necklaces and bas-reliefs reveal their understanding of certain plants\' medicinal value.',
    egyptian_intro2: 'The Ebers papyrus, dating to approximately 1550 BCE, is one of the oldest known medical texts and contains 700 magical formulas and folk remedies. These remedies were intended to cure a range of ailments, from insect bites to toenail pain.',
  },
  ar: {
    brand: 'نبتة', tagline: 'معهد الأبحاث النباتية',
    nav_discover: 'اكتشف', nav_categories: 'التصنيفات', nav_journal: 'المجتمع',
    nav_about: 'من نحن', nav_consult: 'استشر خبيراً', nav_switchLang: 'En',
    ...
    search_placeholder: 'ابحث عن نباتات وفئات...', search_plants: 'النباتات', search_categories: 'الفئات',
    search_no_results: 'لا توجد نتائج لـ', search_browse_all: 'تصفح جميع الفئات',
    search_quick_access: 'وصول سريع', search_hint: 'جرّب "زنجبيل" أو "مناعة" أو "بشرة"',
    ...
    home_featured_overline: 'استكشف المجموعة', home_featured_title: 'النباتات المميزة', home_featured_link: 'عرض جميع النباتات',
    home_egyptian_overline: 'الطب التاريخي', home_egyptian_title: 'الطب المصري القديم',
    ...
    plant_myth: 'خرافة',
    plant_fact: 'حقيقة',
    plant_clinical_notes: 'ملاحظات سريرية للصيادلة',
    // ── مفاتيح الاستبيان الجديدة ──────────────────────────────────────────
    opt_digestive_soon: 'صحة الجهاز الهضمي', opt_digestive_soon_desc: 'راحة الأمعاء ووظائفها',
    opt_digestive: 'صحة الجهاز الهضمي', opt_digestive_desc: 'الإمساك والإسهال والقولون العصبي وعسر الهضم',
    opt_uti: 'صحة المسالك البولية', opt_uti_desc: 'دعم المثانة والكلى والبروستاتا',
    ...
    opt_wh_hair: 'العناية بالشعر', opt_wh_hair_desc: 'صحة فروة الرأس والنمو والقوة',
    ...
    opt_wh_pregnancy: 'دعم الحمل', opt_wh_pregnancy_desc: 'الغثيان والإمساك والتهاب المسالك أثناء الحمل',
    opt_resp_cold: 'نزلة برد وإنفلونزا', opt_resp_cold_desc: 'حمى، التهاب حلق، سيلان أنف',
    opt_resp_cough: 'السعال والتهاب الشعب الهوائية', opt_resp_cough_desc: 'السعال المنتج وتهيج الجهاز التنفسي',
    opt_resp_rhinitis: 'التهاب الأنف / الحساسية', opt_resp_rhinitis_desc: 'احتقان الأنف وحساسية الفصول',
    opt_resp_sinusitis: 'التهاب الجيوب الأنفية', opt_resp_sinusitis_desc: 'احتقان الجيوب الأنفية والتهابها',
    opt_resp_both: 'كلاهما / عام', opt_resp_both_desc: 'دعم تنفسي شامل',
    opt_imm_prevent: 'الوقاية', opt_imm_prevent_desc: 'تعزيز مناعي يومي',
    opt_imm_antiinflammatory: 'مضاد للالتهابات', opt_imm_antiinflammatory_desc: 'آلام المفاصل والالتهاب المزمن والتهاب المفاصل',
    ...
    opt_dig_constipation: 'الإمساك', opt_dig_constipation_desc: 'بطء حركة الأمعاء وصعوبة التبرز',
    opt_dig_diarrhea: 'الإسهال', opt_dig_diarrhea_desc: 'البراز الرخو وتهيج الأمعاء',
    opt_dig_dyspepsia: 'عسر الهضم', opt_dig_dyspepsia_desc: 'الهضم الصعب والانتفاخ وعدم الراحة في المعدة',
    opt_dig_ibs: 'القولون العصبي (IBS)', opt_dig_ibs_desc: 'متلازمة القولون العصبي والتشنجات',
    opt_uti_antiseptic: 'التهاب المسالك البولية', opt_uti_antiseptic_desc: 'العدوى البكتيرية والوقاية من التكرار',
    opt_uti_diuretics: 'تنظيف الكلى والسوائل', opt_uti_diuretics_desc: 'الاستسقاء واحتباس الماء وغسل المسالك البولية',
    opt_uti_bph: 'صحة البروستاتا (BPH)', opt_uti_bph_desc: 'تضخم البروستاتا الحميد وتدفق البول',
    ...
    team_role: 'صيدلاني', team_supervisor: 'المشرفة على المشروع', team_member: 'عضو الفريق',
    footer_devby: 'طوّره',
    ...
    // ── قسم الطب المصري القديم ──────────────────────────────────────────────
    egyptian_badge: 'الطب المصري القديم',
    egyptian_year: '١٥٥٠ ق.م',
    egyptian_papyrus_label: 'بردية إيبرس',
    egyptian_recipe_label: 'الوصفة',
    egyptian_refs_label: 'المراجع',
    egyptian_intro1: 'امتلك المصريون القدماء معرفة طبية واسعة، شملت استخدام النباتات الطبية. تشير البرديات والآثار إلى إدراكهم لخصائص الأعشاب الحافظة في التحنيط، فيما تكشف قلائد النباتات والنقوش البارزة عن فهمهم لقيمتها الطبية.',
    egyptian_intro2: 'تعود بردية إيبرس إلى نحو عام 1550 قبل الميلاد، وهي من أقدم النصوص الطبية المعروفة، وتحتوي على 700 صيغة وعلاج شعبي، كانت تُستخدم لشفاء طائفة من الأمراض، من لدغات الحشرات إلى آلام أظافر القدم.',
  },
};
...
export const PLANT_TRANSLATIONS = {
  ar: {
    ...
    dandelion: {
      ...
      uses: [
        'تخفيف احتباس السوائل الخفيف وذمة ما قبل الدورة الشهرية.',
        'إدرار داعم لإدارة ارتفاع ضغط الدم الخفيف.',
        'إدرار المسالك البولية والتطهير.',
        'دعم تطهير الكبد وتدفق الصفراء.',
      ],
      howToUse: [
        { method: 'شاي أوراق الهندباء', instruction: 'انقع 4–10 غ من الأوراق المجففة في 150–200 مل ماء مغلٍ (مغطى) لمدة 10 دقائق. تناوله حتى 3 مرات يومياً مع الحفاظ على ترطيب عالٍ طوال اليوم.' },
        { method: 'مستخلص سائل (1:1)', instruction: '4–10 مل يومياً في جرعات مقسّمة مخففة بالماء.' },
      ],
      activeConstituents: [
        { name: 'أملاح البوتاسيوم (الأوراق، 3–5%)', detail: 'محتوى البوتاسيوم الداخلي العالي للغاية يُعوّض باستمرار البوتاسيوم المُفرز خلال الإدرار، مع الحفاظ على توازن الإلكتروليت على خلاف المدرّات الصناعية.' },
        { name: 'فلافونويدات (اللوتيولين) وكومارينات', detail: 'تعمل على الأنابيب الكلوية لتحفيز إفراز الماء وتوفير دعم مضاد للالتهاب.' },
        { name: 'لاكتونات سيسكيتيربين (الجذور)', detail: 'مركبات مرّة تحفّز إفراز الصفراء (تأثير صفراوي) مُحسِّنةً هضم الجهاز الهضمي العلوي وتحلّل الدهون.' },
      ],
      moa: [
        { title: 'التأثير المائي (محافظ على البوتاسيوم)', detail: 'يعمل البوتاسيوم المرتفع والفلافونويدات على الأنابيب الكلوية لتحفيز إفراز الماء دون تسريع استنزاف الإلكتروليت، على خلاف مدرّات الهينة أو الثيازيد.' },
        { title: 'إحلال البوتاسيوم ذاتياً', detail: 'على خلاف المدرّات التقليدية التي تُسبّب نقص بوتاسيوم الدم، يُعوّض بوتاسيوم الهندباء الداخلي عن فقد البوتاسيوم الكلوي خلال الإدرار.' },
        { title: 'التأثير الصفراوي (الجذر)', detail: 'تُحفّز المركبات المرّة من لاكتونات السيسكيتيربين المستقبلات التذوقية مُحدِثةً زيادة إفراز الصفراء وتحسين هضم الكبد والجهاز الهضمي.' },
      ],
      suitableAgeGroups: [
        { group: 'البالغون', notes: 'آمن بالجرعات العلاجية مع الترطيب الكافي. مراقبة ضغط الدم إذا كُنت تتناول خافضات ضغط الدم.' },
        { group: 'كبار السن', notes: 'الاستخدام بحذر في أمراض القلب والأوعية الدموية. مراقبة دقيقة لضغط الدم مطلوبة.' },
        { group: 'الأطفال (دون 12 عاماً)', notes: 'غير موصى به للعلاج الذاتي: بيانات السلامة عند الأطفال غير كافية.' },
        { group: 'الحمل والرضاعة', notes: 'موانع استخدام: بيانات السلامة السريرية غير كافية.' },
      ],
      dosage: {
        standard: 'أوراق مجففة (شاي): 4–10 غ، 3 مرات يومياً في 150–200 مل ماء مغلي. مستخلص سائل (1:1): 4–10 مل/يوم.',
        forms: [
          { form: 'مستخلص أوراق مجففة (شاي)', dose: '4–10 غ مع النقع 10 دقائق (مغطى)، حتى 3 مرات يومياً.' },
          { form: 'مستخلص سائل (1:1)', dose: '4–10 مل يومياً في جرعات مقسّمة.' },
        ],
      },
      overdose: {
        symptoms: [
          'حرقة شديدة، فرط حموضة المعدة، ألم شرسوفي خفيف، إسهال.',
          'تفاعلات فرط حساسية محتملة (طفح جلدي) عند الجرعات الكبيرة جداً >50–100 غ/يوم.',
        ],
        management: [
          'وقف الاستخدام فوراً. تناول مضادات الحموضة الفموية أو مضادات مستقبلات H₂ لفرط الحموضة.',
          'الحفاظ على الترطيب المعياري. رعاية داعمة أعراضية.',
        ],
      },
      sideEffects: [
        'حرقة المعدة وفرط الحموضة (خاصةً على معدة خالية).',
        'التهاب جلد تماسّي نادر لدى الحساسين من عائلة Asteraceae.',
        'إدرار مفرط إذا تُناول مع مدرّات بولية متزامنة.',
      ],
      contraindications: [
        'فرط الحساسية لعائلة Asteraceae (البابونج، عشبة الذئب، أقحوان مريم، الأقحوان).',
        'انسداد القناة الصفراوية النشط وحصوات المرارة: التأثير الصفراوي قد يُطلق مغص صفراوي.',
        'فشل كلوي حاد أو انقطاع بول: خطر فرط بوتاسيوم الدم من المحتوى العالي للبوتاسيوم.',
      ],
      drugInteractions: [
        'مدرّات بولية صناعية متزامنة (فيوروسيميد، HCTZ): خطر استنزاف سوائل مضاف.',
        'مدرّات محافظة على البوتاسيوم (سبيرونولاكتون) ومكملات البوتاسيوم: خطر فرط بوتاسيوم الدم المضاف.',
        'خافضات ضغط الدم: قد تُمارس تأثيرات خافضة لضغط الدم مضافة؛ مراقبة ضغط الدم.',
      ],
      storage: {
        forms: [
          { form: 'الأوراق المجففة / أكياس الشاي', instructions: 'تُخزَّن في حاويات محكمة مضادة للضوء في مكان بارد جاف. الحماية الكاملة من الرطوبة إلزامية، إذ تمتص أوراق الهندباء الرطوبة بشدة وتكون عرضة للتلوث الفطري والعفن.' },
        ],
      },
      factsAndMyths: [
        { myth: 'تعمل جذور الهندباء بنفس الآلية وفعالية أوراقها تماماً للإدرار الكلوي.', fact: 'تعمل الأوراق أساساً كمدرّ بولي قوي (مائي) بسبب محتواها العالي من البوتاسيوم والفلافونويد. في المقابل، تستهدف الجذور المسارات الكبدية والهضمية، فتعمل بصفة رئيسية كمنشّط صفراوي مرّ وبريبايوتيك بسبب تركيزها العالي من لاكتونات السيسكيتيربين والإينولين.' },
      ],
    },
    thyme: {
      ...
      uses: [
        'تخفيف السعال المنتج المرتبط بنزلات البرد.',
        'علاج داعم في التهاب الشعب الهوائية الحاد والمزمن.',
        'تخفيف احتقان الجهاز التنفسي وتهيج الحلق.',
      ],
      howToUse: [
        { method: 'تحضير الشاي', instruction: 'انقع 1–2 ملعقة صغيرة من الزعتر المجفف في كوب ماء مغلٍ لمدة 10 دقائق في وعاء مغطى للاحتفاظ بالمكوّنات المتطايرة، ثم صفِّه جيداً وتناوله دافئاً.' },
      ],
      activeConstituents: [
        { name: 'زيوت أساسية متطايرة فينولية (1.0%–2.5%)', detail: 'يقودها بصفة رئيسية الثيمول (30%–70%) والكارفاكرول (3%–15%)، وهي مطهّرات طبيعية قوية ذات نشاط مضاد للبكتيريا والفطريات واسع الطيف.' },
        { name: 'فلافونويدات', detail: 'غني بعدة بولي ميثوكسي فلافونات من بينها اللوتيولين والأبيجينين والتيمونين والإيريوديكتيول، التي تعمل موسّعات شعبية موضعية قوية.' },
        { name: 'حمض الروزمارينيك', detail: 'حمض كربوكسيلي بولي فينولي متخصص يُظهر نشاطاً خلوياً مضاداً للأكسدة والالتهاب وتصيّد الجذور الحرة ممتازاً.' },
        { name: 'صابونينات', detail: 'صابونينات تريتيربينويدية ثانوية تُسهم بشكل ملحوظ في عملية البُلغُم المادية عبر تخفيف مصفوفات المخاط الجهازية.' },
      ],
      moa: [
        { title: 'المسار المضاد للتشنج والموسّع للشعب', detail: 'تُثبّط الفلافونويدات والفينولات المتطايرة تنافسياً قنوات الكالسيوم ذات الجهد المحكوم وتتفاعل مع مستقبلات بيتا-2 الأدرينالية على عضلات الشعب الملساء، مُحدِثةً ارتخاءً وقمعاً لنوبات السعال التشنجي.' },
        { title: 'التأثير الإفرازي والمخاطي', detail: 'تحفّز صابونينات الزعتر وزيوته الأساسية حركة الأهداب في شجرة القصبات وتُرقّق كيميائياً المخاط المتماسك، مُقلِّلةً مرونته ومُسرِّعةً طرحه.' },
        { title: 'التأثير المطهّر المباشر', detail: 'يُعطّل الثيمول والكارفاكرول موضعياً أغشية الخلايا البكتيرية عبر تفاعلات كارهة للماء، مُقلِّلَين الحمل الميكروبي في الجهاز التنفسي العلوي.' },
      ],
      suitableAgeGroups: [
        { group: 'الأطفال', notes: 'تُعطى جرعات صغيرة محسوبة فقط (عبر أشربة صيدلانية معتمدة)؛ الزيت الأساسي الخام موانع استخدام.' },
        { group: 'الحوامل والمرضعات', notes: 'آمن جداً بالكميات الغذائية أو الطهي العادية؛ يُتجنّب الجرعات الطبية والمستخلصات المركّزة بسبب الإمكانية المحفّزة للرحم.' },
        { group: 'كبار السن', notes: 'آمن عموماً للاستهلاك بالكميات العلاجية العادية.' },
      ],
      dosage: {
        standard: 'البالغون والمراهقون فوق 12 عاماً: 1 إلى 2 غ من العشبة المجففة كمستخلص، 3 إلى 4 مرات يومياً. بديلاً: 1 إلى 2 مل مستخلص سائل (1:1) 3 مرات يومياً.\nالأطفال (4–12 عاماً): استخدام مستخلصات صيدلانية موحّدة فقط، عادةً 2.5 إلى 5 مل شراب، 3 مرات يومياً.',
      },
      overdose: {
        symptoms: ['تهيج معدي معوي حاد، غثيان، قيء، دوار، صداع، اكتئاب جهاز عصبي مركزي، وتسرّع التنفس.'],
        management: ['وقف الاستخدام فوراً، الترطيب الداعم، وطلب تقييم طبي سريري عاجل إذا اشتُبه في سمية الزيت الأساسي.'],
      },
      sideEffects: ['اضطراب معدي معوي مؤقت خفيف، حموضة، أو تفاعلات تحسسية موضعية.'],
      contraindications: ['حساسية موثّقة للثيموس فولجاريس أو أي جنس نباتي آخر ضمن عائلة Lamiaceae.'],
      drugInteractions: ['لا توجد تفاعلات دوائية رئيسية موثّقة، ولكن قد يُعزّز نظرياً تأثيرات أدوية حال المخاط أو مفرز البلغم المتزامنة.'],
      storage: {
        forms: [
          { form: 'الزعتر المجفف', instructions: 'يُحفظ في مكان بارد جاف معزول عن الضوء والرطوبة وتعرض الهواء الجوي.' },
        ],
      },
      factsAndMyths: [
        { myth: 'يمكن لمستخلص الزعتر أن يحل محل المضادات الحيوية الصناعية الموصوفة بالكامل لعلاج الالتهابات البكتيرية التنفسية الشديدة.', fact: 'يُقدّم الزعتر دعماً مضاداً للميكروبات تكميلياً وتأثيرات طرد بلغم ومضادة للتشنج قيّمة، لكنه لا يُعوّض عن مضادات حيوية موصوفة في الحالات البكتيرية المؤكدة.' },
      ],
    },
    mullein: {
    ...
    'ginger-cold': {
      name: 'الزنجبيل',
      shortDescription: 'زنجبيل مضاد للالتهاب والتشنج والفيروسات؛ يُعالج أعراض الجهاز التنفسي العلوي من زكام والتهاب حلق وسعال جاف عبر تثبيط COX-2 وإرخاء العضلات الملساء لمجاري الهواء.',
      activeConstituents: [
    ...
    'echinacea-cold': {
      name: 'الإشنسيا',
      shortDescription: 'نبات محوري لتحفيز المناعة ضد الزكام: يُنشِّط الضامّات وخلايا القاتلة الطبيعية، ويُثبِّط تكاثر فيروسات الجهاز التنفسي، ويُقلِّل بشكل ملحوظ من شدة الزكام ومدته عند تناوله في أول ظهور للأعراض.',
      description: 'تعتمد الفعالية العلاجية للإشنسيا البنفسجية على مزيج معقد من المستقلبات الثانوية المتآزرة: الألكيلاميدات (أميدات الأحماض الدهنية المتعددة غير المشبعة)، ومشتقات حمض الكافيك وفي مقدمتها حمض الشيكوريك (المكوّن الفينولي الأوفر)، والسكريات المتعددة بما فيها الأرابينوغالاكتان والهيتيروكسيلان، والتيربينويدات المتطايرة. المؤشر الأساسي: الوقاية والعلاج الداعم قصير الأمد للزكام الشائع والتهابات الجهاز التنفسي العلوي الحادة. يجب البدء به عند أول ظهور لأعراض الجهاز التنفسي.',
      activeConstituents: [
        { name: 'الألكيلاميدات (الألكيلاميدات)', detail: 'أميدات الأحماض الدهنية متعددة غير المشبعة (مثل الإيزوبيوتيلاميدات)، عالية الإتاحة الحيوية ومتركِّزة أساساً في الجذور والأجزاء الهوائية.' },
        { name: 'مشتقات حمض الكافيك (الفينولية)', detail: 'يتصدرها حمض الشيكوريك (المكوّن الفينولي الأوفر في الإشنسيا البنفسجية)، إلى جانب حمض الكافتاريك والإشناكوسيد.' },
        { name: 'السكريات المتعددة والبروتينات السكرية', detail: 'أرابينوغالاكتان وهيتيروكسيلان عالي الوزن الجزيئي.' },
        { name: 'التيربينويدات المتطايرة', detail: 'زيوت أساسية موجودة في جميع أنسجة النبات.' },
      ],
      moa: [
        { title: 'التأثير المعدِّل للمناعة', detail: 'يُنشِّط الضامّات وخلايا القاتلة الطبيعية (NK). يُعزِّز البلعمة (قدرة خلايا المناعة على ابتلاع مسببات الأمراض). يُحفِّز إطلاق السيتوكينات المشاركة في الاستجابة المناعية.' },
        { title: 'التأثير المضاد للالتهاب', detail: 'تُساعد الألكيلاميدات ومشتقات حمض الكافيك على تنظيم مسارات الالتهاب. قد تُقلِّل إنتاج وسائط الالتهاب المُعزِّزة له، مما يؤدي إلى تخفيف أعراض البرد كالتهاب الحلق والتهاب الغشاء المخاطي الأنفي.' },
        { title: 'النشاط المضاد للفيروسات', detail: 'تُشير بعض الدراسات إلى أن مستخلصات الإشنسيا يمكنها تثبيط تكاثر بعض فيروسات الجهاز التنفسي، بما فيها الفيروسات الأنفية (السبب الأكثر شيوعاً للزكام الشائع). وقد تُقلِّل دخول الفيروسات إلى خلايا المضيف.' },
      ],
      uses: [
        'المؤشر الأساسي: الوقاية والعلاج الداعم قصير الأمد للزكام الشائع والتهابات الجهاز التنفسي العلوي الحادة.',
        'الفعالية السريرية: تُثبت المراجعات المنهجية أن الإشنسيا عند تناولها فور ظهور أعراض الزكام تُقلِّل بشكل ملحوظ من شدة المرض ومدته الإجمالية.',
      ],
      howToUse: [
        { method: 'طريق الإعطاء والأشكال', instruction: 'عن طريق الفم فقط. الأشكال: العصير الطازج الموحَّد المعبَّر (من الأجزاء الهوائية)، أو المستخلصات الكحولية المائية، أو الصبغات، أو الكبسولات، أو الأقراص.' },
        { method: 'التوقيت', instruction: 'يجب البدء به عند أول ظهور لأعراض الجهاز التنفسي (سيلان الأنف، خشونة الحلق) والاستمرار فيه يومياً طوال مدة العدوى.' },
      ],
      suitableAgeGroups: [
        { group: 'البالغون وكبار السن', notes: 'آمن للاستخدام العام، يُقدِّم ملف تحمُّل قوياً عند استهلاكه على المدى القصير (أقل من 6 إلى 8 أسابيع).' },
        { group: 'الأطفال (أقل من 12 سنة)', notes: 'تُقيِّد الوكالة الأوروبية للأدوية (EMA) وهيئة تنظيم الأدوية والمنتجات الصحية البريطانية (MHRA) استخدام مستحضرات الإشنسيا في الأطفال دون 12 عاماً بسبب ارتفاع الخطر الإحصائي لتطوير تفاعلات تحسسية جهازية حادة أو طفح جلدي.' },
        { group: 'الحمل والرضاعة', notes: 'على الرغم من عدم إثبات الدراسات السريرية وجود ارتباط حتمي بين تناول الإشنسيا عن طريق الفم وعيوب خلقية كبرى، إلا أن المعايير الهيكلية للسلامة لم تُثبَّت بالكامل. لذا لا يُوصى باستخدامه أثناء الحمل والرضاعة إلا إذا كان مبرراً سريرياً من قِبَل الطبيب.' },
        { group: 'مرضى الأمراض المزمنة', notes: 'يجب على المرضى المصابين بأمراض المناعة الذاتية أو الذين يتناولون أدوية مثبطة للمناعة استشارة الطبيب قبل الاستخدام.' },
      ],
      dosage: {
        standard: 'العصير الطازج المعبَّر (إشنسيا البنفسجية - الأعشاب الهوائية): 6.0–9.0 مل في جرعات مقسَّمة. المستخلص الكحولي المائي (مكافئ الجذر الجاف): 500–2,000 مغ مكافئ جذر خام، مقسَّم على 3 جرعات يومية. الحد الأقصى للمدة: حتى 10 أيام لكل نوبة حادة.',
        forms: [
          { form: 'العصير الطازج المعبَّر (إشنسيا البنفسجية - الأعشاب الهوائية)', dose: '6.0–9.0 مل في جرعات مقسَّمة.' },
          { form: 'المستخلص الكحولي المائي (مكافئ الجذر الجاف)', dose: '500–2,000 مغ مكافئ جذر خام، مقسَّم على 3 جرعات يومية. الحد الأقصى للمدة: حتى 10 أيام لكل نوبة حادة.' },
        ],
      },
      overdose: {
        symptoms: [
          'لم يُحدَّد مستوى جرعة زائدة سامة واضح، إذ يتمتع بنافذة علاجية واسعة.',
          'الأعراض المحتملة: الغثيان، والقيء، وألم البطن، والدوخة، والصداع، وتفاعلات تحسسية.',
        ],
        management: [
          'لا يوجد ترياق محدد. العلاج عرضي وداعم بالكامل.',
          'وقف الاستخدام فوراً، والحفاظ على الترطيب، وإعطاء مضادات القيء أو مضادات الهيستامين إذا ظهرت تفاعلات تحسسية موضعية.',
        ],
      },
      sideEffects: [
        'معدي معوي: غثيان خفيف وعابر، أو قيء، أو انزعاج بطني.',
        'جلدي/تحسسي: طفح جلدي حطاطي بقعي، وشرى (أرتيكاريا)، وحكة، وتورم موضعي في الوجه.',
        'فرط حساسية شديد (نادر): تحفيز تشنج قصبي، أو تفاقم الربو الحاد، أو صدمة تأقية جهازية في الأفراد شديدي الحساسية.',
      ],
      contraindications: [
        'فرط الحساسية: فرط الحساسية المعروف أو التفاعل التقاطعي مع النباتات التابعة لفصيلة النجمية (المُركَّبة) مثل البابونج والقطيفة وعشبة الهراغ.',
        'الأمراض الجهازية التدريجية والمناعة الذاتية: ممنوع استخدامه بشكل صارم في حالات مثل السل، والتصلب المتعدد (MS)، والذئبة الحمراء الجهازية (SLE)، والكولاجينوز، والتهاب المفاصل الروماتويدي، والإيدز. يتعارض تأثير الإشنسيا المُحفِّز للمناعة نظرياً مع الإدارة الطبية لهذه الأمراض.',
        'العلاج المثبِّط للمناعة: يجب على المرضى الذين يتناولون مثبطات المناعة (مثل سيكلوسبورين وأزاثيوبرين) بعد زراعة الأعضاء أو للحدّ من المناعة الذاتية تجنُّبه، لأنه يُعاكس تأثيرات الأدوية.',
      ],
      storage: {
        forms: [
          { form: 'جميع الأشكال الصلبة', instructions: 'تُخزَّن دون 25 درجة مئوية. يُحفَظ في مكان جاف. يُحمى من أشعة الشمس المباشرة. يُبعَد عن متناول الأطفال.' },
          { form: 'المستخلصات السائلة', instructions: 'يجب إغلاقها بإحكام لمنع تبخر الإيثانول وترسيب المكوّنات الفعّالة.' },
        ],
      },
      benefits: [
        { icon: 'shield', title: 'تنشيط المناعة', desc: 'يُنشِّط الضامّات وخلايا القاتلة الطبيعية، مُعزِّزاً البلعمة وإطلاق السيتوكينات للدفاع المناعي السريع ضد فيروسات الزكام.' },
        { icon: 'coronavirus', title: 'النشاط المضاد للفيروسات', desc: 'يُثبِّط تكاثر فيروسات الجهاز التنفسي بما فيها الفيروسات الأنفية (السبب الأكثر شيوعاً للزكام) وقد يُقلِّل دخول الفيروسات إلى خلايا المضيف.' },
        { icon: 'healing', title: 'مضاد للالتهاب', desc: 'تُنظِّم الألكيلاميدات ومشتقات حمض الكافيك المسارات الالتهابية، مُقلِّلةً التهاب الحلق والأنف المرتبطَين بأعراض الزكام.' },
      ],
      factsAndMyths: [
        {
          myth: 'الإشنسيا يمكنها منع جميع نزلات البرد بشكل كامل.',
          fact: 'تُظهر الأبحاث فائدة محتملة متواضعة فقط، ولا تضمن الوقاية.',
        },
      ],
      botanicalFacts: {
        family: 'الفصيلة النجمية (Asteraceae)',
        nativeRegion: 'أمريكا الشمالية (السهول الكبرى وشرق أمريكا الشمالية)؛ تُزرع الآن على نطاق واسع في جميع أنحاء العالم',
        growthHabit: 'نبات عشبي معمر بارتفاع 60–120 سم؛ أزهار كبيرة بنفسجية-وردية على شكل مخروط؛ الجزء الهوائي بالكامل (أوراق وسيقان وأزهار وجذور) يمكن استخدامه طبياً',
        activeCompounds: 'الألكيلاميدات (الألكيلاميدات)، حمض الشيكوريك، حمض الكافتاريك، الإشناكوسيد، الأرابينوغالاكتان، الهيتيروكسيلان، التيربينويدات المتطايرة',
      },
      preparation: [
        { method: 'العصير الطازج المعبَّر', desc: '6.0–9.0 مل في جرعات مقسَّمة، يبدأ عند أول ظهور للأعراض.', bestFor: 'الزكام الحاد والتهابات الجهاز التنفسي العلوي' },
        { method: 'الكبسولات / المستخلص السائل', desc: '500–2,000 مغ مكافئ جذر خام يومياً في 3 جرعات مقسَّمة. الحد الأقصى 10 أيام لكل نوبة حادة.', bestFor: 'جرعة موحَّدة للوقاية من الزكام وعلاجه' },
      ],
      symptoms: ['أعراض الزكام', 'أنفلونزا', 'التهاب الحلق', 'احتقان', 'ضعف المناعة'],
      relatedPlants: ['ginger-cold', 'lemon', 'eucalyptus'],
      references: [
        { text: 'جامعة كيب كوست — الصيدلة النباتية: الإشنسيا البنفسجية.', url: 'https://pharmacognosy.ucc.edu.gh/echinacea-purpurea' },
        { text: 'كوكرين للطب التكميلي والبديل — الزكام الشائع.', url: 'https://cam.cochrane.org/common-cold' },
        { text: 'WebMD — الفوائد الصحية والسلامة والجرعة للإشنسيا.', url: 'https://www.webmd.com/diet/health-benefits-echinacea' },
      ],
    },
    vitex: {
    ...
    'aloe-vera': {
      ...
      history: 'عُرف بـ"نبات الخلود" عند قدماء المصريين، استُخدم الصبّار طبياً لأكثر من 6000 عام في مصر واليونان وروما والعالم العربي. لا يزال حتى اليوم أحد أكثر النباتات الطبية أهمية تجارياً في العالم.',
    ...
    'tea-tree': {
      ...
      history: 'استخدم السكان الأصليون الأستراليون أوراق Melaleuca alternifolia لقرون لعلاج التهابات الجلد والجروح والحالات التنفسية. جُرِّبت فائدة الزيت في بداية القرن العشرين، وانتشر استخدامه خلال الحرب العالمية الثانية مطهراً للإسعافات الأولية قبل توفر المضادات الحيوية.',
    ...
    licorice: {
      ...
      history: 'استُخدم جذر عرق السوس في الطب التقليدي لأكثر من 4000 عام، وعُثر عليه في مقبرة الفرعون توت عنخ آمون. يحتل مكانة بارزة في الطب الآيورفيدي والصيني وطب الشرق الأوسط لعلاج الأمراض التنفسية والهضمية. في العقود الأخيرة أصبحت مستخلصاته المُقنَّنة ركيزة أساسية في طب التجميل لتفتيح البشرة.',
    ...
    'green-tea': {
      ...
      history: 'زُرع الشاي الأخضر في الصين منذ أكثر من 4000 عام وتبوَّأ مكانةً محوريةً في الطب الشرقي والثقافة الآسيوية. وُثِّقت فوائده الصحية في النصوص الطبية الصينية القديمة، وجاءت الأبحاث الحديثة لتُؤكِّد كثيراً من هذه الاستخدامات التقليدية، ولا سيما الخصائص المضادة للأكسدة والالتهابات.',
    ...
    fenugreek: {
      ...
      history: 'استُخدمت الحلبة في الطب المصري والهندي والشرق أوسطي والصيني منذ آلاف السنين. استعان بها المصريون القدماء للمساعدة في الولادة ودعم الرضاعة. وهي مُدرٌّ تقليدي راسخ في الطب الآيورفيدي، وتُعدُّ مكوناً غذائياً وعشبياً أساسياً في جنوب آسيا حيث تُعرف بـ"الميثي".',
    ...
    moringa: {
      ...
      history: 'تنحدر المورينغا من جنوب آسيا وقد استُخدمت في الطب الآيورفيدي والأفريقي والآسيوي لقرون بوصفها "شجرة المعجزة" بفضل قيمتها الغذائية الاستثنائية. اعتُمدت تقليدياً في رعاية ما بعد الولادة في الهند والفلبين وعموم أفريقيا لدعم التغذية الأمومية وإدرار الحليب.',
    ...
    'black-seed-immunity': {
      ...
      history: 'عُثر على الحبة السوداء في مقبرة الفرعون توت عنخ آمون، وتُستخدم منذ أكثر من 3000 عام في الطب الإسلامي والآيورفيدي والصيني. تحتل مكانةً متميزةً في الطب الإسلامي، إذ ورد عن النبي محمد ﷺ قوله إنها شفاء لكل داء إلا الموت. وقد أثبتت الأبحاث الحديثة صحة كثير من هذه الخصائص من خلال تجارب سريرية دقيقة.',
    ...
    'astragalus-immunity': {
      ...
      symptoms: ['ضعف المناعة', 'التهابات متكررة', 'إرهاق مزمن', 'ضعف ما بعد الفيروسي', 'هشاشة الجهاز التنفسي'],
      activeConstituents: [
        { name: 'سكريات الأستراغالوس المتعددة (Astragalan Polysaccharides)', percentage: '', effect: 'غليكانات عالية الجزيء قابلة للذوبان في الماء؛ ركيزة أساسية للخصائص المُكيِّفة والمُحفِّزة لإنتاج الإنترفيرون؛ تُحفِّز مباشرةً تكاثر خلايا المناعة' },
        { name: 'الأستراغالوسيدات I-X (صابونينات ثلاثية التيربين)', percentage: '', effect: 'مصفوفة كيميائية متخصصة؛ الأستراغالوسيد IV الأكثر نشاطاً دوائياً وبحثاً' },
        { name: 'كيرستين وكايمبفيرول وإيزوفلافونات متخصصة (فلافونويدات)', percentage: '', effect: 'استقرار خلوي وعائي؛ مضاد للأكسدة؛ دعم مضاد للالتهاب' },
        { name: 'أسباراجين وبيتا-سيتوستيرول ونيكل وكروم', percentage: '', effect: 'تركيزات كثيفة من العناصر النادرة الأساسية الداعمة للوظيفة المناعية والاستقلابية الكلية' },
      ],
      moa: [
        { title: 'التأثير المُكيِّف الحقيقي', detail: 'يزيد بشكل منهجي مقاومة الجسم الفسيولوجية غير النوعية لعوامل الإجهاد الجسدي والنفسي والبيئي الشديدة.' },
        { title: 'تحفيز إنتاج الإنترفيرون الداخلي', detail: 'يُحفِّز مباشرةً الإنتاج الخلوي الداخلي للإنترفيرون الذي يؤدي دوراً أساسياً في بدء الدفاع الأولي للجسم ضد الغزوات الفيروسية.' },
        { title: 'تنشيط إشارات الخلايا التائية', detail: 'يُعزِّز ويُسرِّع تكاثر ونضج وقدرة الخلايا اللمفاوية التائية وخطوط خلايا القاتل الطبيعي (NK) على الإجهاز.' },
        { title: 'الدفاع الفيروسي التآزري', detail: 'يعمل بتآزر مع العمليات الخلوية الطبيعية لوقف دورات تكاثر الفيروسات، مُظهِراً فاعلية موثّقة ضد كوكساكي B وفيروسات البرد التنفسي الشائعة.' },
      ],
      uses: [
        'استعادة المناعة: تعزيز شامل للأجهزة المناعية المتهالكة أو الخاملة',
        'الوقاية التنفسية: إدارة وقائية طويلة الأمد من الزكام الشائع والتهابات الجهاز التنفسي العلوي',
        'إدارة التعب المزمن: تخفيف التعب الذهني والجسدي العميق الناجم عن الإجهاد المطوّل أو مراحل التعافي ما بعد الفيروسي',
        'بحث: علاج مساعد يُحسِّن جودة الحياة وتعافي المناعة لدى مرضى العلاج الكيميائي',
      ],
      howToUse: [
        { method: 'طبيخ الجذر الخام', instruction: 'اغلِ 9-30 غ من الجذر المجفّف المقطّع يومياً في الماء مع السماح له بالغليان الكامل لاستخلاص السكريات المتعددة الثقيلة.' },
        { method: 'كبسولات المستخلص الجاف الموحّد', instruction: 'أعطِ 100-150 ملغ مستخلص موحّد ثلاث مرات يومياً بالضبط.' },
        { method: 'مستخلص سائل مخفّف (1: 2)', instruction: '4.5-8.5 مل يومياً في جرعات مقسّمة بعناية.' },
      ],
      suitableAgeGroups: [
        { group: 'البالغون', notes: 'الفئة المستهدفة الرئيسية للاستعادة العلاجية والتكيف مع الإجهاد.' },
        { group: 'الأطفال والمراهقون (أقل من 18 سنة)', notes: 'غير موصى به من هيئة الدواء المصرية: نقص بيانات السلامة طويلة الأمد.' },
        { group: 'الحمل والرضاعة', notes: 'يُتجنّب تماماً: الملف الأماني السريري غائب؛ لا توجد بيانات بشرية موثّقة للخصوبة أو الحمل.' },
      ],
      dosage: {
        standard: 'كبسولات المستخلص الموحّد: 100-150 ملغ ثلاث مرات يومياً. طبيخ الجذر الخام: 9-30 غ يومياً. يُستخدم وقائياً: لا يُستخدم أثناء الحمى الشديدة أو الالتهاب الحاد الشديد.',
        forms: [
          { form: 'كبسولات المستخلص الجاف الموحّد', dose: '100-150 ملغ ثلاث مرات يومياً.' },
          { form: 'طبيخ الجذر الخام', dose: '9-30 غ جذر مجفف مقطّع مطبوخ يومياً.' },
          { form: 'مستخلص سائل (1: 2)', dose: '4.5-8.5 مل يومياً في جرعات مقسّمة.' },
        ],
      },
      overdose: {
        symptoms: [
          'التسمم ذو أهمية سريرية أساساً خلال بروتوكولات الجرعات الفائقة المطوّلة (عادةً أكثر من 60 غ جذر خام يومياً).',
          'الأعراض: ارتفاع حاد في ضغط الدم، سرعة ضربات القلب مع خفقان شديد، أرق مزمن، إفراط في تنشيط الجهاز العصبي أو قلق.',
        ],
        management: [
          'أوقف تناول العشب فوراً.',
          'مراقبة دقيقة لضغط الدم ومعاملات إيقاع القلب.',
          'زيادة تناول السوائل لتسريع التصفية الكلوية.',
        ],
      },
      sideEffects: [
        'يُتحمَّل بشكل جيد جداً عند الجرعات الموصى بها',
        'نادراً: عدم ارتياح معدي خفيف بالجرعات العالية',
        'اضطرابات محتملة في ضغط الدم وإيقاع القلب مع الجرعات الزائدة الكبيرة',
      ],
      contraindications: [
        'أمراض المناعة الذاتية النشطة: يُحظر تماماً في الذئبة الحمراء النشطة (SLE) أو التهاب المفاصل الروماتويدي (RA)؛ التحفيز المفرط لجهاز مناعي مفرط النشاط قد يُفاقم الحالة',
        'زرع الأعضاء: محظور تماماً بسبب التعارض الكيميائي المباشر مع أدوية المثبطات المناعية ما بعد الزرع (سيكلوفوسفاميد)',
        'حالة الإصابة الحادة الشديدة: لا تبدأ الاستخدام أثناء مراحل الحمى الشديدة أو الالتهاب الحاد الشديد؛ يُستخدم وقائياً أو في مرحلة التعافي ما بعد الفيروسي',
      ],
      drugInteractions: [
        'مضادات ارتفاع ضغط الدم: قد يُقلّل أو يزيد بشكل غير متوقع من تأثير أدوية ضغط الدم؛ يجب تجنّب الاستخدام المتزامن أو مراقبته',
        'الأدوية المُعدِّلة للمناعة: يُعزّز IL-2 في بعض الأنماط لكن قد يتعارض في أخرى؛ يُثبِّط مسار CYP3A4 الكبدي: توخَّ الحذر مع الأدوية التي تستخدم هذا المسار',
        'تحذير مختبري حرج: قد يُغيِّر ملفات التخثر ويزيد وقت البروثرومبين (PT) ونسبة التطبيع الدولية (INR)',
      ],
      storage: {
        forms: [
          { form: 'جميع الأشكال', instructions: 'يُخزَّن في حاويات محكمة الإغلاق محمية من الرطوبة وأشعة الشمس المباشرة لضمان الحفاظ طويل الأمد على الصابونينات الفعّالة.' },
        ],
      },
    },
    ...
    'turmeric-immunity': {
      ...
      history: 'استُخدم لأكثر من 4000 عام في الطب الآيورفيدي والصيني. حُلَّت مشكلة ضعف التوافر الحيوي عام 1998 باكتشاف أن البيبيرين يُعزّز الامتصاص بنسبة 2000%. ورد في دساتير منظمة الصحة العالمية (WHO) والوكالة الأوروبية للأدوية (EMA).',
    ...
    'garlic-immunity': {
      ...
      history: 'يُعدُّ الثوم من أقدم النباتات الطبية المزروعة في العالم؛ استُخدم لأكثر من 7000 عام في الطب المصري واليوناني والروماني والهندي والصيني. اعتمده أطباء مصر القديمة للوقاية من العدوى ودعم صحة القلب والأوعية الدموية. وقد أثبتت الأبحاث الحديثة خصائصه المُعدِّلة للمناعة والمضادة للميكروبات وحمايته للقلب.',
    ...
    'dill-seed-menstrual': {
      ...
      history: 'استُخدم الشبت دواءً لآلاف السنين؛ ذُكر في بردية إيبرس المصرية (1550 ق.م) وكتب أطباء روما القدماء. تنحدر كلمة dill من الكلمة النوردية القديمة dylla بمعنى التهدئة والتنويم. وكان الشبت تاريخياً المكوَّن الرئيسي في "ماء القولنج" التقليدي لعلاج مغص الرضع.',
    ...
    'cinnamon-menstrual': {
      ...
      history: 'من أقدم التوابل المعروفة: تُداوَل في طرق التوابل القديمة منذ أكثر من 4000 عام. ذُكر في المصادر الطبية الصينية عام 2700 ق.م، وفي بردية إيبرس المصرية (1550 ق.م)، وكذلك في الكتاب المقدس. اشتُهرت قرفة سيلان من سريلانكا باعتبارها أثمن بضاعة في تجارة التوابل بفضل جودتها الفائقة ونسبة أمانها المرتفعة مقارنةً بالكاسيا.',
    ...
    butterbur: {
      name: 'البتربور',
      shortDescription: 'بتربور طبيعي فعّال لعلاج التهاب الأنف التحسسي الموسمي؛ بيتاسين يُثبِّط الليكوترينات ويُقلِّل إطلاق الهيستامين بفعالية مماثلة لمضادات الهيستامين دون التسبب بالنعاس.',
      activeConstituents: [
    ...
    'stinging-nettle': {
      name: 'القراص',
      shortDescription: 'عشب مضاد للهيستامين والالتهاب بشكل طبيعي؛ يُخفِّف أعراض التهاب الأنف التحسسي كالعطس والاحتقان والحكة عبر تثبيط مستقبلات H₁ وتثبيت أغشية الخلايا البدينة.',
      activeConstituents: [
    ...
    'black-seed-rhinitis': {
      name: 'حبة البركة',
      shortDescription: 'حبة البركة الغنية بالثيموكينون؛ تُخفِّف أعراض التهاب الأنف التحسسي عبر تثبيت الخلايا البدينة وحجب مستقبلات الهيستامين وتثبيط مسارات الالتهاب COX وLOX.',
      activeConstituents: [
    ...
    lemon: {
      ...
      history: 'نشأ الليمون في جنوب آسيا وانتشر عبر بلاد فارس والشرق الأوسط وأوروبا على أيدي التجار العرب في القرن العاشر الميلادي. اشتُهر فيتامين C من الحمضيات بعلاج داء الأسقربوط لدى البحارة البريطانيين في القرن الثامن عشر. ولا يزال ماء الليمون الدافئ بالعسل اليوم أحد أكثر علاجات البرد والتهاب الحلق شيوعاً في مختلف ثقافات العالم.',
    ...
    rocket: {
      ...
      factsAndMyths: [
        {
          myth: 'وضع أوراق الجرجير المطحونة الخام يوفر علاجاً فورياً ودائماً للثعلبة البقعية خلال أيام.',
          fact: 'تستلزم الإيزوثيوسيانات الفعّالة تركيزات عالية موحّدة أو بروتوكولات علاجية منضبطة ومستمرة لعدة أشهر لتحقيق فوائد تجميلية ملموسة في سماكة الشعر وتقليل تكسّره. وهي ليست بديلاً عن المُعدّلات المناعية الطبية في حالات الثعلبة البقعية.',
        },
      ],
    },
    ...
    clove: {
      ...
      history: 'استُخدم في الطب الصيني لأكثر من 2000 عام، وأدخله التجار العرب إلى أوروبا. ويُعدّ ركيزة أساسية في مضادات التعقيم السنية التقليدية ومكوناً رئيسياً في الأسمنت السني ZOE (أكسيد الزنك والأوجينول).',
    ...
    'witch-hazel': {
      ...
      history: 'اشتُق الاسم من الكلمة الإنجليزية القديمة wych بمعنى الأغصان المرنة، ولا صلة له بالسحر. وهو ركيزة أساسية في الرعاية التقليدية للجروح لدى السكان الأصليين الأمريكيين. تعترف إدارة الغذاء والدواء الأمريكية (FDA) بعفص الساحرة باعتباره واقياً آمناً وفعالاً للجلد دون وصفة طبية.',
    ...
    parsley: {
      ...
      history: 'استُخدم في الطب اليوناني والروماني القديم. يشتق اسمه من الكلمة اليونانية petroselinon بمعنى الكرفس الصخري. وهو ركيزة أساسية في الإدرار البولي العشبي الأوروبي. نشرت الوكالة الأوروبية للأدوية (EMA) دساتير لكل من الجذر والعشب.',
      ...
      factsAndMyths: [
        {
          myth: 'تناول كميات كبيرة من شاي البقدونس يذيب تمامًا حصوات الكلى الكبيرة من نوع القرن الأيل ويحوّلها إلى سائل.',
          fact: 'يعمل البقدونس بوصفه عاملاً للري والإدرار المائي والوقاية فحسب؛ إذ يُطهّر البلورات الدقيقة والرمال قبل أن تتكتّل في حصوات كبيرة، أما الحصوات الكبيرة الراسخة أو المنحشرة فتستلزم تفتيت الحصى بالموجات الصدمية أو التدخل الجراحي.',
        },
      ],
    },
    ...
    halfabar: {
      ...
      history: 'ركيزة أساسية في الطب الشعبي المصري والسوداني التقليدي لمغص الكلى وطرد الحصوات. جرى التحقق من صحته سريرياً في تجارب مصرية. وتُصرَف عقارا Proximol وKellagon على نطاق واسع في الصيدليات المجتمعية المصرية.',
      ...
      factsAndMyths: [
        {
          myth: 'يُذيب الحلفبر كيميائياً ويُحوّل هياكل حصى الكالسيوم الكبيرة الصلبة إلى سائل داخل الكلى.',
          fact: 'لا يُغيّر حجم الحصى أو تركيبها الكيميائي، بل يُوسّع الطريق البيولوجي (الحالب) ويحافظ على الحركة الدودية التمعّجية لتتمكّن الجسم من دفع الحصى للخارج بأمان.',
        },
      ],
    },
    ...
    pygeum: {
      ...
      history: 'استُخدم تقليدياً من قِبَل الشعوب الأفريقية الأصلية لأعراض الجهاز البولي. جرى التحقق من فاعليته سريرياً في تجارب عشوائية مُعمَّاة أوروبية خلال التسعينيات والألفينيات. ورد في دساتير الوكالة الأوروبية للأدوية (EMA) لإدارة تضخم البروستات الحميد.',
    ...
    'saw-palmetto': {
      ...
      history: 'استُخدم من قِبَل شعب سيمينول الأمريكي الأصلي لاضطرابات الجهاز البولي والتناسلي. انطلق البحث السريري لتضخم البروستات الحميد في أوروبا خلال الثمانينيات. صنّفته الوكالة الأوروبية للأدوية (EMA) عشباً طبياً راسخ الاستخدام لتضخم البروستات الحميد.',
    ...
    'stinging-nettle-root': {
      ...
      history: 'رُسِّخ استخدام الجذر تحديداً لتضخم البروستات الحميد في الطب العشبي الأوروبي خلال الثمانينيات والتسعينيات. نشرت الوكالة الأوروبية للأدوية (EMA) دساتير منفصلة للجذر (تضخم البروستات الحميد) والورقة (مُدرّ بولي ومضاد للالتهاب). ويُعدّ مزيج القراص مع سو بالميتو أكثر مركّبات تضخم البروستات الحميد العشبية دراسةً على مستوى العالم.',
    ...
    cranberry: {
      ...
      history: 'استُخدم من قِبَل السكان الأصليين الأمريكيين لأعراض التهابات المسالك البولية وبوصفه غذاءً. انتشرت دراسته على نطاق واسع في الثمانينيات والتسعينيات إثر تحديد آلية مضادة للالتصاق. تدعم الوكالة الأوروبية للأدوية (EMA) وعدة مبادئ توجيهية وطنية استخدامه وقائياً للتهابات المسالك البولية المتكررة.',
    ...
    'senna-constipation': {
      ...
      description: 'يحتوي نبات السنا على سينوسيدات A وB، وهي جليكوسيدات ديانثرون تعبر الجهاز الهضمي العلوي دون امتصاص. عند وصولها إلى القولون، تُحلّلها بكتيريا الأمعاء إلى الريانثرون الفعّال، الذي يُحفِّز التمعّج القولوني ويُعدِّل نقل الكهارل عبر تثبيط Na+/K+-ATPase وفتح قنوات الكلوريد، منتجاً براز ليّناً كثيفاً. مُشار إليه حصراً للاستخدام قصير الأمد؛ يُفضي الإسراف المزمن إلى القولون المُلهي واستنزاف الكهارل والاعتماد.',
      history: 'استُخدم السنا منذ القرن التاسع في الطب العربي؛ وثّقه ابن سينا في "القانون في الطب". نشرت WHO وEMA مونوغرافات عشبية رسمية تُرسِّخ استخدامه السريري.',
      activeConstituents: [
      ...
      preparation: [
        { method: 'نقيع مائي (الاستخدام المنزلي القياسي)', desc: 'انقع 1-2 غرام من الأوراق المجففة في 150 مل ماء مغلٍّ في وعاء مغطّى مدة 10-15 دقيقة. صفّي جيداً. أضف زنجبيلاً أو نعناعاً لتقليل المغص.', bestFor: 'تخفيف الإمساك قصير الأمد؛ يؤخذ قبل النوم للتأثير الصباحي' },
        { method: 'مستخلص موحّد (تجاري)', desc: 'أقراص وحبيبات موحّدة على محتوى سينوسيدات محدد (مثل 7.5 ملغ أو 12.5 ملغ سينوسيد/قرص) وفق إرشادات EMA/WHO.', bestFor: 'الجرعة الدقيقة؛ تطهير الأمعاء للإجراءات الطبية' },
      ],
      benefits: [
        { icon: 'medical_services', title: 'ملين منشّط معتمد سريرياً', desc: 'علاج معتمد من WHO وEMA قصير الأمد للإمساك الطارئ أو الحاد مع إخلاء معوي موثوق خلال 6-12 ساعة.' },
        { icon: 'cleaning_services', title: 'تطهير الأمعاء قبل الإجراءات', desc: 'يُستخدم تحت إشراف طبي لتطهير الأمعاء قبل تنظير القولون والأشعة البطنية والتدخلات الجراحية.' },
        { icon: 'timer', title: 'بداية تأثير سريعة وموثوقة', desc: 'ينتج تأثيراً ملّيناً متوقعاً خلال 6-12 ساعة، عادةً ليلاً عند تناوله وقت النوم.' },
        { icon: 'science', title: 'آلية عمل مزدوجة', desc: 'يُحفّز التمعّج القولوني في آنٍ واحد ويُعدّل إفراز الكهارل إلى التجويف المعوي عبر تثبيط Na+/K+-ATPase.' },
      ],
      symptoms: ['الإمساك', 'عدم انتظام الأمعاء', 'تطهير الأمعاء قبل الإجراءات الطبية'],
    },
    ...
    'psyllium-constipation': {
      ...
      description: 'تحتوي قشور سيلليوم (Plantago ovata) على هيتيروبوليساكاريدات مخاطية (أرابينوكسيلانات) بنسبة 10-30%، فائقة امتصاص الماء ومقاومة للهضم الإنزيمي في الجهاز الهضمي العلوي. عند وصول المصفوفة الهلامية الموسَّعة إلى القولون، تُمارس تمدداً ميكانيكياً على مستقبلاته الضغطية مُنشِّطةً المنعكس المعوي ومحفّزةً التمعّج. يُنتج التخمير البكتيري الجزئي أحماضاً دهنية قصيرة السلسلة تُغذّي الغشاء المخاطي للقولون. خلافاً للملينات المنشّطة، لا يُسبِّب السيلليوم الاعتماد وهو العلاج الأوّل المُوصَّى به للإمساك المزمن والقولون العصبي.',
      history: 'استُخدم لقرون في الطب الأيورفيدي والطب التقليدي كمنظّم للأمعاء. أصدرت EMA وWHO مونوغرافات رسمية تُحدّد دوره السريري في الإمساك والقولون العصبي والصحة الأيضية.',
      activeConstituents: [
      ...
      preparation: [
        { method: 'تعليق مائي', desc: 'اخلط 5-10 غرام مسحوق في 250 مل ماء بارد أو عصير، حرّك بسرعة واشرب فوراً قبل التبلّور. أتبعه دائماً بكوب سوائل آخر كامل.', bestFor: 'الإمساك المزمن، القولون العصبي، تنظيم الأمعاء، تخفيف البواسير' },
        { method: 'أكياس فوّارة', desc: 'أذِب الكيس في الماء (يُعطي تعليقاً فوّاراً مستساغاً). يؤخذ مرتين يومياً صباحاً ومساءً بعد الوجبات.', bestFor: 'الامتثال والمذاق الأفضل مقارنةً بالمسحوق العادي' },
      ],
      benefits: [
        { icon: 'favorite', title: 'العلاج الأوّل للإمساك المزمن', desc: 'ملين مُعبِّئ معتمد من EMA وWHO غير مُسبِّب للاعتماد؛ آمن للاستخدام طويل الأمد والحمل وإدارة القولون العصبي.' },
        { icon: 'bar_chart', title: 'إدارة الكوليسترول والجلوكوز', desc: 'الهلام اللزج يربط الأحماض الصفراوية والكوليسترول الغذائي مُخفِّضاً LDL. يُسوّي ارتفاعات الجلوكوز بعد الأكل في السكري من النوع الثاني.' },
        { icon: 'water_drop', title: 'تليين البراز وتنظيم الأمعاء', desc: 'يمتص حتى 40 ضعف وزنه من الماء مكوّناً هلاماً يُليّن البراز ويُريح من الإجهاد في البواسير والشقوق الشرجية.' },
        { icon: 'spa', title: 'منظّم أعراض القولون العصبي', desc: 'يُطبّع قوام البراز وأوقات العبور في القولون العصبي الإمساكي والمتناوب، مُقلِّلاً الإلحاح والتشنّج والانزعاج.' },
      ],
      symptoms: ['الإمساك', 'عدم انتظام الأمعاء', 'أعراض القولون العصبي', 'ارتفاع الكوليسترول', 'إدارة سكر الدم'],
    },
    ...
    'castor-constipation': {
      ...
      description: 'زيت الخروع (الزيت الثابت من بذور Ricinus communis) غير فعّال صيدلانياً حتى يُحلَّل بواسطة الليباز البنكرياسي في الأمعاء الدقيقة، مُحرِّراً حمض الريسينولييك. يعمل هذا الحمض الدهني المُهيدروكسَل الفريد ناهضاً انتقائياً لمستقبلات SEP_3 وSEP_4 البروستانويدية على العضلات الملساء المعوية، محاكياً البروستاغلاندينات ومُحفِّزاً تقلصات تمعجية قوية وسريعة. يُثبِّط أيضاً Na+/K+-ATPase مُعزِّزاً إفراز السوائل في التجويف المعوي. خلافاً للسنا، يستهدف زيت الخروع الأمعاء الدقيقة أساساً، منتجاً تأثيراً مُسهِّلاً قوياً خلال 2-6 ساعات.',
      history: 'وُثِّق في بردية إيبرس المصرية القديمة (~1550 قبل الميلاد). استُخدم طبياً لأكثر من 4000 عام. يُعدّ اليوم أيضاً سواغاً صيدلانياً رئيسياً (Cremophor EL لإذابة الباكليتاكسيل وريدياً في علاج السرطان).',
      activeConstituents: [
      ...
      preparation: [
        { method: 'زيت معصور بارداً (فموي)', desc: 'برّد الزيت قبل الإعطاء. اخلط 15-60 مل في عصير حمضي بارد وتناوله جرعة واحدة. ترطيب غزير إلزامي (6-8 أكواب/يوم) طوال اليوم.', bestFor: 'الإمساك الحاد؛ إخلاء سريع قصير الأمد؛ تطهير الأمعاء قبل الإجراءات الطبية' },
      ],
      benefits: [
        { icon: 'bolt', title: 'إخلاء سريع وقوي', desc: 'ينتج إخلاءً معوياً خلال 2-6 ساعات عبر ناهضية مستقبلات بروستانويدية في الأمعاء الدقيقة؛ أسرع بكثير من السنا (6-12 ساعة) أو السيلليوم.' },
        { icon: 'medical_services', title: 'معيار تطهير الأمعاء الطبي', desc: 'أداة راسخة لتطهير الأمعاء قبل تنظير القولون والأشعة والتدخلات الجراحية تحت إشراف طبي.' },
        { icon: 'science', title: 'آلية عمل مزدوجة', desc: 'حمض الريسينولييك يُنبّه مستقبلات SEP_3/SEP_4 (الحركية) ويُثبّط Na+/K+-ATPase (إفراز السوائل) للإخلاء الكامل السريع.' },
        { icon: 'warning', title: 'للاستخدام قصير الأمد حصراً', desc: 'الاستخدام المزمن يُسبّب تلفاً دائماً في الضفيرة المعوية. للاستخدام الحاد قصير الأمد فقط تحت إشراف طبي.' },
      ],
      symptoms: ['الإمساك', 'تطهير الأمعاء قبل الإجراءات الطبية', 'عدم انتظام الأمعاء'],
    },
    ...
    'ginger-diarrhea': {
      name: 'الزنجبيل',
      shortDescription: 'نبات مضاد للإسهال متعدد الآليات وقوي؛ يعمل الجينجيرول والشوجاول كمضادات مسكارينية وحاصرات لقنوات الكالسيوم لتقليل فرط حركية الأمعاء، مع حصار ارتباط السموم المعوية وإظهار نشاط مضاد للميكروبات مباشر ضد مسببات أمراض الجهاز الهضمي الرئيسية.',
      description: 'يحتوي الزنجبيل الألماني (Zingiber officinale) على مركبات كيتون فينيل ألكيل حارة غير طيارة (جينجيرولات وشوجاولات) وزيوت أساسية طيارة (1–3٪ β-zingiberene وβ-sesquiphellandrene وar-curcumene وα-farnesene). يُعدّ 6-جينجيرول المبدأ الفعّال الأساسي في الجذمور الطازج؛ أما 6-شوجاول فيسود في الزنجبيل المجفف (يتشكّل عبر التجفيف الحراري للجينجيرولات أثناء التجفيف أو التسخين). تُظهر الشوجاولات ثباتاً كيميائياً أعلى وملامح أقوى في مضادة الالتهاب والتشنج مقارنةً بالجينجيرولات. يعمل الجينجيرول والشوجاول كمضادات للمستقبلات المسكارينية وحاصرات قنوات الكالسيوم ذات الجهد المحكوم، مما يُثبّط فرط حركية الأمعاء المستحثة بالأسيتيل كولين. يحصر الفعل المضاد للإفراز ارتباط السموم البكتيرية بمستقبلات خلايا الأمعاء، مما يمنع تنشيط أديلات سيكلاز وفرط إفراز السوائل الضخم.',
      history: 'أحد أكثر التوابل تداولاً في التاريخ القديم، يعود أصله إلى جنوب شرق آسيا. يمتد استخدامه العلاجي الموثق أكثر من 2000 عام في أنظمة الطب الصيني التقليدي والأيورفيدي والأنانيّ والإغريقي الروماني لعلاج الشكاوى الهضمية. صدر له مونوغراف رسمي من وكالة الأدوية الأوروبية (EMA) ومنظمة الصحة العالمية (WHO) وESCOP للتطبيقات الهضمية.',
      activeConstituents: [
        { name: '6-جينجيرول', percentage: 'المادة الفعّالة الأساسية في الجذمور الطازج', effect: 'يمتلك خصائص قوية مضادة للالتهاب ومحرّكة للحركة الهضمية ومضادة للغثيان. أكثر الكيتونات الفينيل ألكيل وفرةً ونشاطاً بيولوجياً.' },
        { name: '6-شوجاول', percentage: 'يسود في الزنجبيل المجفف', effect: 'يتشكّل عبر التجفيف الحراري للجينجيرولات أثناء عمليات التجفيف أو التسخين. يُظهر ثباتاً كيميائياً أعلى وملامح أقوى في مضادة الالتهاب والتشنج مقارنةً بالجينجيرولات.' },
        { name: 'زينجيرون وباردولات', percentage: '', effect: 'منتجات تحلّل ثانوية تتشكّل أثناء التخزين الطويل والطهي، تُسهم في ملامح مضادة الأكسدة وحماية الغشاء المخاطي.' },
        { name: 'الزيوت الأساسية الطيارة (1٪ إلى 3٪)', percentage: '1٪–3٪', effect: 'تتكوّن أساساً من هيدروكربونات السيسكيتيربين، وأبرزها β-zingiberene وβ-sesquiphellandrene وar-curcumene وα-farnesene، التي تُحدّد الرائحة الحارة المميزة وتُسهم في الأفعال المضادة للميكروبات محلياً داخل تجويف الأمعاء.' },
      ],
      moa: [
        { title: 'تأثير مضاد للتشنج ومُرخٍ للعضلات', detail: 'يُحدث الجينجيرول والشوجاول تأثيراً مُرخياً مباشراً على العضلات الملساء المعوية. يعملان كمضادات للمستقبلات المسكارينية وحاصرات قنوات الكالسيوم ذات الجهد المحكوم، مما يُثبّط فعلياً فرط حركية الأمعاء المستحثة بالأسيتيل كولين، وبذلك يُقلّل التشنجات البطنية ويُبطّئ عبور الإسهال.' },
        { title: 'فعل مضاد للإفراز ومضاد للإسهال', detail: 'يحصر تحديداً ارتباط السموم البكتيرية (مثل السموم الحرارية اللابتة لـE. coli) بمستقبلات خلايا الأمعاء. هذا يُثبّط التنشيط الشاذ لأديلات سيكلاز، مما يمنع فرط الإفراز الضخم للماء والشوارد إلى تجويف الأمعاء.' },
        { title: 'تأثير مضاد للالتهاب', detail: 'تثبيط مزدوج لشلال حمض الأراشيدونيك عبر قمع مسارَي أكسجيناز الحلقي (COX) وليبوأكسيجيناز-5 (5-LOX) كلاهما، فضلاً عن تثبيط السيتوكينات المؤيدة للالتهاب (TNF-α وIL-1β). هذا يُخفّف بشكل ملحوظ التهاب الغشاء المخاطي المعوي الناجم عن الإسهال.' },
        { title: 'فعل مضاد للميكروبات ومضاد للحركة', detail: 'يُظهر نشاطاً موثقاً جراثيمياً وقاتلاً للجراثيم ضد مسببات الإسهال الرئيسية، بما فيها Escherichia coli وSalmonella typhi وVibrio cholerae.' },
        { title: 'حصار مستقبلات السيروتونين (5-HT3)', detail: 'يُعدِّل مستقبلات السيروتونين محيطياً في الأمعاء ومركزياً في منطقة المحفّز الكيميائي (CTZ)، مما يُحكم الغثيان والقيء المصاحب الذي يرتبط غالباً بالتهاب المعدة والأمعاء المعدي.' },
      ],
      uses: [
        'التخفيف العرضي للإسهال الخفيف غير المحدد: يُقلّل تواتر البراز وفقدان السوائل في الاضطرابات الهضمية الحادة غير المعقدة.',
        'الإدارة الداعمة لإسهال المسافرين: يعمل كعلاج نباتي مساعد لتخفيف المضاعفات البكتيرية المعوية.',
        'تخفيف الضيق المعدي المعوي المصاحب: يُخفّف التشنجات البطنية المؤلمة والانتفاخ وعسر الهضم والغثيان/القيء المصاحب.',
      ],
      howToUse: [
        { method: 'منقوع الزنجبيل الطازج (شاي)', instruction: 'يُنقع 1–2 غ من الجذمور المقطّع طازجاً أو المبشور في 200 مل من الماء المغلي في إناء مُغطّى لمدة 10–15 دقيقة (لحبس الزيوت الطيارة). يُشرب دافئاً 2 إلى 3 مرات يومياً (الحد الأقصى: 4 غ من الزنجبيل الطازج يومياً).' },
        { method: 'كبسولات/أقراص فموية موحّدة', instruction: '250 مغ إلى 1000 مغ يومياً، تُؤخذ في جرعات مقسّمة. يُستحسن أن تكون التركيبات موحّدة لمحتوى إجمالي الجينجيرول والشوجاول لضمان نتائج علاجية موحّدة.' },
        { method: 'المستخلص السائل', instruction: 'يُتبَع إرشادات الشركة المصنّعة الدقيقة مع ضمان التخفيف المناسب لتجنّب التهيّج المباشر للغشاء المخاطي المعدي.' },
      ],
      suitableAgeGroups: [
        { group: 'البالغون', notes: 'معترف به عموماً بأنه آمن (GRAS) عند الاستهلاك ضمن الحدود اليومية العلاجية المحددة.' },
        { group: 'كبار السن', notes: 'آمن، لكن يتطلب مراقبة دقيقة للحالات المزمنة الموجودة مسبقاً والتفاعلات الدوائية المحتملة المتعددة.' },
        { group: 'الأطفال', notes: 'يُستخدم بحذر شديد. يُتجنَّب في الرضّع والأطفال دون سنتين. للأطفال الأكبر سناً، يمكن استخدامه بكميات صغيرة جداً مُعدَّلة بحسب الوزن تحت إشراف طبي.' },
        { group: 'الحوامل والمرضعات', notes: 'يُعتبر آمناً بشكل عام للاستخدام قصير الأمد بجرعات منخفضة (حتى 1000 مغ/يوم من المستخلص المجفف) للغثيان، لكن يجب تجنّب الجرعات العلاجية العالية لإدارة الإسهال خلال الحمل دون موافقة طبية نسائية مباشرة نظراً للمخاطر النظرية لتعديل تقلصات الرحم.' },
      ],
      dosage: {
        standard: 'الشاي: 1–2 غ جذمور طازج في 200 مل ماء، 2–3 مرات يومياً (الحد الأقصى 4 غ/يوم). الكبسولات: 250–1000 مغ/يوم في جرعات مقسّمة، موحّدة لمحتوى الجينجيرول/الشوجاول.',
        forms: [
          { form: 'شاي الزنجبيل الطازج', dose: '1–2 غ جذمور مقطّع طازجاً، مُنقَع مُغطّى 10–15 دقيقة في 200 مل ماء، 2–3 مرات يومياً.' },
          { form: 'كبسولات موحّدة', dose: '250–1000 مغ يومياً في جرعات مقسّمة، موحّدة لمحتوى الجينجيرول والشوجاول.' },
          { form: 'المستخلص السائل', dose: 'حسب إرشادات الشركة المصنّعة الدقيقة مع التخفيف المناسب.' },
        ],
      },
      overdose: {
        intro: 'جرعة زائدة فموية حادة: نادراً ما تحدث من الاستهلاك الغذائي، لكن من المحتمل جداً حدوثها مع الاستهلاك المفرط للمستخلصات أو المكمّلات المركّزة.',
        symptoms: [
          'ارتداد معدي حاد وحرقة معوية مُنهِكة',
          'إسهال حاد متناقض (بسبب التهيّج الشديد للغشاء المخاطي بالجرعات الضخمة)',
          'ألم معدي وكبت خفيف للجهاز العصبي المركزي وانخفاض ضغط الدم',
          'زيادة الميل النظامي للنزيف',
        ],
        management: [
          'التوقف الفوري عن تناول الزنجبيل.',
          'بدء بروتوكولات داعمة وعرضية.',
          'الحفاظ على ترطيب فموي أو وريدي قوي لإدارة توازن الشوارد.',
        ],
      },
      sideEffects: [
        'ارتداد معدي وحرقة بالجرعات العالية',
        'تفاعلات تحسسية نادرة في الأفراد الحساسين لعائلة الزنجبيليات',
        'تأثير خفيف مضاد للصفيحات: يُراقَب في مرضى مضادات التخثر',
      ],
      contraindications: [
        'فرط الحساسية المعروف لـZingiber officinale أو أعضاء آخرين من عائلة الزنجبيليات',
        'اضطرابات التخثر والنزيف النشطة: (مثل الهيموفيليا) بسبب النشاط المضاد للصفيحات',
        'حصوات المرارة العرضية (تحصّي المرارة): يُظهر الزنجبيل تأثيرات مفرزة للصفراء قوية (يُحفّز إفراز الصفراء)، مما قد يُثير مغصاً صفراوياً مؤلماً أو انسداد حصوات المرارة',
        'فترات ما قبل الجراحة: يجب إيقافه على الأقل 7 إلى 14 يوماً قبل العمليات الجراحية الكبرى الاختيارية للحدّ من مخاطر النزيف الحاد أثناء الجراحة',
      ],
      drugInteractions: [
        'مضادات التخثر / مضادات الصفيحات (مثل: وارفارين، أسبرين، كلوبيدوقريل): تُثبّط مكوّنات الزنجبيل (6-شوجاول و6-جينجيرول) إنزيم تركيب الثرومبوكسان وتُقلّل تجمّع الصفيحات. يُضخّم الإعطاء المشترك بشكل كبير مخاطر النزيف ويُغيّر قيم PT/INR.',
        'الأدوية المضادة لسكري الدم (مثل: ميتفورمين، إنسولين، سلفونيلوريا): قد يُعزّز الزنجبيل حساسية الإنسولين ويزيد امتصاص الجلوكوز المحيطي، مما قد يُضاعف خطر انخفاض السكر غير المتوقع. قد تكون تعديلات جرعة خافضات السكر الفموية ضرورية.',
        'أدوية خافضة ضغط الدم (مثل: حاصرات قنوات الكالسيوم كنيفيدبين): قد يُحدث الزنجبيل تأثيرات قلبية وعائية مضافة لحصار قنوات الكالسيوم، مما يؤدي إلى انخفاض تآزري في ضغط الدم وزيادة خطر الانخفاض الشديد لضغط الدم.',
      ],
      storage: {
        forms: [
          { form: 'الجذامير الطازجة', instructions: 'يجب لفّها غير مقشورة وتخزينها في الثلاجة (عند 4 درجات مئوية) للحفاظ على رطوبة الخلية ومنع التلف الميكروبي/الفطري.' },
          { form: 'التركيبات الجافة الموحّدة', instructions: 'يجب تخزينها في حاويات محكمة الإغلاق محمية من ضوء الشمس المباشر والحرارة العالية والرطوبة لتجنّب تدهور الجينجيرولات إلى شوجاولات وتبخّر الزيوت الأساسية الحيوية.' },
        ],
      },
      factsAndMyths: [
        { myth: '"يعمل الزنجبيل كعلاج بيولوجي فوري وكامل لجميع أشكال الإسهال المعدي الحاد الشديد، يُغني عن جميع الأدوية التقليدية."', fact: 'لا يقضي الزنجبيل فوراً على مسببات الأمراض الغازية شديدة الضراوة (كالشيجلا أو الأميبا)، ولا يُمكنه استبدال بروتوكولات الترطيب الأساسية. يُشكّل علاجاً نباتياً داعماً استثنائياً قائماً على الأدلة يُخفّف بشكل ملحوظ شدة الأعراض ويُهدّئ فرط حركية الأمعاء ويُقلّل التشنجات ويُحسّن راحة المريض.' },
      ],
      benefits: [
        { icon: 'block', title: 'حاصر السموم البكتيرية المعوية', desc: 'يحصر تحديداً ارتباط السموم البكتيرية المعوية بمستقبلات خلايا الأمعاء، مما يمنع فرط إفراز السوائل الضخم المسؤول عن الإسهال المعدي.' },
        { icon: 'spa', title: 'مضاد تشنج الأمعاء', desc: 'التضاد المسكاريني وحصار قنوات الكالسيوم يُقلّلان فرط حركة الأمعاء، مما يُخفّف التشنجات والاستعجال.' },
        { icon: 'shield', title: 'نشاط مضاد للميكروبات واسع الطيف', desc: 'نشاط جراثيمي موثّق ضد Escherichia coli وSalmonella typhi وVibrio cholerae — مسببات رئيسية للتهاب المعدة والأمعاء الحاد.' },
      ],
      botanicalFacts: {
        origin: 'يُعتقد أنه نشأ في جنوب شرق آسيا (الهند أو الصين على الأرجح). يُزرع تجارياً الآن في جامايكا والهند والصين ونيجيريا وعبر العالم العربي.',
        parts: 'الجذمور (الساق السفلية): يُستخدم طازجاً أو مجففاً أو مسحوقاً أو مستخلصاً. غني بالزيوت الطيارة وكيتونات الفينيل ألكيل الحارة غير الطيارة.',
        history: 'من أقدم وأكثر البهارات الدوائية تداولاً في العالم. مُشار إليه في الصيدليات الصينية والأيورفيدية والأنانية والإغريقية الرومانية القديمة للتطبيقات الهضمية والمضادة للغثيان والمسكّنة لأكثر من 2000 عام.',
      },
      preparation: [
        { method: 'منقوع طازج (شاي)', desc: 'يُنقع 1–2 غ جذمور مقطّع طازجاً في 200 مل ماء مغلٍّ في إناء مُغطّى لمدة 10–15 دقيقة. التغطية ضرورية للاحتفاظ بالزيوت الطيارة.', bestFor: 'إسهال حاد، غثيان، تشنجات بطنية، إسهال المسافرين' },
        { method: 'كبسولات موحّدة', desc: 'كبسولات موحّدة لمحتوى إجمالي الجينجيرول والشوجاول لضمان نتائج علاجية ثابتة.', bestFor: 'جرعة دقيقة، إدارة هضمية مزمنة' },
      ],
      clinicalNotes: [
        { title: 'الحالة المساندة', detail: 'يجب دائماً إرشاد المرضى بأن الزنجبيل علاج داعم ولا يُعدّ بديلاً أبداً عن أملاح الإماهة الفموية (ORS) أو بروتوكولات استبدال السوائل الأساسية.' },
        { title: 'العلامات الحمراء للإحالة', detail: 'يجب على الصيادلة الإحالة الفورية للمرضى المُقدِّمين بإسهال دموي (دوسنتاريا) أو حمى شديدة الدرجة أو تيبس بطني حاد أو علامات جفاف متقدم مباشرةً إلى مرافق الطوارئ السريرية.' },
        { title: 'المراقبة', detail: 'الفحص النشط لملفات المرضى بحثاً عن مخاطر النزيف والعمليات الجراحية المجدولة والاستخدام المتزامن للأدوية ذات النطاق العلاجي الضيق (مثل الوارفارين).' },
      ],
    },
...
export const TAG_TRANSLATIONS = {
  ...
  'Allicin': 'أليسين',
  'Anti-adhesive': 'مضاد للالتصاق',
  'Anti-infective': 'مضاد للعدوى',
  'Anti-proliferative': 'مضاد للتكاثر الخلوي',
  'Antibacterial': 'مضاد للبكتيريا',
  'Antiemetic': 'مضاد للغثيان',
  'Arbutin': 'أربوتين',
  'Aromatherapy': 'العلاج بالروائح',
  'Bronchitis': 'التهاب الشعب الهوائية',
  'Bulk-Forming': 'ملين تجميعي',
  'COX-2 Inhibitor': 'مثبّط COX-2',
  'Cardiovascular': 'قلبي وعائي',
  'Cineole': 'سينيول',
  'Digestive Aid': 'مساعد هضمي',
  'Dyspepsia Relief': 'تخفيف عسر الهضم',
  'Enteric-Coated': 'مُغلَّف معوي',
  'Evidence-Based': 'مبني على الأدلة',
  'Flatulence Relief': 'تخفيف الانتفاخ',
  'Hair Conditioning': 'تحسين الشعر',
  'Hemorrhoid Prevention': 'الوقاية من البواسير',
  'IBS-C': 'قولون عصبي مع إمساك',
  'IBS-D': 'قولون عصبي مع إسهال',
  'Level A Evidence': 'دليل من المستوى أ',
  'Morning Sickness': 'غثيان الصباح',
  'Nausea Relief': 'تخفيف الغثيان',
  'Pregnancy-Safe': 'آمن للحمل',
  'Prokinetic': 'مُحرِّك للأمعاء',
  'Sinusitis': 'التهاب الجيوب الأنفية',
  'Soluble Fiber': 'ألياف قابلة للذوبان',
  'UTI Relief': 'تخفيف التهابات المسالك',
  'Urinary Antiseptic': 'مطهّر مسالك بولية',
  'Urinary Health': 'صحة المسالك البولية',
};

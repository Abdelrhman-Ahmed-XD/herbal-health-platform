...
export const PLANTS = {
  ...
  'ginger': {
    ...
    references: [
      { text: 'PubMed — Ginger and respiratory illness.', url: 'https://pubmed.ncbi.nlm.nih.gov/31935866/' },
      ...
      { text: 'European Medicines Agency (EMA). (2014). European Union herbal monograph on Zingiber officinale Roscoe, rhizoma. Committee on Herbal Medicinal Products (HMPC).' },
      { text: 'World Health Organization (WHO). WHO Monographs on Selected Medicinal Plants, Volume 1: Rhizoma Zingiberis. Geneva.' },
      { text: 'Anh, N. H., et al. (2020). Ginger on Human Health: A Comprehensive Systematic Review of Randomized Clinical Trials. Nutrients, 12(1), 157.' },
      { text: 'PubMed — Ginger for Human Health Study.', url: 'https://pubmed.ncbi.nlm.nih.gov/31861713/' },
      { text: 'PubMed — Fresh Ginger Antiviral Activity Study.', url: 'https://pubmed.ncbi.nlm.nih.gov/23123794/' },
      { text: 'PubMed — Ginger for Irritable Bowel Syndrome.', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3958926/' },

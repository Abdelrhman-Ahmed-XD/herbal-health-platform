...
export const PLANT_TRANSLATIONS = {
  ar: {
    ...
    ginger: {
      name: 'الزنجبيل',
      shortDescription: 'علاج آمن وفعّال ومبني على الأدلة وغير دوائي لإدارة الغثيان والقيء الخفيف إلى المتوسط في الحمل (غثيان الصباح)، مع خصائص قوية مضادة للالتهاب والأكسدة والقيء.',
      description: 'الاستخدامات الدوائية في الحمل:\nيُستخدم الزنجبيل بشكل رئيسي في الحمل كعلاج آمن وفعّال ومبني على الأدلة وغير دوائي لإدارة الغثيان والقيء الخفيف إلى المتوسط (غثيان الصباح)\n\nاستخدامات أخرى:\nيمتلك الزنجبيل الطازج القدرة على موازنة الأحوال الخارجية للجسم وتعزيز التعرق. قد يساعد الزنجبيل الطازج في تخفيف أعراض نزلات البرد كالاحتقان والصداع والغثيان.\n يمتلك الزنجبيل الطازج القدرة على تخفيف أعراض كالصداع واحتقان الأنف والسعال والغثيان الناجمة عن نزلات البرد والاضطرابات الحموية.\n يوفر الزنجبيل خصائص قوية مضادة للالتهاب ومضادة للأكسدة ومضادة للقيء وخصائص محتملة مضادة للسرطان. ويُستخدم على نطاق واسع لعلاج الغثيان (في الحمل والعلاج الكيميائي والجراحة) والاضطرابات الهضمية (الانتفاخ وعسر الهضم) وآلام المفاصل والمشكلات الأيضية كارتفاع نسبة السكر في الدم',
      activeConstituents: [
        { name: 'الجنجيرول والشوجاول', percentage: '', effect: 'المبدأ الحار الرئيسي المسؤول عن الفوائد العلاجية' },
      ],
      moa: [
        { title: 'تحفيز الجهاز الهضمي', detail: 'يزيد الزنجبيل من توتر المعدة وحركتها الدودية. ومن خلال تسريع إفراغ المعدة، يقلل من الوقت الذي يمكث فيه الطعام في المعدة، مما يخفف الغثيان.' },
        { title: 'تثبيط مستقبلات السيروتونين (5-HT3)', detail: 'تعمل مركبات الزنجبيل (الجنجيرول والشوجاول) كمضادات تنافسية عند مستقبلات السيروتونين المحيطية والمركزية (5-HT3). والسيروتونين ناقل عصبي رئيسي يسبب القيء عند إفرازه استجابةً للغثيان، ويُقلل تثبيطه من هذا الإحساس.' },
        { title: 'التأثير المباشر على الأمعاء', detail: 'يُعتقد أن الزنجبيل يُمارس تأثيره المضاد للقيء بشكل رئيسي محلياً داخل الجهاز الهضمي.' },
        { title: 'التأثيرات المضادة للالتهاب والمزيلة للغازات', detail: 'يُوفر الزنجبيل الراحة من عسر الهضم (اضطراب المعدة) ويساعد في مشكلات الحركة الدودية.' },
      ],
      uses: [
        'الاستخدام الدوائي في الحمل: علاج آمن وفعّال ومبني على الأدلة وغير دوائي لإدارة الغثيان والقيء الخفيف إلى المتوسط (غثيان الصباح)',
        'يوازن الزنجبيل الطازج الأحوال الخارجية للجسم ويعزز التعرق؛ يساعد في تخفيف أعراض نزلات البرد كالاحتقان والصداع والغثيان',
        'يخفف الزنجبيل الطازج أعراض الصداع واحتقان الأنف والسعال والغثيان الناجمة عن نزلات البرد والاضطرابات الحموية',
        'خصائص قوية مضادة للالتهاب والأكسدة والقيء ومحتملة مضادة للسرطان؛ يُستخدم على نطاق واسع لعلاج الغثيان (في الحمل والعلاج الكيميائي والجراحة) والاضطرابات الهضمية (الانتفاخ وعسر الهضم) وآلام المفاصل والمشكلات الأيضية كارتفاع نسبة السكر في الدم',
      ],
      howToUse: [
        { method: 'شاي الزنجبيل الطازج', instruction: 'انقع ملعقة إلى ملعقتين صغيرتين من الزنجبيل الطازج المبشور أو المشرح في الماء الساخن لمدة 5 إلى 10 دقائق.' },
        { method: 'كبسولات الزنجبيل', instruction: 'ابحث عن مكملات تحتوي على 250 ملغ من مسحوق الزنجبيل، وتُؤخذ عادةً 2 إلى 4 مرات يومياً، مع التأكد من موافقة المختص الصحي.' },
      ],
      suitableAgeGroups: [
        { group: 'الأطفال دون سنتين', notes: 'لا يُنصح عموماً باستخدام الكميات الطبية.' },
        { group: 'الأطفال (سنتان فأكبر)', notes: 'يمكن استخدام كميات صغيرة من الزنجبيل الطازج في الغذاء للغثيان أو أعراض البرد.' },
        { group: 'البالغون (18 سنة فأكثر)', notes: 'يُنصح بالاعتدال إذ قد لا تكون الكميات الكبيرة جداً مناسبة.' },
        { group: 'الحمل', notes: 'الجرعات الطبية المنخفضة والمعيارية (حتى 1 جرام يومياً) فعالة سريرياً وآمنة، بدلاً من الاقتصار على الكميات الغذائية، بشرط المراقبة الطبية.' },
      ],
      dosage: {
        forms: [
          { form: 'الحمل', dose: '250 ملغ عن طريق الفم، 4 مرات يومياً. الجرعة القصوى الإجمالية: 1 جرام يومياً. يجب استخدام جرعات أعلى خلال الحمل بحذر بسبب محدودية بيانات الأمان.' },
        ],
      },
      overdose: {
        intro: 'لا يوجد تعريف قانوني صارم لجرعة الزنجبيل السامة، لكن الكميات اليومية الكبيرة تُعدّ مفرطة عموماً وقد تؤدي إلى آثار جانبية ضارة.',
        symptoms: [
          'مخاطر النزيف: نظراً لخصائص الزنجبيل المضادة للصفائح الدموية، قد يزيد التناول المفرط من خطر النزيف أو الكدمات، مما يشكل خطورة خاصة قرب موعد الولادة.',
          'اضطرابات الجهاز الهضمي: حرقة شديدة وارتداد حمضي وانتفاخ وإسهال.',
          'تهيج الفم والحلق: إحساس بالحرق أو الألم في الفم.',
          'اضطرابات ضربات القلب: قد تؤثر الجرعات العالية نادراً على نظم القلب عند الجرعات المفرطة.',
          'اضطراب الجهاز العصبي المركزي: قد تسبب الجرعات العالية جداً الخمول أو الإرهاق.',
        ],
        management: [
          'التوقف الفوري عن تناوله.',
          'شرب كميات كافية من الماء لمساعدة الجسم على طرح المادة.',
          'الإدارة العرضية: تناول مضادات الحموضة أو مثبطات مضخة البروتون لتهيج المعدة الشديد.',
          'طلب الرعاية الطبية عند ظهور أعراض حادة كخفقان القلب أو صعوبة التنفس أو النزيف المفرط.',
          'لا يوجد ترياق؛ الإدارة داعمة.',
        ],
      },
      sideEffects: [
        'تحفيز الرحم: الجرعات العالية قد تحفز نظرياً تقلصات الرحم مما يزيد من مخاطر الولادة المبكرة في مراحل الحمل المتأخرة.',
        'اضطرابات الجهاز الهضمي: حرقة المعدة وارتداد حمضي وإسهال وانتفاخ، وهي الآثار الجانبية الأكثر شيوعاً خاصةً عند تناول كميات كبيرة.',
        'تهيج الفم والحلق: قد تحدث حرقة في الفم أو الحلق.',
        'التهاب الجلد التماسي: قد يُسبب التطبيق الموضعي لزيوت الزنجبيل الأساسية احمراراً وتهيجاً جلدياً أو طفحاً تحسسياً.',
        'نشاط مضاد للصفائح الدموية: تثبيط تجمع الصفائح الدموية مما يهيئ المريض لخطر النزيف.',
      ],
      contraindications: [
        'المراحل المتأخرة من الحمل وقرب الولادة: يجب الحذر عند الاستخدام قرب الولادة بسبب النشاط المضاد للصفائح الدموية الخفيف للزنجبيل.',
        'اضطرابات النزيف: يمتلك الزنجبيل تأثيرات مضادة للتخثر مما يجعله غير آمن للنساء المصابات باضطرابات النزيف أو اللواتي يتناولن أدوية مضادة للتخثر مثل الوارفارين.',
        'حالات الحمل عالية الخطورة: ممنوع للنساء الحوامل ذوات التاريخ السريري الموثق من الإجهاضات التلقائية المتكررة أو النزيف المهبلي غير المبرر.',
      ],
      drugInteractions: [
        'مضادات التخثر والأدوية المضادة للصفائح الدموية مثل الوارفارين والأسبرين والكلوبيدوجريل والإينوكساباريين: تفاعل تآزري. يعزز الزنجبيل خطر النزيف عن طريق تثبيط تخليق الثرومبوكسان الصفائحي.',
        'الأدوية المضادة لداء السكري مثل الأنسولين والميتفورمين والسلفونيل يوريا: تفاعل دوائي تراكمي. تعزز الجرعات العالية من الزنجبيل امتصاص الجلوكوز في الأنسجة الحساسة للأنسولين مما يزيد من خطر نقص السكر في الدم.',
        'الأدوية الخافضة لضغط الدم وحاصرات قنوات الكالسيوم مثل أملوديبين ونيفيديبين: يُظهر الزنجبيل نشاطاً طبيعياً في حصر قنوات الكالسيوم الجهدية. قد يُضاعف الاستخدام المتزامن التأثيرات الخافضة لضغط الدم والتأثيرات السالبة للقوة.',
      ],
      storage: {
        forms: [
          { form: 'درجة حرارة الغرفة', instructions: 'يمكن تخزين الجذامير الطازجة لمدة 1 إلى 2 أسبوع في مكان بارد وجاف وجيد التهوية بعيداً عن أشعة الشمس المباشرة.' },
          { form: 'في الثلاجة (4 درجات مئوية)', instructions: 'لمدة 1 إلى 2 شهر.' },
          { form: 'في الفريزر (18 درجة مئوية تحت الصفر)', instructions: 'حتى 6 أشهر.' },
        ],
      },
      botanicalFacts: {
        family: 'فصيلة الزنجبيلية',
        scientificEvidence: 'تؤكد التجارب المعشاة المضبوطة الشاملة أن الزنجبيل تدخل فعّال للغاية وآمن وغير دوائي لإدارة غثيان وقيء الحمل. تُشير المراجعات المنهجية إلى أن فاعليته مماثلة إحصائياً للبيريدوكسين (فيتامين B6) وتفوق بشكل ملحوظ الدواء الوهمي في تخفيف شدة درجات الغثيان، دون أي ارتفاع إحصائي في النتائج السلبية للحمل أو السمية التناسلية للأجنة.',
      },
      symptoms: ['غثيان', 'قيء', 'غثيان الصباح', 'انتفاخ', 'عسر هضم', 'آلام المفاصل', 'احتقان', 'صداع'],
    },
    peppermint: {

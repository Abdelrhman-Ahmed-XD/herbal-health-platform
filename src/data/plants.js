...
export const PLANTS = {
  ...
  'eucalyptus': {
    ...
    commonNames: ['Eucalyptus'],
    category: 'respiratory',
    subcategory: 'sinusitis',
    tags: ['Secretolytic', 'Decongestant', 'Anti-inflammatory', 'Antimicrobial', 'Cineole'],
    image: '/images/Eucalyptus-Sinusitis.jpg',
    shortDescription: '1,8-Cineole-dominant Myrtaceae leaf with triple-action secretolytic, decongestant, and antimicrobial activity; thins mucus, accelerates mucociliary clearance, and relieves nasal congestion and sinus pressure.',
    activeConstituents: [
      { name: '1,8-cineole (also known as Eucalyptol)', detail: 'Acts as a secretolytic and hyperemic agent. Thins mucus, increases ciliary beat frequency to accelerate mucociliary clearance, and possesses significant anti-inflammatory and mild antimicrobial properties.' },
    ],
    moa: [
      { title: 'Secretolytic and Hyperemic Agent', detail: 'Thins mucus and increases ciliary beat frequency to accelerate mucociliary clearance.' },
      { title: 'Anti-inflammatory and Antimicrobial', detail: 'Possesses significant anti-inflammatory and mild antimicrobial properties.' },
    ],
    uses: [
      'Symptomatic relief of nasal congestion, sinus pressure, and upper respiratory tract catarrh.',
    ],
    howToUse: [
      { method: 'Inhalation', instruction: 'Inhalation of essential oil (3–12 drops in steaming water).' },
      { method: 'Oral', instruction: 'Orally via standardized gastro-resistant capsules.' },
    ],
    suitableAgeGroups: [
      { group: 'Adults', notes: 'Generally safe for topical, inhalation, and oral use when properly diluted.' },
      { group: 'Pediatrics', notes: 'Contraindicated in children under 2 years of age due to the risk of laryngospasm or bronchospasm. Steam inhalation is not recommended for children under 12 years of age without medical supervision.' },
      { group: 'Pregnancy & Lactation', notes: 'Not recommended. Safety during pregnancy and lactation has not been clinically established; avoid use without explicit medical advice.' },
      { group: 'Chronic Diseases', notes: 'Caution is advised in patients with asthma or severe respiratory airway hypersensitivity.' },
    ],
    dosage: {
      standard: 'Orally: 100–200 mg of cineole, 2–3 times daily.\nInhalation: 3–12 drops of pure essential oil in steaming water, up to 3 times daily.',
    },
    overdose: {
      intro: 'Ingestion of pure, undiluted essential oil is highly toxic.',
      symptoms: [
        'Gastrointestinal disturbances (epigastric burning, nausea, vomiting, diarrhea).',
        'Central nervous system depression (dizziness, drowsiness, ataxia, coma).',
        'Respiratory depression.',
        'Miosis (pinpoint pupils).',
      ],
      management: [
        'Immediate medical attention is mandatory. Management includes symptomatic support, intensive care monitoring, and gastric lavage if caught early.',
      ],
    },
    sideEffects: [
      'Nausea, vomiting, or diarrhea (upon oral administration).',
      'Localized skin irritation or hypersensitivity reactions (if applied topically).',
    ],
    contraindications: [
    ...
    storage: {
      forms: [
        { form: 'Storage', instructions: 'Store in light-resistant, airtight glass containers in a cool place, well away from children.' },
      ],
    },
    marketedProducts: [
      { name: 'Sinex', image: '/images/Eucalyptus4.jpg' },
      { name: 'Vicks VapoRub', image: '/images/Eucalyptus5.jpg' },
      { name: 'Eucalyptol capsules (e.g., Soledum)', image: '' },
    ],
    benefits: [],
    factsAndMyths: [
      {
        myth: 'More is better; putting pure, undiluted eucalyptus oil directly into the nostrils can cause severe chemical burns to the delicate nasal mucosa and paralyze the cilia.',
        fact: '1,8-cineole is clinically proven (Well-established use by EMA) to significantly reduce sinus headaches, nasal obstruction, and secretions.',
      },
    ],
    botanicalFacts: {
      family: 'Myrtaceae',
      activeCompounds: '1,8-cineole (Eucalyptol)',
    ...
    references: [
      { text: 'European Medicines Agency (EMA) – HMPC. (2014). European Union herbal monograph on Eucalyptus globulus Labill., aetheroleum. (EMA/HMPC/307781/2012).' },
    ],
  },
  ...
  'ginger-cold': {
    ...
    marketedProducts: [
      { name: 'Ginger Capsules 400mg (Mepaco Pharaonia)', image: '/images/Ginger-400mg-Mepaco.jpg' },
      { name: 'Emetal Drops / Capsules (Pharco Pharmaceuticals)', image: '' },
      { name: 'Rani Ginger Effervescent Granules', image: '/images/ginger1.jpg' },

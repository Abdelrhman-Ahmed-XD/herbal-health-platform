...
export const PLANTS = {
    ...
    'aloe-vera': {
        ...
        activeConstituents: [
            {
                name: 'Vitamins A, C, E, B12, Folic Acid, Choline',
                percentage: '',
                effect: 'Potent antioxidants; support cellular protection and metabolic function'
            },
            {
                name: 'Bradykinase (and 7 other enzymes)',
                percentage: '',
                effect: 'Reduces excessive inflammation when applied topically; aids breakdown of sugars and fats'
            },
            {
                name: 'Minerals (Ca, Cr, Cu, Mg, Mn, Zn, K, Na, Se)',
                percentage: '',
                effect: 'Vital for proper cellular metabolism and enzyme function'
            },
            {
                name: 'Acemannan (Mucopolysaccharides / Glucomannans)',
                percentage: '',
                effect: 'Immunomodulatory, anti-inflammatory, and healing effects; enhances skin hydration'
            },
            {
                name: 'Anthraquinones: Aloin, Emodin (Latex only)',
                percentage: '',
                effect: 'Stimulant laxatives; antibacterial, antiviral, and analgesic properties'
            },
            {
                name: 'Plant Sterols: Cholesterol, Campesterol, β-sitosterol',
                percentage: '',
                effect: 'Anti-inflammatory, antiseptic, and localized pain-relieving actions'
            },
            {
                name: 'Auxins and Gibberellins',
                percentage: '',
                effect: 'Promote wound healing and exhibit anti-inflammatory activities'
            },
            {
                name: 'Salicylic Acid, Lignin, Saponins',
                percentage: '',
                effect: 'Anti-inflammatory, antibacterial; enhances skin penetration; cleansing and antiseptic properties'
            },
        ],
        moa: [
            {
                title: 'Wound Healing',
                detail: 'Stimulates fibroblast activity, increases collagen synthesis and promotes wound healing.'
            },
            {
                title: 'Anti-inflammatory Action',
                detail: 'Inhibits the cyclooxygenase (COX) pathway, reducing prostaglandin synthesis and decreasing inflammation.'
            },
            {
                title: 'Antioxidant & Photoprotection',
                detail: 'Antioxidant compounds (vitamins and polyphenols) protect skin cells from oxidative damage and UV radiation.'
            },
            {
                title: 'Skin Hydration',
                detail: 'Enhances skin hydration by retaining moisture through mucopolysaccharides (like acemannan).'
            },
            {
                title: 'Antimicrobial Activity',
                detail: 'Shows broad-spectrum antimicrobial activity against various pathogenic microorganisms.'
            },
            {
                title: 'Immunomodulation',
                detail: 'Modulates immune responses by stimulating macrophages and reducing histamine release from mast cells.'
            },
            {
                title: 'Laxative Effect (Latex only)',
                detail: 'Anthraquinones stimulate intestinal peristalsis and increase water content in the stool, producing a potent laxative effect.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Facial Care',
                instruction: 'Cleanse the skin first, then apply a thin layer of pure aloe gel, massaging gently in an upward motion. Leave on as a lightweight moisturizer or rinse off with lukewarm water after 15 minutes.'
            },
            {
                method: 'Dry Skin',
                instruction: 'Mix a few drops of hydrating oil (jojoba or coconut) with aloe gel before application to boost moisturizing effect.'
            },
            {
                method: 'Oily / Acne-Prone Skin',
                instruction: 'Use pure, unadulterated aloe gel as a lightweight, water-based, non-comedogenic moisturizer.'
            },
            {
                method: 'Hair and Scalp Care',
                instruction: 'Apply fresh or commercial pure aloe gel directly to scalp and hair strands. Massage gently into the scalp, coat hair from roots to ends. Leave for 30–60 minutes to condition, then rinse thoroughly. Use 2–3 times per week as a conditioning treatment. Can be used as a leave-in scalp treatment in small amounts between washes.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Infants (<1 year)',
                notes: 'Oral use strictly contraindicated. Topical use not recommended unless expressly approved by a pediatrician.'
            },
            {group: 'Children (1-5 years)', notes: 'External use only in small amounts; avoid oral use.'},
            {
                group: 'Children (6-12 years)',
                notes: 'Generally safe for topical use (burns, irritation, skincare). Oral latex use strictly avoided due to electrolyte risks.'
            },
            {
                group: 'Adolescents (12-18 years)',
                notes: 'Safe for topical use; limited and cautious oral use (decolorized whole-leaf juice) if clinically indicated.'
            },
            {group: 'Adults', notes: 'Safe for topical and proper oral use when guidelines are followed.'},
            {
                group: 'Pregnant & Breastfeeding Women',
                notes: 'Oral use strictly contraindicated (stimulates uterine contractions; anthraquinones pass into breast milk). Topical use generally considered safe.'
            },
        ],
        dosage: {
            ...
            forms: [
                ...
                {
                    form: 'Laxative / Latex (not for routine use)',
                    dose: 'Approx. 50-200 mg standardized extract. Start with low dose; avoid long-term oral use.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                ...
                {
                    form: 'Freshly extracted natural gel',
                    instructions: 'Keep in an airtight container, refrigerate immediately, and use within 1-2 weeks.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'healing',
                title: 'Wound & Burn Healing',
                desc: 'Stimulates fibroblast activity and collagen synthesis to accelerate repair of wounds and 1st-2nd degree burns.'
            },
            {
                icon: 'water_drop',
                title: 'Deep Skin Hydration',
                desc: 'Acemannan mucopolysaccharides retain moisture for lasting hydration without clogging pores.'
            },
            {
                icon: 'spa',
                title: 'Anti-inflammatory',
                desc: 'Inhibits the COX pathway and reduces prostaglandin synthesis to calm skin irritation and redness.'
            },
            {
                icon: 'science',
                title: 'Antimicrobial',
                desc: 'Broad-spectrum activity against pathogenic microorganisms for skin and wound protection.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                ...
                desc: 'Extract inner leaf gel directly for immediate topical application.',
                bestFor: 'Wound healing, burns, acute skin soothing'
            },
            {
                method: 'Decolorized Oral Juice',
                desc: 'Commercially prepared juice with aloin/latex removed, taken orally at 10-30 mL.',
                bestFor: 'Short-term management of occasional constipation'
            },
            {
                method: 'Topical Skincare Formulation',
                desc: 'Standardized commercial gels or creams containing aloe vera extract.',
                bestFor: 'Daily moisturizing, acne care, and UV protection'
            },
        ],
        ...
        references: [
            {
                ...
                url: 'https://journals.lww.com/ijd/fulltext/2008/53040/aloe_vera__a_short_review.1.aspx'
            },
            {
                text: 'Eshun, K., & He, Q. (2004). Aloe vera: A valuable ingredient for the food, pharmaceutical and cosmetic industries. Critical Reviews in Food Science and Nutrition, 44(2), 91–96.',
                url: 'http://dx.doi.org/10.1016/j.jep.2004.09.006'
            },
    ...
    'tea-tree': {
        ...
        activeConstituents: [
            {
                name: 'Terpinen-4-ol',
                percentage: '35-48%',
                effect: 'Primary active constituent; potent antibacterial, antifungal, and anti-inflammatory properties'
            },
            {
                name: '1,8-Cineole (Eucalyptol)',
                percentage: '<15%',
                effect: 'Anti-inflammatory and mucolytic properties; higher concentrations can induce cutaneous irritation'
            },
            {
                name: 'γ-Terpinene and α-Terpinene',
                percentage: '10-28%',
                effect: 'Significant antioxidant and synergistic antimicrobial support'
            },
            {name: 'p-Cymene and Limonene', percentage: 'minor', effect: 'Aid in topical skin penetration'},
        ],
        moa: [
            {
                title: 'Antimicrobial Action (Antibacterial & Antifungal)',
                detail: 'Terpinen-4-ol is highly lipophilic; penetrates microbial cell walls disrupting the lipid bilayer, causing leakage of essential cellular contents and fatal inhibition of bacterial respiration via membrane-bound electron transport system disruption.'
            },
            {
                title: 'Anti-inflammatory Effect',
                detail: 'Chemically suppresses production of key inflammatory mediators. Downregulates superoxide synthesis by activated macrophages and inhibits TNF-α, IL-1β, and prostaglandin E2 (PGE2) expression.'
            },
            {
                title: 'Anti-Acne Activity',
                detail: 'Exerts direct bactericidal effect against Cutibacterium acnes (formerly Propionibacterium acnes) and reduces localized follicular inflammation.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Facial / Acne Application',
                instruction: 'Dilute 1 drop of pure TTO in 1 teaspoon of non-comedogenic carrier oil (jojoba or mineral oil) to yield ~1% concentration. Apply as spot treatment.'
            },
            {
                method: 'Body Application',
                instruction: 'Blend 2-3 drops per teaspoon of carrier oil. Apply to affected areas.'
            },
            {
                method: 'Scalp Application',
                instruction: 'Blend 3-5 drops per tablespoon of carrier oil or add directly into a mild sulfate-free shampoo.'
            },
            {
                method: 'Antifungal Formulation',
                instruction: 'Use commercially prepared 10-50% topical solutions depending on tissue thickness (nails vs. skin surface).'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pediatrics (<3 years)',
                notes: 'Strictly contraindicated: thin infant skin barrier increases risk of transdermal absorption and systemic neurotoxicity.'
            },
            {group: 'Adults', notes: 'Safe in concentrations up to 5%; 1-2% is often sufficient for facial use.'},
            {
                group: 'Pregnancy & Lactation',
                notes: 'Topical cosmetic use in low concentrations (<2%) generally considered safe. Avoid application near breast area during lactation.'
            },
            {
                group: 'Geriatrics & Chronic Skin Conditions',
                notes: 'Use with heightened caution in individuals with sensitive skin, atopic eczema, or severe psoriasis.'
            },
        ],
        dosage: {
            ...
            forms: [
                ...
                {
                    form: 'Antifungal Topical Solution',
                    dose: '10-50% concentration, applied 1-2 times daily to affected nails/skin.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Essential Oil',
                    instructions: 'Store in tightly sealed dark amber glass bottles in a cool, dry environment protected from sunlight and heat. Exposure to air and light induces auto-oxidation of monoterpenes into highly allergenic peroxide compounds.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'bug_report',
                title: 'Acne Fighter',
                desc: 'Clinically proven bactericidal effect against Cutibacterium acnes, reducing inflammatory and non-inflammatory lesions.'
            },
            {
                icon: 'sanitizer',
                title: 'Broad Antifungal',
                desc: 'Effective against dermatophyte infections causing athlete\'s foot and nail fungus, comparable to topical clotrimazole.'
            },
            {
                icon: 'spa',
                title: 'Scalp Health',
                desc: 'Targets Malassezia furfur to reduce dandruff, scalp itching, and greasiness.'
            },
            {
                icon: 'shield',
                title: 'Natural Antiseptic',
                desc: 'Disinfects minor cuts, abrasions, and insect bites while suppressing local inflammation.'
            },
        ],
        botanicalFacts: {
            family: 'Myrtaceae',
        ...
        preparation: [
            {
                method: 'Diluted Essential Oil',
                desc: 'Dilute in carrier oil (1-5%) before any topical application. Never apply undiluted to skin.',
                bestFor: 'Acne, minor antiseptic, deodorant'
            },
            {
                method: 'Commercial 5% Gel',
                desc: 'Standardized commercial topical formulations for safe, consistent dosing.',
                bestFor: 'Acne vulgaris management'
            },
            {
                method: 'Medicated Shampoo',
                desc: '5% TTO added to mild shampoo for scalp use.',
                bestFor: 'Dandruff, seborrheic dermatitis'
            },
        ],
    ...
    'licorice': {
        ...
        activeConstituents: [
            {
                ...
                percentage: '',
                effect: 'Triterpenoid saponin; anti-inflammatory, anti-ulcer, antiviral; cortisone-like action via 11β-HSD inhibition'
            },
            {
                name: 'Glycyrrhetinic Acid (Enoxolone)',
                percentage: '',
                effect: 'Pharmacologically active aglycone metabolite of glycyrrhizin'
            },
            {
                name: 'Glabridin',
                percentage: '',
                effect: 'Main polyphenolic flavonoid; competitively inhibits tyrosinase to reduce melanin production: skin lightening'
            },
            {
                name: 'Licochalcone A',
                percentage: '',
                effect: 'Potent chalcone derivative; strong antioxidant and anti-inflammatory; neutralizes UV-induced free radicals'
            },
            {
                name: 'Liquiritin',
                percentage: '',
                effect: 'Flavonoid; induces melanin dispersal and removal, fading existing hyperpigmentation and dark spots'
            },
            {
                name: 'Isoliquiritigenin',
                percentage: '',
                effect: 'Flavonoid; contributes to antioxidant, anti-inflammatory, and antispasmodic properties'
            },
        ],
        moa: [
            {
                title: 'Tyrosinase Inhibition (Topical)',
                detail: 'Glabridin competitively inhibits tyrosinase, the key rate-limiting enzyme responsible for melanin production (pigmentation), directly reducing skin darkening.'
            },
            {
                title: 'Anti-Oxidative Stress (Topical)',
                detail: 'Licochalcone A neutralizes free radicals induced by UV exposure, protecting skin cells from oxidative damage.'
            },
            {
                title: 'Melanin Dispersal (Topical)',
                detail: 'Liquiritin induces dispersal and removal of melanin, helping to fade hyperpigmentation and dark spots already present on the skin.'
            },
            {
                title: 'Anti-inflammatory & Cortisone-like Effect (Systemic)',
                detail: 'Glycyrrhizin inhibits cortisol metabolism by blocking 11β-hydroxysteroid dehydrogenase (11β-HSD), prolonging active cortisol life and producing a potent anti-inflammatory glucocorticoid effect.'
            },
            {
                title: 'Mineralocorticoid Effect (Systemic Overdose Pathway)',
                detail: 'Inhibition of 11β-HSD leads to cortisol accumulation in kidneys, causing excessive mineralocorticoid receptor activation, resulting in sodium/water retention and potassium excretion.'
            },
            {
                title: 'Expectorant',
                detail: 'Stimulates tracheal and bronchial secretions to loosen mucus, making it easier to expel.'
            },
            {
                title: 'Demulcent',
                detail: 'Forms a protective soothing film over mucous membranes to relieve irritation in the GI tract (throat and stomach lining).'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'DIY Brightening Mask',
                instruction: 'Mix 1 teaspoon of licorice powder with rose water, milk, yogurt, or honey to form a paste. Apply to clean face, leave 15-20 minutes, rinse with lukewarm water.'
            },
            {
                method: 'Targeted Spot Treatment',
                instruction: 'Mix a pinch of licorice powder with aloe vera gel or honey and apply directly to acne marks or hyperpigmentation for 10-15 minutes before rinsing.'
            },
            {
                method: 'Commercial Topical Products',
                instruction: 'Incorporate serums, toners, or creams containing standardized licorice extract (glabridin) into daily skincare routines.'
            },
            {
                method: 'Oral Tea (Respiratory/Digestive)',
                instruction: 'Steep 1-2 teaspoons of dried chopped root in hot water to relieve coughs or improve digestion. For sore throats: mix 1 teaspoon of powder in warm water for gargling.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Infants (<1 year)',
                notes: 'Oral use strictly contraindicated. Topical use not recommended unless prescribed by a pediatrician.'
            },
            {group: 'Children (1-5 years)', notes: 'External use only in small amounts; oral use strictly avoided.'},
            {
                group: 'Children (6-12 years)',
                notes: 'Safe for topical use in skincare. Oral use strictly limited to prevent pseudoaldosteronism (fluid retention and blood pressure shifts).'
            },
            {
                group: 'Adolescents (12-18 years)',
                notes: 'Safe for topical use (acne, hyperpigmentation). Cautious brief oral use is acceptable within standard limits.'
            },
            {group: 'Adults', notes: 'Safe for topical use and proper oral use when duration limits are followed.'},
            {
                group: 'Pregnancy',
                notes: 'Strictly contraindicated orally: high intake linked to increased risk of preterm labor and fetal neurodevelopmental issues. Low-concentration topical commercial use generally considered safe.'
            },
            {
                group: 'Chronic Disease Patients',
                notes: 'Oral use strictly contraindicated or limited for patients with hypertension, cardiovascular diseases, or renal insufficiency.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Licorice Extract Serum (1–2%), Topical',
                    dose: 'Apply 2–3 drops 1–2 times daily onto clean skin before moisturizer.'
                },
                {
                    form: 'DIY Powder Mask, Topical',
                    dose: 'Mix ½ tsp with yogurt/honey/rose water, apply 2–3 times per week for 10–15 minutes.'
                },
                {
                    form: 'Dried Root, Oral Infusion (Respiratory/GI)',
                    dose: '5–15 g dried root per day (delivers 200–600 mg glycyrrhizin). Maximum continuous use: 4–6 weeks. Infuse 1–2 tsp chopped root in hot water.'
                },
                {
                    form: 'Deglycyrrhizinated Licorice (DGL), GI use',
                    dose: 'Up to 4.5 g daily for up to 4 months. DGL removes glycyrrhizin; safe for patients with cardiovascular or renal concerns.'
                },
                {
                    form: 'Standardized Cough Syrup (e.g., Ventoherb)',
                    dose: 'As per product label. Typically 5–10 mL 2–3× daily for adults.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'All forms',
                    instructions: 'Store in a cool, dry place away from direct sunlight in airtight containers to preserve bioactive compounds and prevent moisture absorption.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                ...
                desc: 'Glabridin inhibits tyrosinase to reduce melanin production: effectively fading dark spots, melasma, and sun damage.'
            },
            {
                icon: 'spa',
                title: 'Soothes Inflammation',
                desc: 'Anti-inflammatory and cortisone-like action calms rosacea, acne redness, and eczema flares.'
            },
            {
                icon: 'shield',
                title: 'Antioxidant Protection',
                desc: 'Licochalcone A neutralizes UV-induced free radicals, protecting against photoaging.'
            },
            {
                icon: 'local_pharmacy',
                title: 'Respiratory & GI Support',
                desc: 'Expectorant and demulcent actions soothe coughs, bronchitis, and gastric ulcers when taken orally.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Topical Serum/Cream',
                desc: 'Standardized commercial products with glabridin (1-2%) for daily skincare.',
                bestFor: 'Hyperpigmentation, melasma, dark spots, rosacea'
            },
            {
                method: 'DIY Face Mask',
                desc: 'Mix licorice powder with honey, yogurt, or rose water for a 15-minute brightening mask.',
                bestFor: 'Skin brightening, acne marks'
            },
            {
                method: 'Oral Root Infusion',
                desc: 'Steep chopped dried root in hot water for respiratory or digestive use.',
                bestFor: 'Cough, sore throat, gastric ulcer support'
            },
        ],
        ...
        references: [
            {
                text: 'Healthline — Licorice Root: Benefits, Dosage, Side Effects, and More.',
                url: 'https://www.healthline.com/nutrition/licorice-root#dosage-and-forms'
            },
            {
                text: 'WebMD — Licorice Uses, Side Effects, Interactions.',
                url: 'https://www.webmd.com/vitamins/ai/ingredientmono-881/licorice#uses'
            },
    ...
    'green-tea': {
        ...
        activeConstituents: [
            {
                name: 'EGCG (Epigallocatechin-3-gallate)',
                percentage: '',
                effect: 'Most abundant and pharmacologically active catechin; antioxidant, anti-inflammatory, 5α-reductase inhibitor, anticancer research'
            },
            {
                name: 'Other Catechins: EC, EGC, ECG',
                percentage: '',
                effect: 'Potent free radical scavengers; antimicrobial and antiviral properties'
            },
            {
                name: 'Caffeine (Methylxanthine Alkaloid)',
                percentage: '',
                effect: 'CNS stimulation; synergistic with EGCG for thermogenesis and sebum reduction; vasoconstriction for under-eye care'
            },
            {
                name: 'L-theanine',
                percentage: '',
                effect: 'Unique amino acid crossing blood-brain barrier; promotes relaxation without drowsiness by modulating GABA and glutamate'
            },
            {
                name: 'Condensed Tannins',
                percentage: '',
                effect: 'Natural astringents; temporarily shrink pores and reduce oiliness by complexing with sebum proteins'
            },
            {
                name: 'Vitamins E and B2',
                percentage: '',
                effect: 'Aid in maintaining skin barrier hydration and cellular turnover'
            },
        ],
        moa: [
            {
                title: 'Antioxidant Activity',
                detail: 'Catechins (especially EGCG) function as potent free radical scavengers, chelating transition metals and upregulating endogenous antioxidant enzymes (superoxide dismutase and catalase).'
            },
            {
                title: 'Anti-inflammatory Effect',
                detail: 'Suppresses inflammatory pathways by inhibiting Nuclear Factor-kappa B (NF-κB), reducing iNOS, COX-2, TNF-α, and IL-1β production.'
            },
            {
                title: 'Antimicrobial Activity',
                detail: 'Catechins disrupt bacterial cell membranes by binding to lipid bilayers and inhibit viral replication (Influenza and HPV) by interfering with viral adsorption.'
            },
            {
                title: 'Metabolic & Thermogenic Regulation',
                detail: 'Caffeine and EGCG synergistically inhibit catechol-O-methyltransferase (COMT), prolonging norepinephrine action, expanding energy expenditure and enhancing fatty acid oxidation.'
            },
            {
                title: 'Topical Sebum Control',
                detail: 'EGCG acts as a natural 5α-reductase inhibitor, preventing conversion of testosterone into DHT, directly reducing sebum production in sebaceous glands.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Facial Toner (Topical)',
                instruction: 'Cooled fresh green tea infusion applied directly via a cotton pad as a soothing antioxidant toner.'
            },
            {
                method: 'Eye Compress',
                instruction: 'Cooled used green tea bags compressed over closed eyelids for 10-15 minutes to reduce puffiness and dark circles.'
            },
            {
                method: 'Oral Infusion (Tea)',
                instruction: 'Steep 2-3 g of dried leaves in hot water at 80-85°C (avoid boiling to prevent tannin bitterness and catechin degradation) for 3-5 minutes.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Oral intake strictly limited to maximum 1-2 cups daily. High doses of caffeine cross the placenta; EGCG may interfere with folic acid absorption. Topical cosmetic use poses negligible systemic risk.'
            },
            {
                group: 'Pediatrics',
                notes: 'High oral doses of caffeine-containing supplements not recommended; moderation with standard dietary intake is essential.'
            },
            {
                group: 'Geriatrics',
                notes: 'Generally safe; clinical vigilance regarding potential interactions with cardiovascular therapies or anticoagulants.'
            },
            {
                group: 'Chronic Diseases',
                notes: 'Use with extreme caution in patients with hepatic impairment, severe renal failure, or clinical anxiety disorders: avoid concentrated oral extracts.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Topical Gel/Cream',
                    dose: '2-3% standardized green tea extract, applied twice daily for dermatological use.'
                },
                {form: 'Brewed Oral Tea', dose: '2-3 g leaves per 200 mL at 80-85°C; 2-3 cups daily.'},
                {
                    form: 'Extract Supplements',
                    dose: 'Must never be taken on an empty stomach due to heightened risk of hepatotoxicity.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'All forms',
                    instructions: 'Store in airtight, opaque containers in a cool, dry environment away from direct sunlight and moisture to prevent rapid auto-oxidation of active polyphenols.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                ...
                desc: 'EGCG catechins scavenge free radicals and protect skin from UV-induced oxidative stress and premature aging.'
            },
            {
                icon: 'face',
                title: 'Acne & Sebum Control',
                desc: '5α-reductase inhibition reduces sebum production; bactericidal against Cutibacterium acnes.'
            },
            {
                icon: 'auto_fix_high',
                title: 'Anti-aging',
                desc: 'Inhibits matrix metalloproteinases (MMPs) to prevent collagen degradation and reduce fine lines.'
            },
            {
                icon: 'visibility',
                title: 'Under-Eye Care',
                desc: 'Caffeine constricts blood vessels to transiently reduce periorbital puffiness and dark circles.'
            },
        ],
        botanicalFacts: {
            family: 'Theaceae',
        ...
        preparation: [
            {
                method: 'Topical Toner',
                desc: 'Brewed, cooled green tea applied with cotton pad to skin.',
                bestFor: 'Daily antioxidant protection, oily/acne-prone skin'
            },
            {
                method: 'Eye Compress',
                desc: 'Cooled used tea bags placed over closed eyelids for 10-15 minutes.',
                bestFor: 'Reducing puffiness and dark circles'
            },
            {
                method: 'Oral Tea',
                desc: 'Brewed at 80-85°C for 3-5 minutes; 2-3 cups daily.',
                bestFor: 'Cardiovascular support, cognitive function, weight management'
            },
        ],
        ...
        references: [
            {
                text: 'National Center for Biotechnology Information — Green Tea.',
    ...
    'rosemary': {
        ...
        activeConstituents: [
            {
                name: 'Carnosic Acid and Carnosol (Phenolic Diterpenes)',
                percentage: '',
                effect: 'Primary lipid-soluble antioxidants; cellular protection and formulation stabilization; mild 5α-reductase inhibition for anti-alopecia action'
            },
            {
                name: 'Rosmarinic Acid',
                percentage: '',
                effect: 'Potent water-soluble antioxidant and anti-inflammatory agent'
            },
            {
                name: 'Caffeic Acid (Phenolic Acid)',
                percentage: '',
                effect: 'Secondary antioxidant and anti-inflammatory support'
            },
            {
                name: 'Genkwanin, Luteolin, Apigenin (Flavonoids)',
                percentage: '',
                effect: 'Antispasmodic and vascular activities'
            },
            {
                name: '1,8-Cineole (Eucalyptol): Volatile Oil',
                percentage: '',
                effect: 'Promotes microcirculation; acts as natural acetylcholinesterase (AChE) inhibitor improving cognitive function'
            },
            {
                name: 'Camphor: Volatile Oil',
                percentage: '',
                effect: 'Local counter-irritant, analgesic, and antimicrobial actions'
            },
            {
                name: 'Alpha-Pinene & Camphene: Volatile Oil',
                percentage: '',
                effect: 'Antiseptic and aromatic properties'
            },
        ],
        moa: [
            {
                title: 'Stimulation of Hair Follicles (Anti-Alopecia)',
                detail: 'Carnosic acid stimulates local microcirculation and tissue perfusion. Acts as mild 5α-reductase inhibitor, disrupting conversion of testosterone into dihydrotestosterone (DHT): the primary hormone responsible for androgenetic alopecia.'
            },
            {
                title: 'Cognitive & Neuroprotective Effects',
                detail: 'Inhalation or absorption of 1,8-cineole acts as a natural acetylcholinesterase (AChE) inhibitor. By preventing acetylcholine breakdown, it improves cholinergic neurotransmission, enhancing focus, memory, and concentration.'
            },
            {
                title: 'Antioxidant Activity',
                detail: 'Carnosic acid and rosmarinic acid function as potent free radical scavengers, chain-breaking antioxidants, and inhibitors of lipid peroxidation.'
            },
            {
                title: 'Anti-inflammatory Action',
                detail: 'Suppresses inflammatory cascades by downregulating COX-2 and iNOS expression, and inhibiting production of leukotrienes and pro-inflammatory cytokines.'
            },
            {
                title: 'Antimicrobial Activity',
                detail: 'Destroys bacterial and fungal cell walls, showing broad-spectrum activity against Malassezia species (causative yeast for dandruff).'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Scalp: Essential Oil',
                instruction: 'Dilute 5 drops of rosemary essential oil in a suitable carrier oil (jojoba, argan, or coconut oil). Massage thoroughly into the scalp 2-3 times weekly; leave for at least 2-4 hours or overnight before rinsing.'
            },
            {
                method: 'Scalp: Aqueous Infusion Spray',
                instruction: 'Prepare rosemary infusion (1–2 g dried leaves in 200 mL boiling water, covered 15 min, then cooled and strained). Pour into a spray bottle and apply 5–10 sprays directly onto the scalp 1–2 times daily as a leave-in treatment. Refrigerate; discard after 7 days.'
            },
            {
                method: 'Skincare: Topical Mask',
                instruction: 'Mix 2-3 drops of rosemary essential oil per teaspoon of carrier oil or aloe vera gel. Apply for 10-15 minutes as an antioxidant face treatment, then rinse thoroughly.'
            },
            {
                method: 'Oral: Herbal Infusion',
                instruction: 'Steep 1-2 g (1-2 teaspoons) of dried leaves in 150-200 mL of hot water (85-90°C) in a covered vessel for 10-15 minutes. Strain and consume 1-3 times daily. Maximum daily: 4-6 g dry herb.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Oral intake in medicinal/concentrated amounts and use of pure essential oil STRICTLY CONTRAINDICATED. Rosemary acts as an emmenagogue and uterine stimulant: can induce pelvic congestion and pose risk of preterm labor or miscarriage. Low-concentration cosmetic topical use away from mammary glands considered low-risk during lactation.'
            },
            {
                group: 'Pediatrics (<6 years)',
                notes: 'Pure rosemary essential oil strictly contraindicated near face/nostrils: camphor and 1,8-cineole content can trigger reflex glottis spasms, respiratory depression, or seizures.'
            },
            {
                group: 'Geriatrics',
                notes: 'Generally safe, but clinical monitoring required for potential interactions with cardiovascular or anticoagulant regimens.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Topical Essential Oil (diluted)',
                    dose: '5 drops in carrier oil applied to scalp 2-3 times weekly.'
                },
                {
                    form: 'Oral Herbal Infusion',
                    dose: '1-2 g dried leaves per 150-200 mL at 85-90°C; 1-3 cups daily (max 4-6 g dry herb/day).'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Foliage',
                    instructions: 'Store in airtight, opaque containers in a cool, dry, dark environment to preserve volatile oil fractions.'
                },
                {
                    form: 'Essential Oil',
                    instructions: 'Dispense in dark amber or cobalt glass bottles tightly sealed, kept away from direct heat and sunlight.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'grass',
                title: 'Hair Regrowth',
                desc: 'Clinically equivalent to Minoxidil 2% for androgenetic alopecia: stimulates follicles and inhibits DHT with fewer side effects.'
            },
            {
                icon: 'psychology',
                title: 'Cognitive Support',
                desc: '1,8-cineole inhibits acetylcholinesterase to enhance memory, focus, and alertness.'
            },
            {
                icon: 'shield',
                title: 'Antioxidant Protection',
                desc: 'Carnosic and rosmarinic acids are potent chain-breaking antioxidants protecting cells from oxidative damage.'
            },
            {
                icon: 'sanitizer',
                title: 'Scalp Antimicrobial',
                desc: 'Broad-spectrum activity against Malassezia species: effectively treats dandruff and seborrheic dermatitis.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Scalp Oil Massage',
                desc: 'Dilute rosemary EO in carrier oil (jojoba/coconut), apply to scalp with massage, leave overnight.',
                bestFor: 'Hair loss (androgenetic alopecia), dandruff'
            },
            {
                method: 'Leave-in Scalp Spray',
                desc: 'Cooled rosemary infusion sprayed onto scalp daily without rinsing.',
                bestFor: 'Scalp circulation, mild hair thinning'
            },
            {
                method: 'Oral Herbal Tea',
                desc: 'Steep 1-2 g dried leaves covered at 85-90°C for 10-15 minutes.',
                bestFor: 'Cognitive support, dyspepsia, antioxidant maintenance'
            },
        ],
        ...
        references: [
            {
                text: 'WebMD — Rosemary Uses, Side Effects, Interactions.',
                url: 'https://www.webmd.com/vitamins/ai/ingredientmono-154/rosemary'
            },
    ...
    'fenugreek': {
        ...
        activeConstituents: [
            {
                name: '4-Hydroxyisoleucine',
                percentage: '0.09%',
                effect: 'Amino acid derivative with antidiabetic activity'
            },
            {
                name: 'Steroidal Saponins (Diosgenin, Yamogenin, Tigogenin)',
                percentage: '0.6-1.7%',
                effect: 'Cholesterol-lowering effect; diosgenin mimics estrogen and may promote breast development'
            },
            {
                name: 'Galactomannan Fiber',
                percentage: '20-30%',
                effect: 'Soluble fiber: lowers blood glucose and cholesterol'
            },
            {
                name: 'Alkaloids: Trigonelline, Gentianine, Choline',
                percentage: '0.5%',
                effect: 'Antidiabetic and neuroprotective effects'
            },
            {
                name: 'Flavonoids / Polyphenols: Quercetin, Orientin, Vitexin',
                percentage: '',
                effect: 'Antioxidant and anti-inflammatory activity'
            },
            {
                name: 'Proteins (Rich in Lysine, Tryptophan)',
                percentage: '20-30%',
                effect: 'Essential for milk protein production'
            },
            {
                name: 'Fixed Oils (PUFAs)',
                percentage: '5-10%',
                effect: 'Rich in polyunsaturated fatty acids; nutritional support'
            },
            {
                name: 'Minerals & Vitamins (Iron, Calcium, Niacin)',
                percentage: '',
                effect: 'Supports maternal recovery and boosts milk nutrient density'
            },
            {
                name: 'Sotolon (Volatile Component)',
                percentage: '',
                effect: 'Responsible for the characteristic maple syrup-like aroma in sweat and breast milk'
            },
        ],
        moa: [
            {
                title: 'Hormonal Stimulation',
                detail: 'Increases prolactin and oxytocin secretion, enhancing milk production and ejection.'
            },
            {
                title: 'Phytoestrogenic Effect',
                detail: 'Diosgenin (a steroidal sapogenin) mimics estrogen and may promote breast development and milk synthesis pathways.'
            },
            {
                title: 'Sweat Gland Stimulation',
                detail: 'May increase milk volume because mammary glands are modified sweat glands: fenugreek\'s sweat-stimulating properties may translate to increased lactation.'
            },
            {
                title: 'Insulin Axis Modulation',
                detail: 'Affects the insulin/GH/IGF-1 axis and promotes milk synthesis genes.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Capsules (Most Common)',
                instruction: 'Take 2-3 capsules (580-610 mg each) three to four times per day.'
            },
            {
                method: 'Tea',
                instruction: 'Steep 1 teaspoon of fenugreek seeds in boiling water for at least 15 minutes, 2-3 times a day.'
            },
            {
                method: 'Powder / Seeds',
                instruction: 'Consume ½ to 1 teaspoon of powder or seeds up to 3 times a day, mixed into water, juice, or food.'
            },
            {
                method: 'Tincture',
                instruction: 'Take 1-2 mL three times a day (check package directions for specific concentration).'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults (18-65+ years)',
                notes: 'Primary users for lactation support, diabetes management, and testosterone support.'
            },
            {group: 'Older Men (40+ years)', notes: 'Used to address declining testosterone levels.'},
            {
                group: 'Women for Lactation',
                notes: 'Used by lactating women to boost milk supply. Leaves only recommended: avoid bark and root.'
            },
            {
                group: 'Children (Small Amounts)',
                notes: 'Considered safe in amounts found in food. Insufficient evidence for large amounts; may cause unusual maple syrup body odors.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Capsules',
                    dose: '2-3 capsules (approx. 500-600 mg each) three times daily (total 6-12 capsules/day).'
                },
            ...
            forms: [
                {
                    ...
                    instructions: 'Store in an airtight container in a dry, dark, and cool environment to prevent staleness and loss of therapeutic properties.'
                },
                {
                    form: 'Brewed Tea',
                    instructions: 'Store in the refrigerator for up to a few days (similar to iced tea).'
                },
                {
                    form: 'Capsules & Supplements',
                    instructions: 'Store at room temperature (68-72°F/20-22°C). Avoid excessive humidity and temperature extremes. Once opened, consume within 12 months. Shelf life 18-24 months properly stored.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                ...
                desc: 'Increases prolactin and oxytocin secretion; some studies report up to 400 mL/day increase in milk volume during early postpartum days.'
            },
            {
                icon: 'favorite',
                title: 'Hormonal Support',
                desc: 'Diosgenin mimics estrogen, supporting mammary gland development and milk synthesis pathways.'
            },
            {
                icon: 'nutrition',
                title: 'Nutrient-Rich',
                desc: 'Provides iron, calcium, and vitamins A and B to rebuild maternal nutrient stores depleted during lactation.'
            },
        ],
        botanicalFacts: {
            family: 'Fabaceae (Leguminosae)',
        ...
        preparation: [
            {
                method: 'Capsules/Tablets',
                desc: '2-3 capsules (500-600 mg) three to four times daily: most convenient and consistent dose.',
                bestFor: 'Lactation support, consistent therapeutic dosing'
            },
            {
                method: 'Seed Tea',
                desc: 'Steep 1 tsp seeds in boiling water for 15 minutes; consume 2-3 cups daily.',
                bestFor: 'Lactation, digestive support'
            },
            {
                method: 'Culinary Use',
                desc: 'Add seeds to food or sprinkle powder into smoothies, yogurt, or soups.',
                bestFor: 'Nutritional supplementation, gradual lactation support'
            },
        ],
        ...
        references: [
            {
                text: 'National Center for Biotechnology Information — Fenugreek.',
                url: 'https://www.ncbi.nlm.nih.gov/books/NBK501779/'
            },
            {
                text: 'ScienceDirect — Fenugreek and breastfeeding.',
                url: 'https://www.sciencedirect.com/science/article/pii/S2213398420300051'
            },
            {
                text: 'Healthline — Fenugreek for Breastfeeding: Does It Help?',
                url: 'https://www.healthline.com/health/breastfeeding/fenugreek-breastfeeding#dose'
            },
            {
                text: 'Avicenna Journal of Phytomedicine — Fenugreek pharmacology.',
                url: 'https://ajp.mums.ac.ir/article_26043_538c31701d3e67cabb73b8c9b84bf5ad.pdf'
            },
        ],
    },
    ...
    'fennel': {
        ...
        activeConstituents: [
            {
                name: 'trans-Anethole (Volatile Oil)',
                percentage: '50-80%',
                effect: 'Phytoestrogen mimicking estrogen; supports mammary gland development; may block dopamine to increase prolactin; antispasmodic and carminative properties'
            },
            {
                name: 'Fenchone (Volatile Oil)',
                percentage: 'up to 11.68%',
                effect: 'Contributes to bitter taste and digestive/antispasmodic effects'
            },
            {
                name: 'Limonene, α-Pinene, Methyl Chavicol',
                percentage: 'minor',
                effect: 'Antimicrobial and aromatic support'
            },
            {
                name: 'Rosmarinic Acid, Caffeoylquinic Acid Derivatives (Phenolic)',
                percentage: '',
                effect: 'Antioxidant and anti-inflammatory activity'
            },
            {
                name: 'Flavonoids: Eriodictyol-7-rutinoside, Quercetin-3-rutinoside',
                percentage: '',
                effect: 'Antioxidant and anti-inflammatory support'
            },
            {
                name: 'Petroselinic Acid, Palmitic Acid (Fatty Acids)',
                percentage: '',
                effect: 'Nutritional fatty acid support'
            },
            {name: 'Calcium, Potassium, Vitamin C', percentage: '', effect: 'Nutritional minerals and vitamins'},
        ],
        moa: [
            {
                title: 'Phytoestrogen (Anethole)',
                detail: 'Fennel seeds contain anethole, which mimics estrogen and supports mammary gland development for milk production.'
            },
            {
                title: 'Dopamine Inhibition',
                detail: 'Anethole may block dopamine, which normally suppresses prolactin secretion: leading to higher prolactin levels and increased milk production.'
            },
            {
                title: 'Prolactin & Milk Volume Enhancement',
                detail: 'May increase prolactin levels and overall breast milk volume through hormonal modulation.'
            },
            {
                title: 'Improved Let-Down Reflex',
                detail: 'Relaxes smooth muscles, helping milk flow more easily during feeding.'
            },
            {
                title: 'Milk Quality Enhancement',
                detail: 'May slightly increase the fat content of breast milk in some studies.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Fennel Tea (Most Common)',
                instruction: 'Steep 1-3 teaspoons of crushed fennel seeds in 8 ounces of boiling water for 10-20 minutes. Cover the cup while steeping to prevent beneficial volatile oils from escaping. Drink 1-3 cups per day.'
            },
            {
                method: 'Seed Consumption',
                instruction: 'Chew on 1 teaspoon of fennel seeds after meals, up to 3 times a day, to aid digestion and support lactation.'
            },
            {
                method: 'Culinary Uses',
                instruction: 'Add crushed seeds to soups, salads, curries, or roasted vegetables for a light anise-like flavor and nutritional benefit.'
            },
            {
                method: 'Lactation Blends',
                instruction: 'Choose teas that combine fennel with other herbs like fenugreek or nettle for synergistic lactation support.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Infants (2-12 weeks)',
                notes: 'Fennel seed oil emulsions used for alleviating colic: under medical supervision only.'
            },
            {
                group: 'Adolescents and Young Adults (13-21 years)',
                notes: 'Used for primary dysmenorrhea; studies involve oral fennel drops.'
            },
            {
                group: 'Adults: Women of Reproductive Age',
                notes: 'Used for PMS, hirsutism, and general digestive health.'
            },
            {
                group: 'Menopausal Women (40-60+)',
                notes: 'Used to reduce hot flashes, improve sleep quality, and manage bone density.'
            },
            {
                group: 'Lactating Women',
                notes: 'Primary use group; 1-3 cups of tea or 500-1,000 mg capsules 2-3 times daily.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Fennel Seed Tea',
                    dose: '1-3 cups daily of 10-20 minute infusion of 1-3 teaspoons crushed seeds.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Fennel Seeds',
                    instructions: 'Store in an airtight glass jar in a cool, dark, dry place. Properly stored, dried seeds remain potent for 6-12 months. Lightly crush just before steeping to release volatile oils.'
                },
                {
                    form: 'Fresh Fennel Bulb/Fronds',
                    instructions: 'Store in a sealed plastic bag in the vegetable crisper. Fresh fennel lasts up to one week in the fridge.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'child_care',
                title: 'Milk Supply Support',
                desc: 'Anethole phytoestrogen and potential prolactin-boosting action support breast milk volume and quality.'
            },
            {
                icon: 'child_friendly',
                title: 'Infant Colic Relief',
                desc: 'Anethole passes through breast milk to soothe infant digestive discomfort and reduce colic crying.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Seed Tea',
                desc: 'Steep 1-3 tsp crushed seeds in boiling water for 10-20 minutes (covered).',
                bestFor: 'Lactation support, infant colic (via breast milk), digestive comfort'
            },
            {
                method: 'Capsules',
                desc: '500-1,000 mg seed powder capsules taken with meals.',
                bestFor: 'Consistent lactation dosing, dysmenorrhea'
            },
            {
                method: 'Culinary Incorporation',
                desc: 'Add to soups, salads, or roasted vegetables.',
                bestFor: 'Nutritional supplementation, mild digestive support'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'Milky Mama — Does Fennel Tea Increase Milk Supply?',
                url: 'https://milky-mama.com/blogs/milk-supply-guide/does-fennel-tea-increase-milk-supply-a-guide-for-breastfeeding-moms'
            },
            {
                text: 'National Center for Biotechnology Information — Fennel.',
                url: 'https://www.ncbi.nlm.nih.gov/books/NBK501793/'
            },
            {
                text: 'Breastfeeding Network — Increasing Milk Supply.',
                url: 'https://www.breastfeedingnetwork.org.uk/factsheet/increasing-milk-supply-use-of-galactagogues/'
            },
            {text: 'Healthline — Fennel Tea Benefits.', url: 'https://www.healthline.com/health/fennel-tea'},
            {
                text: 'Latchette — The Magic of Fennel for Breastfeeding Mums.',
                url: 'https://latchette.com/blogs/blog-posts/the-magic-of-fennel-for-breastfeeding-mums'
            },
    ...
    'moringa': {
        ...
        activeConstituents: [
            {
                name: 'β-sitosterol, Stigmasterol, Campesterol (Phytosterols)',
                percentage: '',
                effect: 'Support hormonal pathways for milk production; anti-inflammatory properties'
            },
            {
                name: 'Quercetin, Kaempferol (Flavonoids)',
                percentage: '',
                effect: 'Potent antioxidants; anti-inflammatory effects that assist milk synthesis'
            },
            {name: 'Saponins', percentage: '', effect: 'Promote prolactin and milk production pathways'},
            {
                name: 'Phenolic Acids',
                percentage: '',
                effect: 'Antioxidant and cellular protective effects in mammary tissue'
            },
            {
                name: 'Essential Amino Acids and Proteins (Lysine, Tryptophan)',
                percentage: '',
                effect: 'Essential for milk protein production'
            },
            {
            ...
            },
            {
                name: 'Vitamins A, C, E',
                percentage: '',
                effect: 'Antioxidants that help with general metabolic support and immune function'
            },
            {
                name: 'Isothiocyanates',
                percentage: '',
                effect: 'Provide anti-inflammatory effects that may assist in the overall process of milk synthesis'
            },
        ],
        moa: [
            {
                title: 'Prolactin Boost',
                detail: 'Increases serum prolactin levels: the primary hormone responsible for producing breast milk.'
            },
            {
                title: 'Mammary Gland Stimulation',
                detail: 'Boosts the development and activity of alveolar cells in the mammary glands.'
            },
            {
                title: 'Nutritional Support',
                detail: 'Provides the necessary nutrients (protein, iron, calcium) required for high-quality milk production.'
            },
            {
                title: 'Anti-inflammatory Effects',
                detail: 'Reduces oxidative stress in the mammary tissue, supporting optimal milk synthesis environment.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Capsules',
                instruction: 'Capsules containing moringa leaf powder are a common, easy way to ensure a consistent dosage.'
            },
        ...
        suitableAgeGroups: [
            {
                group: 'Infants and Young Children (6 months to 5 years)',
                notes: 'As a nutritional supplement in food amounts only.'
            },
            {
                group: 'Children and Adolescents (6-18 years)',
                notes: 'Supports immunity, muscle growth, and brain development. Often added to juices and smoothies.'
            },
            {
                group: 'Young Adults and Adults (19-50 years)',
                notes: 'Provides natural energy, stress balance, iron levels, and breast milk production support.'
            },
            {
                group: 'Lactating Women',
                notes: 'Using LEAVES ONLY: roots, bark, and flowers are strictly contraindicated.'
            },
            {
                group: 'Older Adults (50+)',
                notes: 'Helps manage blood sugar and blood pressure, reduces joint inflammation, and supports eye health.'
            },
        ],
        dosage: {
        ...
        storage: {
            forms: [
                {
                    form: 'Powder Form',
                    instructions: 'Store in a cool, dark, dry place in an airtight container. High heat destroys delicate vitamins and enzymes: do not store near a stove or in direct sunlight.'
                },
                {
                    form: 'Dried Leaves',
                    instructions: 'Store in sealed, opaque/airtight containers to avoid degradation from light and humidity. Properly dried, can last several years.'
                },
                {
                    form: 'Capsules',
                    instructions: 'Store in a cool, dry place away from humidity and temperature extremes.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'child_care',
                title: 'Boosts Milk Volume',
                desc: 'Increases serum prolactin and stimulates mammary alveolar cells: studies report up to 400 mL/day increase in early postpartum.'
            },
            {
                icon: 'nutrition',
                title: 'Exceptional Nutrition',
                desc: 'Rich in protein, iron, calcium, and vitamins A/B/C/E: rebuilds maternal nutrient stores depleted during lactation.'
            },
            {
                icon: 'shield',
                title: 'Immune Support',
                desc: 'Antioxidant flavonoids and anti-inflammatory isothiocyanates benefit both mother and infant.'
            },
            {
                icon: 'favorite',
                title: 'Maternal Recovery',
                desc: 'Supports blood sugar, blood pressure, and reduces oxidative stress in mammary tissue.'
            },
        ],
        botanicalFacts: {
            family: 'Moringaceae',
        ...
        preparation: [
            {
                method: 'Leaf Powder in Food',
                desc: 'Mix 1 tsp-1 tbsp moringa powder into smoothies, yogurt, or soups.',
                bestFor: 'Daily lactation support, nutritional supplementation'
            },
            {
                method: 'Capsules',
                desc: '1-2 capsules twice daily for consistent dosing.',
                bestFor: 'Convenient lactation support with precise dosing'
            },
            {
                method: 'Fresh Leaves (Cooked)',
                desc: 'Cooked like spinach in local dishes.',
                bestFor: 'Culinary integration, nutritional boost'
            },
        ],
        ...
        references: [
            {
                text: 'PubMed Central — Moringa oleifera and lactation.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC9684698/'
            },
            {
                text: 'PubMed Central — Moringa nutritional composition.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12294722/'
            },
            {
                text: 'National Center for Biotechnology Information — Moringa.',
                url: 'https://www.ncbi.nlm.nih.gov/books/NBK501899/'
            },
            {
                text: 'PubMed Central — Moringa oleifera health benefits.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC8373516/'
            },
            {
                text: 'Actas Dermosifiliográficas — Cutaneous toxicity due to Moringa oleifera.',
                url: 'https://www.actasdermo.org/en-cutaneous-toxicity-due-moringa-oleifera-articulo-S1578219021002596'
            },
    ...
    'ginger-menstrual': {
        ...
        activeConstituents: [
            {
                name: 'Gingerols',
                percentage: '',
                effect: 'Abundant in fresh ginger; primarily responsible for anti-emetic effects, while possessing baseline analgesic and anti-inflammatory activities.'
            },
            {
                name: 'Shogaols',
                percentage: '',
                effect: 'Formed via drying or heating; 3 times more potent than gingerols in inhibiting inflammatory markers, while working synergistically to enhance anti-emetic efficacy.'
            },
            {
                name: 'Volatile Oils (e.g., Zingiberene)',
                percentage: '',
                effect: 'Responsible for the characteristic aromatic scent.'
            },
        ],
        moa: [
            {
                title: 'For Pain Relief (Analgesic)',
                detail: 'Acts as a dual inhibitor of the Cyclooxygenase (COX-1 & COX-2) and Lipoxygenase (5-LOX) enzymes. This reduces the production of Prostaglandins and Leukotrienes, the primary chemical mediators of pain and severe uterine contractions.'
            },
            {
                title: 'For Nausea (Anti-emetic)',
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion',
                instruction: 'Infuse the ginger in hot water (covered) for 10 minutes. It is highly recommended to consume the remaining sediment; it is a rich source of Shogaols and essential oils trapped within the plant fibers. Consume with food to minimize irritation to the gastric mucosa.'
            },
        ],
        suitableAgeGroups: [
            {group: 'Females (Adolescents & Adults)', notes: 'For dysmenorrhea management.'},
            {
                group: 'Travelers, Athletes, and Elderly',
                notes: 'For motion sickness and inflammatory joint/muscle pain.'
            },
            {group: 'Pediatrics', notes: 'Not recommended for children under 6 years of age.'},
            {
                group: 'Pregnancy',
                notes: 'Avoided and contraindicated during pregnancy according to the Egyptian Drug Authority (EDA) guidelines.'
            },
            {
                group: 'Lactation',
                notes: 'Safety during lactation has not been established. In the absence of sufficient data, the use during lactation is not recommended.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Powdered Ginger (Dried Extract)',
                    dose: '500 mg to 1000 mg (1 g) per single dose (approx. 1/4 to 1/2 flat teaspoon), taken 2 to 3 times daily. Do not exceed a daily limit of 3 grams per day.'
                },
                {
                    form: 'Fresh Ginger (Rhizome)',
                    dose: '2 to 3 grams per single dose (approx. 1 level teaspoon of finely grated ginger), taken 3 to 4 times daily. Do not exceed a daily limit of 10 grams per day.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'General Storage',
                    instructions: 'Store in airtight, opaque glass containers away from moisture and direct light to maintain the stability of active compounds.'
                },
            ],
        },
        factsAndMyths: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Dysmenorrhea Relief',
                desc: 'Dual COX/LOX inhibition reduces prostaglandins and leukotrienes: efficacy clinically comparable to Ibuprofen (400 mg) and Mefenamic Acid (Ponstan 250 mg) for menstrual pain.'
            },
            {
                icon: 'favorite',
                title: 'Anti-emetic Action',
                desc: 'Peripheral 5-HT3 and muscarinic receptor antagonism suppresses vagal afferent stimulation and accelerates gastric emptying without central nervous system depression.'
            },
            {
                icon: 'fitness_center',
                title: 'Anti-inflammatory',
                desc: 'Effective for joint pain (Arthritis) and muscle soreness in athletes and the elderly through dual enzyme inhibition.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Aqueous Infusion (Covered)',
                desc: 'Infuse fresh or dried ginger in hot water in a covered vessel for 10 minutes. Consume the sediment for maximum shogaol content.',
                bestFor: 'Dysmenorrhea, nausea, motion sickness'
            },
            {
                method: 'Powdered Capsules',
                desc: '500–1000 mg per dose, 3–4 times daily; start 2 days before period onset.',
                bestFor: 'Standardized dysmenorrhea management'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'Egyptian Drug Authority — Zingiber officinale monograph.',
                url: 'https://edaegypt.gov.eg/media/2kuczzhq/zingiber-officinale-roscoe-%DA%86%D9%86%D8%B2%D9%86%D8%A8%D9%8A%D9%84.pdf'
            },
            {
                text: 'Ginger - Uses, Side Effects, and More',
                url: 'https://www.webmd.com/vitamins/ai/ingredientmono-961/ginger?hl=ar-EG#precautions'
            },
        ],
    },
    ...
    'dill-seed-menstrual': {
        ...
        activeConstituents: [
            {
                name: 'Carvone (Primary Essential Oil)',
                percentage: 'up to 60%',
                effect: 'Key bioactive molecule for gastrointestinal and smooth muscle (uterine) spasmolytic relief; carminative activity'
            },
            {
                name: 'Limonene (Secondary Essential Oil)',
                percentage: '',
                effect: 'Antioxidant and hepatic enzyme inducer; secondary antibacterial properties'
            },
            {
                name: 'α-Phellandrene (Secondary Essential Oil)',
                percentage: '',
                effect: 'Provides secondary antibacterial properties'
            },
        ],
        moa: [
            {
                title: 'Spasmolytic & Antispasmodic Activity',
                detail: 'Exhibits direct smooth muscle relaxant and spasmolytic effects in the gastrointestinal and uterine tracts. Acts by modulating intracellular calcium availability and blocking voltage-dependent calcium influx, effectively mitigating severe contractions or colic.'
            },
            {
                title: 'Carminative Effect',
                detail: 'Volatile essential oils (primarily Carvone) stimulate gastrointestinal motility and induce localized relaxation of the lower esophageal sphincter (LES). This spasmolytic action facilitates the rapid expulsion of trapped gas, relieving debilitating flatulence or bloating.'
            },
            {
                title: 'Antimicrobial Action',
                detail: 'Documented in vitro bacteriostatic and antiseptic efficacy against common intestinal pathogens, specifically E. coli and Staphylococcus species.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Dill Seed Tea)',
                instruction: 'Infuse 1 teaspoon (approximately 3 g) of CRUSHED seeds in 200-250 mL of boiling water in a strictly COVERED vessel for 10 minutes to prevent escape of volatile carvone.'
            },
            {method: 'Adult Dry Powder', instruction: '3 grams of dried powder administered daily in divided doses.'},
            {
                method: 'Adult Concentrated Pure Essential Oil',
                instruction: '0.05-2 mL (or 0.1-0.3 g) total daily, strictly divided into 3 distinct doses per day.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pediatrics (<12 months)',
                notes: 'Not recommended: potential renal and gastric irritation by volatile monoterpenes.'
            },
            {
                group: 'Pregnancy',
                notes: 'STRICTLY PROHIBITED AND CONTRAINDICATED: classified medically as an abortifacient and potent emmenagogue; can stimulate severe uterine contractions, risking miscarriage or fetal demise.'
            },
            {
                group: 'Lactation',
                notes: 'Egyptian Drug Authority (EDA) advises strict caution: insufficient clinical safety data regarding infant\'s exposure via breast milk despite traditional galactagogue use.'
            },
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Crushed Seed Tea',
                    dose: '1 tsp (~3 g) crushed seeds per 200-250 mL covered boiling water, 10 min; drink 2-3 times daily.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Dill Seeds',
                    instructions: 'Store in tightly sealed, airtight glass containers, protected completely from direct light, moisture, and high heat environments to maintain the absolute chemical stability of the active Carvone molecule.'
                },
            ],
        },
        factsAndMyths: [
        ...
        marketedProducts: [
            {
                name: 'Gripe Water Liquid (Pharco Pharmaceuticals / Various Manufacturers — Standardized dill water for infantile colic)',
                image: null
            },
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Dysmenorrhea Relief',
                desc: 'Carvone-driven spasmolytic activity relieves severe uterine cramping: comparable in clinical trials to Mefenamic Acid (Ponstan).'
            },
            {
                icon: 'nutrition',
                title: 'Digestive Spasmolytic',
                desc: 'Relaxes gastrointestinal smooth muscle to relieve flatulence, dyspepsia, bloating, and stomach cramps.'
            },
            {
                icon: 'child_friendly',
                title: 'Infant Colic',
                desc: 'Historical gold standard for infantile colic: the primary active ingredient in traditional Gripe Water formulas.'
            },
            {
                icon: 'sanitizer',
                title: 'Antimicrobial',
                desc: 'Bacteriostatic against E. coli and Staphylococcus species in the gastrointestinal tract.'
            },
        ],
        botanicalFacts: {
            family: 'Apiaceae',
        ...
        preparation: [
            {
                method: 'Covered Seed Tea',
                desc: 'Crush 1 tsp seeds IMMEDIATELY before steeping in covered boiling water for 10 minutes.',
                bestFor: 'Dysmenorrhea, flatulence, infantile colic, digestive cramps'
            },
            {
                method: 'Dry Powder',
                desc: '3 g daily in divided doses mixed with food or water.',
                bestFor: 'Consistent therapeutic dosing for dysmenorrhea or dyspepsia'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'Egyptian Drug Authority — Anethum graveolens monograph.',
                url: 'https://edaegypt.gov.eg/media/kixhbxbj/anethum-graveolens-l-%D8%B4%D8%A8%D8%AA.pdf'
            },
            {
                text: 'NIT — Effect of Dill (Anethum graveolens) on the severity of primary dysmenorrhea in compared with mefenamic acid: A randomized, double-blind trial.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4115348/'
            },
            {
                text: 'NIT — Clinical trial for the management dysmenorrhea using selected spices.',
                url: 'https://pubmed.ncbi.nlm.nih.gov/31383440/'
            },
        ],
    },
    ...
    'cinnamon-menstrual': {
        ...
        activeConstituents: [
            {
                name: 'trans-Cinnamaldehyde (Primary Volatile)',
                percentage: '',
                effect: 'Primary compound responsible for the vast majority of cinnamon\'s systemic pharmacological activities: analgesic, anti-inflammatory, antimicrobial'
            },
            {
                name: 'Eugenol (Volatile Phenolic)',
                percentage: '',
                effect: 'Powerful local anesthetic and targeted anti-inflammatory agent within mucosal tissues'
            },
            {
                name: 'Condensed Tannins (High Molecular Weight Polyphenols)',
                percentage: '',
                effect: 'Astringent properties; modify local uterine vascular hemodynamics; reduce menorrhagia'
            },
            {
                name: 'Coumarin (TRACE in Ceylon; HIGH in Cassia)',
                percentage: 'negligible in Ceylon',
                effect: 'Anticoagulant; chronic high levels (Cassia) cause severe hepatotoxicity: use Ceylon only for therapeutic protocols'
            },
        ],
        moa: [
            {
                title: 'Analgesic & Anti-inflammatory Effect',
                detail: 'Acts as a direct chemical inhibitor of both COX (cyclooxygenase) and LOX (lipoxygenase) enzymatic cascades, arresting downstream biosynthesis of pro-inflammatory prostaglandins.'
            },
            {
                title: 'Hemostatic Activity',
                detail: 'Dense tannin fraction functions as a localized astringent, reducing heavy menstrual blood loss by inducing targeted vasoconstriction within the hyperemic uterine lining.'
            },
            {
                title: 'Uterorelaxant Effect',
                detail: 'Induces direct, non-specific relaxation of the uterine smooth muscle wall, effectively alleviating severe cramping and hyper-reactivity.'
            },
            {
                title: 'Endocrine & Insulin Modulation',
                detail: 'Significantly enhances peripheral insulin sensitivity, optimizing cellular glucose disposal and downregulating circulating androgens: highly beneficial for PCOS patients.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Tea)',
                instruction: 'Infuse 1 gram of crushed CEYLON cinnamon bark in boiling water for 10 minutes in a sealed vessel.'
            },
            {
                method: 'Therapeutic Dose Range',
                instruction: 'Administer 1-4 grams of dried bark daily, strictly divided into multiple smaller doses throughout the day. Maximum absolute daily limit: 6 grams.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults (18+ years)',
                notes: 'Primary demographic for therapeutic administration: metabolic or gynecological disorders.'
            },
            {
                group: 'Pediatrics & Adolescents (<18 years)',
                notes: 'Safe in standard small culinary amounts as dietary flavoring. High-dose therapeutic protocols not recommended by Egyptian Drug Authority (EDA).'
            },
            {
                group: 'Pregnancy',
                notes: 'STRICTLY CONTRAINDICATED in high therapeutic doses: potential emmenagogue actions and theoretical uterine stimulant risks.'
            },
            {
                group: 'Liver Disease',
                notes: 'STRICTLY CONTRAINDICATED if using Cassia cinnamon: dangerous potential for coumarin-induced hepatotoxicity.'
            },
        ],
        dosage: {
            ...
            forms: [
                {form: 'Dried Bark Infusion (CEYLON)', dose: '1-4 g daily in divided doses; max 6 g/day.'},
                {
                    ...
                    dose: 'Per manufacturer\'s standardized protocol for specific condition (dysmenorrhea, PCOS, metabolic support).'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Bark / Sticks / Powder',
                    instructions: 'Must be stored in strictly airtight, opaque glass containers away from thermal fluctuations to completely prevent the rapid oxidation and evaporation of active Cinnamaldehyde.'
                },
            ],
        },
        factsAndMyths: [
        ...
        benefits: [
            {
                ...
                desc: 'Dual COX/LOX inhibition reduces prostaglandin synthesis, clinically decreasing menstrual pain intensity, nausea, and vomiting.'
            },
            {
                icon: 'bloodtype',
                title: 'Controls Menorrhagia',
                desc: 'Condensed tannins act as localized astringents in the uterine lining, effectively reducing excessive menstrual blood loss.'
            },
            {
                icon: 'favorite',
                title: 'PCOS Support',
                desc: 'Enhances peripheral insulin sensitivity and downregulates circulating androgens: a key benefit for PCOS management.'
            },
            {
                icon: 'sanitizer',
                title: 'Antimicrobial',
                desc: 'Potent antifungal and antibacterial activity against Candida albicans and common gastrointestinal pathogens.'
            },
        ],
        botanicalFacts: {
            family: 'Lauraceae',
        ...
        preparation: [
            {
                method: 'Bark Infusion (Ceylon Only)',
                desc: 'Infuse 1 g crushed Ceylon bark in sealed boiling water for 10 minutes.',
                bestFor: 'Dysmenorrhea, menorrhagia, PCOS, digestive complaints'
            },
            {
                method: 'Standardized Extract Capsules',
                desc: 'Commercially standardized Ceylon cinnamon capsules for consistent therapeutic dosing.',
                bestFor: 'PCOS, blood sugar management, metabolic support'
            },
        ],
        ...
        references: [
            ...
            {text: 'Chevallier, A. (2016). Encyclopedia of Herbal Medicine (3rd ed.). DK Publishing.'},
            {
                text: 'Egyptian Drug Authority — Cinnamomum verum monograph.',
                url: 'https://www.edaegypt.gov.eg/media/jvknpkbg/cinnamomum-verum-j-presl.pdf'
            },
        ],
    },
    ...
    'ginger-pregnancy': {
        ...
        activeConstituents: [
            {
                ...
                percentage: '',
                effect: 'Main pungent principles responsible for the therapeutic benefits.'
            },
            {
                name: 'Terpenoids (Zingiberene, Zingiberol)',
                percentage: '',
                effect: 'Other active constituents of ginger.'
            },
        ],
        moa: [
            {
                title: 'Gastrointestinal Stimulation',
                detail: 'Ginger increases gastric tone and peristalsis (motion). By speeding up gastric emptying, it reduces the amount of time food sits in the stomach, thus reducing nausea.'
            },
            {
                title: 'Serotonin (5-HT3) Receptor Antagonism',
                detail: 'Ginger compounds (gingerols and shogaols) act as competitive antagonists at peripheral and central serotonin (5-HT3) receptors. Serotonin is a key neurotransmitter that causes vomiting when released in response to nausea, and blocking it reduces this sensation.'
            },
            {
                title: 'Direct Action on the Gut',
                detail: 'Ginger is thought to exert much of its antiemetic effect locally within the gastrointestinal tract.'
            },
            {
                title: 'Anti-inflammatory and Carminative Effects',
                detail: 'Ginger provides relief from dyspepsia (upset stomach) and helps with motility issues.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Fresh Ginger Tea',
                instruction: 'Steep 1–2 teaspoons of grated or sliced fresh ginger root in hot water for 5–10 minutes.'
            },
            {
                method: 'Ginger Capsules',
                instruction: 'Look for supplements containing 250 mg of ginger powder, often taken 2–4 times daily, ensuring they are approved by a healthcare professional.'
            },
        ],
        suitableAgeGroups: [
            {group: 'Children (Under 2 years)', notes: 'Use of medicinal amounts is generally not recommended.'},
            {
                group: 'Children (2 years and older)',
                notes: 'Small amounts, such as small quantities of fresh ginger in food, can be used for nausea or cold symptoms.'
            },
            {group: 'Adults (18+ years)', notes: 'Moderation is advised, as very high amounts may not be appropriate.'},
            {
                group: 'Pregnant Women',
                notes: 'Medicinal, standardized low doses (up to 1 g/day) are clinically effective and safe, provided it is monitored by a healthcare provider.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Pregnancy',
                    dose: 'Standardized dosage of 250 mg orally, 4 times daily (Total maximum dose: 1,000 mg / 1 gram daily). Higher doses during pregnancy should be used cautiously due to limited safety data.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Room Temperature',
                    instructions: 'Raw rhizomes can be stored for 1–2 weeks in a cool, dry, well-ventilated area away from direct sunlight.'
                },
        ...
        references: [
            {
                text: 'PMC — Safety of ginger rhizome for decreasing nausea and vomiting in women during early pregnancy.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC6616534/'
            },
            {
                text: 'PMC — A systematic review and meta-analysis of the effect and safety of ginger in the treatment of pregnancy-associated nausea and vomiting.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4228518/'
            },
            {
                text: 'PMC — Safety of ginger use in pregnancy: results from a large population-based cohort study.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4755634/'
            },
            {
                text: 'ScienceDirect — Ginger in pregnancy research.',
                url: 'https://www.sciencedirect.com/science/article/pii/S216183132400142X'
            },
        ],
    },
    ...
    'psyllium-pregnancy': {
        ...
        moa: [
            {
                title: 'Water Retention & Lubrication',
                detail: 'Psyllium absorbs water, increasing the moisture content of stool, which keeps it soft and eases transit through the intestines, helping to combat constipation caused by increased progesterone levels and reduced bowel motility.'
            },
            {
                title: 'Bulk Formation',
                detail: 'The gel-like mass increases the physical volume (bulk) of stool, stimulating stretch receptors in the bowel wall, which triggers the urge to defecate.'
            },
            {
                title: 'Local Action',
                detail: 'Because it is not absorbed systemically, it works locally within the GI tract without causing fetal exposure, making it a commonly preferred treatment.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Consult Your Provider',
                instruction: 'Always check with your doctor or midwife before starting, particularly if you have other health issues.'
            },
            {
                method: 'Crucial Hydration',
                instruction: 'Drink at least 8 ounces (240 mL) of water or juice with each dose. Inadequate fluid intake can lead to blockage.'
            },
            {
                method: 'Start Slow',
                instruction: 'Begin with 1 teaspoon/day and gradually increase to 1 tablespoon up to 3 times daily to minimize gas and bloating.'
            },
            {
                method: 'Timing',
                instruction: 'Take psyllium at least 2 hours apart from prenatal vitamins and other medications to avoid interfering with nutrient absorption.'
            },
            {
                method: 'Usage Duration',
                instruction: 'Avoid prolonged use without consulting a healthcare professional.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults and Children (6+ years)',
                notes: 'Generally safe for adults and children over the age of 6, though many pediatric guidelines suggest consulting a doctor for children under 12.'
            },
        ],
        dosage: {
            forms: [
        ...
        storage: {
            forms: [
                {
                    form: 'Psyllium Husk',
                    instructions: 'Psyllium husk should be stored at room temperature (59°F to 86°F or 15°C to 30°C) in a cool, dry, dark place, away from direct sunlight, moisture, and heat sources.  \n' +
        ...
        references: [
            {
                text: 'LactMed Database — Psyllium monograph.',
                url: 'https://www.ncbi.nlm.nih.gov/books/n/lactmed/LM471/?report=reader'
            },
            ...
            {
                text: 'PMC — Review of psyllium fiber and clinical applications.',
    ...
    'peppermint-pregnancy': {
        ...
        activeConstituents: [
            ...
            {
                name: 'Non-Volatile Compounds ',
                percentage: '',
                effect: 'Flavonoids (luteolin, eriocitrin), phenolic acids (rosmarinic acid), and triterpenes '
            },
            {
                name: 'Other key active constituents ',
                percentage: '',
                effect: 'include menthyl acetate, 1,8-cineole (eucalyptol), and limonene, which contribute to its refreshing aroma and respiratory benefits '
            },
        ],
        moa: [
            {
                title: 'Gastrointestinal Smooth Muscle Relaxation',
                detail: 'By reducing the inflow of calcium, peppermint relaxes the muscles of the stomach and intestines, reducing spasms, esophageal dysmotility, and overall nausea.'
            },
            {
                title: 'Carminative Action',
                detail: 'Peppermint aids in reducing gas and improving digestion, which helps relieve the abdominal discomfort often associated with pregnancy.'
            },
            {
                title: 'Aromatherapy Mechanism',
                detail: 'When inhaled, the compounds in peppermint oil (menthol) are absorbed through the olfactory system, which may influence the central nervous system to reduce the severity of nausea.'
            },
            {
                title: 'Anxiety Reduction',
                detail: 'It can help reduce anxiety during pregnancy and labor, which often accompanies morning sickness.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Tea',
                instruction: 'Drinking 1–2 cups of peppermint tea daily (using tea bags or dried leaves) is considered safe for morning sickness and indigestion.'
            },
            {
                method: 'Aromatherapy',
                instruction: 'Inhaling peppermint essential oil via a diffuser or a cotton ball can safely help reduce nausea, particularly during the first trimester.'
            },
            {method: 'Culinary', instruction: 'Peppermint-flavored candies or food items in moderation are safe.'},
        ],
        suitableAgeGroups: [
            {
                group: 'Essential Oil (Aromatherapy/Topical)',
                notes: 'Generally safe for children over age 3. Do not use on children under 30 months (2.5 years) as it can cause seizures or breathing issues.'
            },
            {group: 'Adults and Children (8+ years)', notes: 'Safe and recommended for IBS management.'},
            {
                group: 'Peppermint Tea',
                notes: 'Generally safe in moderate amounts for younger children, but not recommended for infants.'
            },
        ...
        dosage: {
            forms: [
                {
                    form: 'Peppermint Tea',
                    dose: 'may be consumed in moderate amounts during pregnancy, commonly 1–2 cups daily. '
                },
                {
                    form: ' Peppermint essential oil aromatherapy',
                    dose: 'commonly uses 2–4 drops for inhalation. High doses should be avoided during pregnancy due to limited safety data.'
                },
            ],
        },
        overdose: {
        ...
        references: [
            {
                text: 'PMC — The effect of peppermint on nausea and vomiting during pregnancy.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC5960050/'
            },
            {text: 'LactMed Database — Peppermint monograph.', url: 'https://www.ncbi.nlm.nih.gov/books/NBK501851/'},
            {
                text: 'PMC — Herbal medicine use in pregnancy: results of a multinational study.',
    ...
    'cranberry-pregnancy': {
        ...
        moa: [
            {
                title: 'Inhibition of E. coli Adhesion (Anti-Adhesion Activity)',
                detail: 'The active compounds, specifically A-type proanthocyanidins (PACs), interfere with the ability of P-fimbriated Escherichia coli (E. coli) a common cause of UTIs during pregnancy ,to attach to the epithelial cells lining the urinary tract. \n'
            },
            {
                title: 'Structural Disruption of Fimbriae',
                detail: 'Cranberry constituents can change the conformation of surface molecules on E. coli, interfering with fimbrial adhesion mechanisms.'
            },
            {
                title: 'Fructose Inhibition',
                detail: 'Fructose present in cranberries acts in conjunction with PACs to inhibit the adhesion of type 1 pili to the bladder wall.'
            },

            {
                title: 'Direct Antibacterial and Anti-inflammatory Effects',
                detail: 'Beyond adhesion prevention, components of cranberry may help reduce bacterial adherence and inflammation associated with UTIs.'
            },
            {
                title: 'Modification of Urinary Environment',
                detail: 'Metabolites from ingested cranberry, when excreted in urine, decrease the adherence capacity of E. coli and other Gram-negative bacteria to uroepithelial cells.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Juice Formulation',
                instruction: 'Choose 100% pure, unsweetened cranberry juice to minimize added sugar.'
            },
            {
                method: 'Alternative Forms',
                instruction: 'Dried cranberries can be added to yogurt or salads, and fresh cranberries can be added to smoothies.'
            },
            {
                method: 'Supplements',
                instruction: 'Capsules or Tablets: If you take supplements, follow the specific dosing instructions on the packaging.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pediatric Use',
                notes: 'Standardized extracts and therapeutic doses are safe for children (typically above 2–3 years old) and adults to help prevent UTIs and for nutritional benefits.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Cranberry Juice',
                    dose: '240–300 mL daily; higher amounts may be used in some studies but should be consumed cautiously due to gastrointestinal discomfort and sugar content.'
                },
                {
                    form: 'Cranberry Capsules/Tablets',
                    dose: 'Standardized products providing approximately 36 mg of A-type proanthocyanidins (PACs) daily are most commonly studied for prevention of recurrent urinary tract infections (UTIs) during pregnancy.'
                },
            ],
        ...
        storage: {
            forms: [
                {
                    form: 'Refrigerator Storage',
                    instructions: 'To maintain the stability of bioactive compounds (anthocyanins and PACs), cranberry products (such as juice or processed purees) should be kept refrigerated.ensure products are not left in direct sunlight or warm, humid environments, as this degrades the antioxidant benefits.'
                },
            ],
        },
        marketedProducts: [
        ...
        references: [
            ...
            {
                text: 'PMC — Cranberries for preventing urinary tract infections.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3924191/'
            },
    ...
    'butterbur': {
        ...
        activeConstituents: [
            {
                name: 'Petasin, Isopetasin, and Neopetasin',
                detail: 'Considered responsible for the pharmacological activity.'
            },
        ],
        moa: [
            {
                title: 'Leukotriene Inhibition',
                detail: 'Reduces leukotriene production, decreasing allergy and inflammation.'
            },
            {title: 'Antihistamine Effects', detail: 'Decreases histamine release, reducing sneezing and itching.'},
            {
                title: 'Anti-inflammatory Activity',
                detail: 'Inhibits COX-2 and lowers prostaglandin E2 to reduce inflammation.'
            },
            {
                title: 'Calcium Channel Modulation',
                detail: 'Blocks calcium channels, reducing vascular constriction and inflammation.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Oral Tablet or Capsule',
                instruction: 'Generally taken orally in tablet or capsule form, with studies suggesting dosages of 50–150 mg daily, often divided into two or three doses.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults (18+)',
                notes: 'Most clinical trials for allergic rhinitis have been conducted on adults (mean age often 35–39).'
            },
        ...
        storage: {
            forms: [
                {
                    form: 'Container',
                    instructions: 'Keep capsules or tablets in their original, sealed packaging to maintain stability and prevent contamination.'
                },
        ...
        marketedProducts: [
            ...
            {name: 'Solaray, Vital Extracts, Butterbur (50 mg)', image: ''},
        ],
        benefits: [],
        factsAndMyths: [
            {
        ...
        references: [
            {
                text: 'American Academy of Allergy, Asthma and Immunology — Butterbur.',
                url: 'https://www.aaaai.org/allergist-resources/ask-the-expert/answers/old-ask-the-experts/butterbur'
            },
            {
                text: 'National Center for Biotechnology Information — Butterbur.',
                url: 'https://www.ncbi.nlm.nih.gov/books/NBK537160/'
            },
            {
                text: 'National Center for Complementary and Integrative Health — Butterbur.',
                url: 'https://www.nccih.nih.gov/health/butterbur'
            },
            {text: 'Europe PMC — Petasites hybridus pharmacology.', url: 'https://europepmc.org/article/pmc/64514'},
            {
                text: 'Nutricost Butterbur Extract — Product example (Ubuy Egypt).',
                url: 'https://www.ubuy.com.eg/en/product/R9HT036-nutricost-butterbur-extract-capsules-75mg-120-capsules-gluten-free-and-non-gmo'
            },
            {
                text: 'National Center for Biotechnology Information — Butterbur safety.',
                url: 'https://www.ncbi.nlm.nih.gov/books/NBK547997/'
            },
        ],
    },
    ...
    'stinging-nettle': {
        ...
        activeConstituents: [
            {
                ...
                detail: 'Polyphenols, carotenoids, and CMA inhibit enzymes to reduce allergy-induced inflammation.'
            },
            {
                name: 'Antihistamine',
                detail: 'Amentoflavone and alpha-tocotrienol act as natural blockers for histamine receptors (HR1).'
            },
            {name: 'Mediators', detail: 'The plant also contains compounds like serotonin and acetylcholine,'},
        ],
        moa: [
            {
                title: 'Histamine Antagonism',
                detail: 'Acts as an antagonist and negative agonist against H₁ receptors to reduce allergy symptoms.'
            },
            {
                title: 'Mast Cell Stabilization',
                detail: 'Stabilizes mast cell membranes to limit the release of histamine and proinflammatory cytokines.'
            },
            {
                title: 'Enzyme Inhibition',
                detail: 'Inhibits COX-1, COX-2, and HPGDS enzymes, which are key to pro-inflammatory pathways.'
            },
            {
                title: 'Tryptase Inhibition',
                detail: 'Blocks mast cell tryptase, preventing nasal tissue damage and inflammation.'
            },
            {
                title: 'Eosinophil Reduction',
                detail: 'Decreases the count of eosinophils, the white blood cells that multiply during allergic reactions.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'How to use',
                instruction: 'Consuming dried leaf capsules (approx. 600mg daily), drinking 3-4 cups of tea daily, or taking tinctures.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Children under 12',
                notes: 'Generally, nettle preparations should not be used in children younger than 12 years due to a lack of safety data.'
            },
            {
                group: 'Adults (18+)',
                notes: 'Most clinical trials for rhinitis and other conditions (like BPH) focus on adults, often with a mean age in the 20s–60s range.'
            },
        ],
        dosage: {
        ...
        contraindications: [
            'Allergy (Asteraceae Family): Cross-reactivity is possible for those sensitive to ragweed, chrysanthemums, marigolds, or daisies.',
            'Liver Disease: Unprocessed butterbur contains PA compounds that can cause liver damage.',
            'Pregnancy/Lactation: Insufficient safety evidence exists; PA components can pass through breast milk.',
            'Drug Interactions: Avoid if taking medications that induce CYP3A4 enzymes (which increase liver toxicity) or other anticholinergic medications.',
            'Uncertified Products: Only use products specifically labeled "PA-free" (pyrrolizidine alkaloid-free) to avoid liver injury.',
        ],
        drugInteractions: [],
        storage: {
            forms: [
                {
                    form: 'Freeze-Dried Nettle (Most Effective Form)',
                    instructions: 'Keep commercial capsules or home-processed freeze-dried powder in airtight, amber-colored glass jars. Store in a cool, dark pantry away from heat, direct sunlight, and moisture. Shelf Life: Stays highly potent for up to 1 to 2 years if unexposed to air.'
                },
                {
                    form: 'Frozen Blanched Nettle (For Culinary Use)',
                    instructions: 'Pack the blanched nettles tightly into heavy-duty plastic freezer bags. Ensure all excess air is fully squeezed out of the bag before sealing. Shelf Life: Can be frozen for 6 to 8 months.'
                },
                {
                    form: 'Prepared Liquids (Infusions & Liquid Extracts)',
                    instructions: 'Nettle Tea/Decoctions: Once the liquid is strained, it should be sealed in a glass jar.'
                },
                {
                    form: 'Air-Dried Loose Leaf (For Nettle Tea)',
                    instructions: 'Keep in airtight glass jars or clean containers in a dark cabinet (away from light). Shelf Life: Up to 1 year. Note: Discard if you notice mold or a musty smell.'
                },
            ],
        },
        marketedProducts: [
        ...
        references: [
            {
                text: 'National Center for Biotechnology Information — Stinging Nettle.',
                url: 'https://www.ncbi.nlm.nih.gov/books/NBK537160/'
            },
            {
                text: 'WebMD — Stinging Nettle Uses and Risks.',
                url: 'https://www.webmd.com/vitamins/ai/ingredientmono-664/stinging-nettle'
            },
            {
                text: 'Clinician.com — Stinging Nettles and Hay Fever.',
                url: 'https://www.clinician.com/articles/46213-can-stinging-nettles-take-the-sting-out-of-hay-fever'
            },
            {
                text: 'A.Vogel — How can nettle help your allergies?',
                url: 'https://www.avogel.co.uk/health/allergic-rhinitis/how-can-nettle-help-your-allergies/'
            },
            {
                text: 'WebMD — Stinging Nettle Uses and Risks.',
                url: 'https://www.webmd.com/vitamins-and-supplements/stinging-nettle-uses-and-risks'
            },
            {
                text: 'PubMed Central — Nettle leaf anti-inflammatory activity.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC5963652/'
            },
        ],
    },
    ...
    'black-seed-rhinitis': {
        ...
        activeConstituents: [
            {
                name: 'Essential Oils',
                detail: 'Thymoquinone (main active compound), dithymoquinone, thymohydroquinone, p-cymene, carvacrol, thymol, α-pinene.'
            },
            ...
            {
                name: 'Fixed Oils & Fatty Acids',
                detail: '32–40% oil containing linoleic acid (Omega-6), oleic acid (Omega-9), palmitic acid, plus sterols like β-sitosterol, stigmasterol & campesterol.'
            },
        ],
        moa: [
            {
                title: 'Antihistaminic and Anti-Allergic Effects',
                detail: 'Mast Cell Stabilization: Thymoquinone prevents mast cell degranulation, lowering histamine release in nasal passages. Receptor Blocking: Non-selectively blocks histamine receptors to relieve itching and sneezing.'
            },
            {
                title: 'Anti-Inflammatory Action',
                detail: 'Pathway Inhibition: Nigella sativa inhibits 5-LOX and COX enzymes (arachidonic acid pathway), blocking leukotrienes and prostaglandins to reduce nasal edema and mucus. Cytokine Regulation: Downregulates pro-inflammatory cytokines like TNF-α.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Oral Capsules',
                instruction: 'Clinical studies have shown success with doses ranging from (250 mg) to (500 mg) of seed extract taken daily.'
            },
            {
                method: 'Liquid Black Seed Oil',
                instruction: 'Adults typically take 1 to 2 teaspoons per day, either directly or mixed with honey or warm water.'
            },
            {
                method: 'Nasal Drops/Spray',
                instruction: 'Some trials suggest applying 1 to 2 drops of high-quality black seed oil directly into each nostril up to 3 times a day to relieve mucosal inflammation.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Infants & Toddlers (< 12 months)',
                notes: 'Not recommended due to their still-developing digestive and immune systems.'
            },
            {
                group: 'Young Children (Ages 1 to 5)',
                notes: 'Used in small, limited amounts. Specific nasal administration products exist for daily use.'
            },
            {
                group: 'School-Age Children (Ages 6 to 12)',
                notes: 'Dosing focuses on specific, measured daily amounts adapted to the child\'s weight.'
            },
            {
                group: 'Teens & Adults (Age 13+)',
                notes: 'Uses standard daily measurements, which can be split into multiple doses.'
            },
        ],
        dosage: {
        ...
        marketedProducts: [
            {
                name: 'Black Seed Oil — Pure, cold-pressed oils from brands like Imtenan, Biohayah, and Purity',
                image: '/images/BlackSeedRhinitis1.jpg'
            },
            {
                name: 'Softgel Capsules — Avantic Activated Black Seed Oil, ZeinPharma, or generic Premium Black Seed Oil',
                image: null
            },
        ...
        storage: {
            forms: [
                {
                    form: 'Nigella Sativa Oil',
                    instructions: 'Keep in amber or cobalt glass bottles to block light. Seal the cap tightly after every use to prevent oxygen exposure. Store in a cool pantry or refrigerate after opening to preserve the delicate fatty acids.'
                },
                {
                    form: 'Oil Capsules / Softgels',
                    instructions: 'Store in their original container away from heat and moisture. Avoid bathroom storage, as high humidity can cause the softgel shells to stick together or dissolve.'
                },
                {
                    form: 'Whole or Ground Seeds',
                    instructions: 'Keep whole seeds in a sealed, dry jar at room temperature. Grind them only right before consumption, as pre-ground seeds lose their medicinal essential oils very rapidly.'
                },
            ],
        },
        benefits: [],
        ...
        references: [
            {
                text: 'ScienceDirect — Nigella sativa and allergic rhinitis.',
                url: 'https://www.sciencedirect.com/science/article/abs/pii/S0041010124003593'
            },
            {text: 'WebMD — Black Seed.', url: 'https://www.webmd.com/vitamins/ai/ingredientmono-901/black-seed'},
            {
                text: 'Frontiers in Pharmacology — Nigella sativa pharmacology.',
                url: 'https://www.frontiersin.org/journals/pharmacology/articles/10.3389/fphar.2024.1417013/full'
            },
            {
                text: 'IJABBR — Nigella sativa review.',
                url: 'https://www.ijabbr.com/article_712694_0a0a34b2f0cc578baf9052ee287b18d0.pdf'
            },
            {text: 'PubMed — Nigella sativa antihistamine.', url: 'https://pubmed.ncbi.nlm.nih.gov/23855426/'},
            {
                text: 'PubMed Central — Nigella sativa anti-allergic review.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4387228/'
            },
        ],
    },
    ...
    'eucalyptus': {
        ...
        activeConstituents: [
            {
                name: '1,8-Cineole (Eucalyptol)',
                detail: 'The primary active monoterpene alcohol comprising 70–85% of the essential oil. Principal compound responsible for mucolytic, secretolytic, and anti-inflammatory activities in the respiratory tract.'
            },
            {
                name: 'α-Pinene & Limonene',
                detail: 'Minor monoterpene hydrocarbons that act synergistically to provide secondary antiseptic and antioxidant protection.'
            },
            {
                name: 'Sesquiterpenes (e.g., Globulol)',
                detail: 'Contributes to the characteristic aroma and antimicrobial profile.'
            },
            {
                name: 'Flavonoids & Hydrolyzable Tannins',
                detail: 'Present in crude leaf extracts, providing astringent and cellular antioxidant support.'
            },
        ],
        moa: [
            {
                title: 'Secretomotoric & Mucolytic Effect',
                detail: '1,8-Cineole directly stimulates the ciliary beat frequency of the respiratory epithelium (secretomotoric action). Concurrently, it exerts a true mucolytic effect by downregulating the genetic expression of mucin genes (MUC2 and MUC19) in airway goblet cells, effectively thinning hyperviscous mucus secretions and facilitating effective expectoration.'
            },
            {
                title: 'Anti-inflammatory Action',
                detail: 'Strongly suppresses pro-inflammatory cascades. Inhibits the activation of Nuclear Factor-kappa B (NF-κB), leading to significant reduction in synthesis of TNF-α, IL-1β, leukotriene B4 (LTB4), and thromboxane B2.'
            },
            {
                title: 'Decongestant Effect (Sensory Modification)',
                detail: 'Actively stimulates TRPM8 cold receptors on afferent trigeminal nerve endings within the nasal mucosa. Similar to menthol, this interaction induces a localized cooling sensation, reducing the perception of nasal congestion and breathing resistance without acting as a vascular vasoconstrictor.'
            },
            {
                title: 'Antimicrobial Action',
                detail: 'Disrupts bacterial cell membrane integrity, demonstrating notable bacteriostatic and bactericidal effects against common respiratory pathogens like Streptococcus pneumoniae and Haemophilus influenzae.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Steam Inhalation (Aqueous Vapor)',
                instruction: 'Add 2–5 drops of pure eucalyptus essential oil into a vessel of steaming (not boiling) water. Inhale the medicated vapors through the nose and mouth for 5–10 minutes while keeping eyes closed to avoid ocular irritation.'
            },
            {
                method: 'Topical Application (Chest Rub)',
                instruction: 'Incorporate the essential oil into a suitable carrier oil (such as sweet almond or jojoba oil) to a maximum concentration of 1%. Massage gently onto the chest or back area to act as a localized counter-irritant and vapor releaser.'
            },
            {
                method: 'Standardized Oral Formulations',
                instruction: 'Standardized eucalyptol is available in specific pharmaceutical enteric-coated capsules (e.g., Soledum® or Myrtol®) indicated for lower respiratory infections, and must be administered strictly under medical supervision.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults & Adolescents',
                notes: 'Generally safe for topical, inhalation, and standardized oral use when properly diluted or formulated.'
            },
            {
                group: 'Pediatrics (<6 years old)',
                notes: 'Strictly Contraindicated. Formulations containing 1,8-cineole or pure eucalyptus oil must never be applied topically to the face, nose, or chest of infants and young children under 6 years old, nor used in steam inhalations. Exposure can trigger reflex glottis spasms, severe laryngospasm, acute respiratory depression, or systemic seizures.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Oral administration of the essential oil is strictly contraindicated due to insufficient clinical safety data and potential risks of hepatic enzyme induction in the fetus. Inhalation or low-dose topical cosmetic use away from the thoracic/mammary area is generally considered low-risk during lactation.'
            },
            {
                group: 'Geriatrics & Chronic Diseases',
                notes: 'Use with high clinical caution in patients with history of asthma (unmonitored inhalation may trigger acute bronchospasm), epilepsy, or severe hepatic impairment.'
            },
        ],
        dosage: {
        ...
        storage: {
            forms: [
                {
                    form: 'Essential Oil',
                    storage: 'Store in tightly sealed, dark amber glass bottles in a cool, dark environment completely out of reach of children to prevent accidental fatal poisoning. Exposure to light and oxygen induces the auto-oxidation of monoterpenes, rendering the oil highly irritating.'
                },
            ],
        },
        marketedProducts: [
        ...
        references: [
            ...
            {
                text: 'PeaceHealth Medical Topics — Eucalyptus Monograph.',
                url: 'https://www.peacehealth.org/medical-topics/id/hn-2086009'
            },
        ],
    },
    ...
    'ginger-cold': {
        ...
        activeConstituents: [
            {
                name: 'Gingerols',
                detail: 'The primary active principles in fresh ginger rhizomes, with 6-gingerol being the most abundant and biologically active. It possesses potent anti-inflammatory and anti-emetic properties.'
            },
            {
                name: 'Shogaols',
                detail: 'Formed via the thermal dehydration of gingerols during drying or heating processes. 6-shogaol is the predominant compound in dry ginger, exhibiting significantly higher chemical stability and a more potent anti-inflammatory and neuroprotective profile than gingerols.'
            },
            {
                name: 'Paradols & Zingerone',
                detail: 'Secondary degradation products formed during long-term storage and cooking, contributing to the antioxidant and warming profile.'
            },
            {
                name: 'Volatile Essential Oils (1% to 3%)',
                detail: 'Composed primarily of sesquiterpene hydrocarbons, chiefly beta-zingiberene (up to 35%), ar-curcumene, beta-sesquiphellandrene, and alpha-farnesene, which dictate the characteristic spicy aroma and contribute to the antimicrobial and antispasmodic effects.'
            },
            {
                name: 'Phenolic Derivatives & Resins',
                detail: 'Provide secondary cellular antioxidant support and maintain gastric mucosal integrity at physiological doses.'
            },
        ],
        moa: [
            {
            ...
            {
                title: 'Antispasmodic & Antitussive Effect',
                detail: 'Exerts a direct relaxant effect on airway smooth muscle cells (ASMCs). It blocks voltage-dependent calcium channels (VDCCs) and modulates intracellular calcium stores, which effectively mitigates bronchospasms and reduces non-productive, spasmodic coughing fits.'
            },
            {
                title: 'Antioxidant Effect',
                detail: 'Directly scavenges reactive oxygen species (ROS), including superoxide and hydroxyl free radicals, while upregulating endogenous antioxidant defense enzymes like superoxide dismutase (SOD) and catalase, mitigating respiratory oxidative stress during infections.'
            },
            {
                title: 'Antimicrobial & Antiviral Action',
                detail: 'Demonstrates notable in vitro antiviral activity, particularly against Respiratory Syncytial Virus (RSV) in human airway epithelium, by blocking viral attachment, internalization, and plaque formation. It also exhibits bacteriostatic actions against common secondary respiratory pathogens.'
            },
            {
                title: 'Local Demulcent & Soothing Effect',
                detail: 'When administered as a warm aqueous infusion, the mucilaginous and resinous fractions exert a local demulcent effect over the pharyngeal mucosa, reducing sensory nerve irritation, throat roughness, and vocal cord hoarseness.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Ginger Tea)',
                instruction: 'Steep 2–3 g of freshly sliced or grated rhizome in 200–250 mL of boiling water in a covered vessel for 10–15 minutes (to prevent the loss of volatile essential oils). Inhale vapors during consumption. Honey or lemon may be added as adjuvants.'
            },
            {
                method: 'Crude Dried Powder',
                instruction: '1–4 g daily, administered in divided doses 500–1000 mg per dose mixed with food or warm water.'
            },
            {
                method: 'Standardized Oral Capsules',
                instruction: '250–500 mg of standardized extract taken 2 to 4 times per day (typically standardized to contain 5% total gingerols/shogaols).'
            },
            {
                method: 'Local Lozenges / Candies',
                instruction: 'Used as needed to dissolve slowly in the buccal cavity for targeted, local antiseptic and anesthetic action in the pharynx.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Highly effective and clinically utilized for pregnancy-induced nausea and morning sickness. However, oral consumption must be strictly limited to a maximum of 1 g/day of dry ginger equivalent under medical supervision. High therapeutic doses are avoided due to theoretical risks of uterine contraction stimulation (oxytocic effect) and low-level inhibition of fetal testosterone binding. Safe during lactation at standard culinary doses.'
            },
            {
                group: 'Pediatrics (<2 years old)',
                notes: 'Strictly Contraindicated. Safe clinical data is absent for infants. For children over 2 years of age, very mild aqueous infusions may be administered under supervision at weight-adjusted, significantly reduced doses.'
            },
            {
                group: 'Geriatrics & Chronic Diseases',
                notes: 'Diabetes: Ginger enhances insulin sensitivity and may lower blood glucose; monitoring is required. Cardiovascular: May exert weak calcium-channel blocking properties; use with caution in patients taking antihypertensives. Cholelithiasis (Gallstones): Must be used with extreme clinical caution.'
            },
        ],
        overdose: {
            symptoms: [
        ...
        drugInteractions: [
            {
                drug: 'Anticoagulants / Antiplatelets (e.g., Warfarin, Aspirin, Clopidogrel)',
                effect: 'Ginger inhibits thromboxane synthase and acts as a weak platelet aggregation inhibitor in vitro. While clinical trials show conflicting data regarding significant INR alterations, close monitoring of bleeding times and INR is mandatory during concurrent use.'
            },
            {
                drug: 'Antidiabetic Agents (e.g., Metformin, Insulin)',
                effect: 'May potentiate hypoglycemic effects by enhancing glucose uptake into skeletal muscle cells; blood glucose monitoring is recommended.'
            },
            {
                drug: 'Calcium Channel Blockers (CCBs) (e.g., Nifedipine, Verapamil)',
                effect: 'High therapeutic doses of ginger may exert additive hypotensive and bradycardic properties via synergistic voltage-dependent calcium channel blockade.'
            },
        ],
        storage: {
            forms: [
                {
                    form: 'Dry Powder / Standardized Capsules',
                    instructions: 'Must be stored in tightly sealed, light-resistant containers below 25°C in a dry environment to avoid moisture absorption and the hydrolytic degradation of active gingerols.'
                },
                {
                    form: 'Fresh Ginger Rhizomes',
                    instructions: 'Should be wrapped securely and refrigerated at 4°C to maintain cellular moisture and prevent fungal/microbial spoilage.'
                },
            ],
        },
        marketedProducts: [
    ...
    'lemon': {
        ...
        activeConstituents: [
            {
                name: 'Citric Acid',
                percentage: '5-7% of fresh juice (pH ~2.0-3.0)',
                effect: 'Stimulates salivation, airway mucus secretion; local demulcent effect when diluted; mild antimicrobial (unfavorable pH for pathogens); potent crystallization inhibitor for calcium oxalate kidney stones'
            },
            {
                name: 'Vitamin C (Ascorbic Acid)',
                percentage: '~40-50 mg per 100 mL fresh juice',
                effect: 'Potent water-soluble antioxidant; accumulates in phagocytic cells enhancing chemotaxis, phagocytosis, T-cell proliferation, and differentiation'
            },
            {
                name: 'Hesperidin, Eriocitrin, Naringin (Flavanones)',
                percentage: '',
                effect: 'Downregulate iNOS and COX-2 expression, markedly decreasing pro-inflammatory mediators (PGE2 and NO); vascular protection'
            },
            {
                name: 'D-Limonene (Volatile Peel Oil)',
                percentage: '65-70% of peel oil',
                effect: 'Disrupts microbial cell membranes in vitro; responsible for antimicrobial and aromatic profile'
            },
            {
                name: 'Coumarins & Furanocoumarins (Peel: trace)',
                percentage: 'minor',
                effect: 'Clinically relevant for photosensitivity reactions (phytophotodermatitis) when peel oil contacts skin before sun exposure'
            },
        ],
        moa: [
            {
                title: 'Antioxidant Action',
                detail: 'Ascorbic acid directly scavenges reactive oxygen species (ROS) and free radicals, shielding respiratory epithelial cells from oxidative stress and cellular damage induced during acute viral infections.'
            },
            {
                title: 'Immune Response Support',
                detail: 'Vitamin C actively accumulates within phagocytic cells (neutrophils and macrophages), enhancing chemotaxis, phagocytosis, and the generation of reactive oxygen species to eradicate invading pathogens. Also promotes T-cell proliferation and differentiation.'
            },
            {
                title: 'Anti-inflammatory Action',
                detail: 'Citrus flavonoids (hesperidin and eriocitrin) downregulate the expression of inducible nitric oxide synthase (iNOS) and cyclooxygenase-2 (COX-2), leading to a marked decrease in pro-inflammatory mediators (PGE2 and NO).'
            },
            {
                title: 'Secretomotoric & Antitussive (Demulcent) Effect',
                detail: 'High acidity of citric acid stimulates gustatory nerves, triggering reflex salivation and secretion of airway mucus. When properly diluted with honey in warm water, acts as a local demulcent coating the pharyngeal mucosa, soothing irritated cough receptors and mitigating dry tickling coughs.'
            },
            {
                title: 'Mild Antimicrobial Properties',
                detail: 'Volatile components (primarily limonene) disrupt microbial cell membranes in vitro. Locally, the low pH of undiluted juice creates a transient acidic microenvironment on the tonsillar surface unfavorable for certain pH-sensitive pathogens.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standard Warm Lemon Infusion',
                instruction: 'Squeeze 15-30 mL of fresh lemon juice (approximately half a fresh lemon) into 200 mL of warm water. Drink 2-3 times daily.'
            },
            {
                method: 'Synergistic Demulcent Formulation',
                instruction: 'Mix 15 mL of fresh lemon juice with 1-2 teaspoons (5-10 mL) of pure honey in a cup of warm water. Sip slowly to coat the hypopharynx and suppress dry cough.'
            },
            {
                method: 'CRITICAL PREPARATION NOTE',
                instruction: 'AVOID adding boiling water (>60°C) directly to fresh lemon juice: thermal stress accelerates irreversible oxidation and degradation of bioactive L-ascorbic acid. Use warm, not boiling, water.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Completely safe and highly recommended at standard dietary/therapeutic doses. Widely utilized as non-pharmacological option to alleviate first-trimester morning sickness and gestational nausea.'
            },
            {
                group: 'Pediatrics (>1 year)',
                notes: 'Safe for general pediatric use. CRITICAL: If combining lemon juice with honey for pediatric cough management, NEVER administer to infants under 12 months due to fatal risk of infant botulism from Clostridium botulinum spore contamination in raw honey.'
            },
            {
                group: 'Advanced CKD (Stage 4-5)',
                notes: 'Limit heavy intake due to risk of hyperkalemia: lemon juice contains notable concentrations of potassium.'
            },
            {
                group: 'Nephrolithiasis',
                notes: 'Highly beneficial for patients prone to calcium oxalate stones: dietary citrate acts as potent crystallization inhibitor.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Warm Lemon Infusion',
                    dose: '15-30 mL fresh juice in 200 mL warm water (<60°C), 2-3 times daily.'
                },
                {
                    form: 'Lemon-Honey Demulcent',
                    dose: '15 mL juice + 1-2 tsp honey in warm water; sip slowly 3-4 times daily for cough relief.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Fresh Whole Lemons',
                    instructions: 'Store under refrigeration at 4-8°C to prevent moisture loss and inhibit mold growth (Penicillium species).'
                },
                {
                    form: 'Freshly Squeezed Lemon Juice',
                    instructions: 'Store in a tightly sealed glass container, refrigerated, and consume within 48-72 hours to avoid micro-oxidation of Vitamin C and microbial fermentation.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'shield',
                title: 'Immune Support',
                desc: 'Vitamin C accumulates in phagocytic cells enhancing chemotaxis, phagocytosis, and T-cell proliferation for comprehensive immune defense.'
            },
            {
                icon: 'thermostat',
                title: 'Antioxidant Defense',
                desc: 'Ascorbic acid scavenges ROS and free radicals, protecting respiratory epithelial cells during acute viral infections.'
            },
            {
                icon: 'spa',
                title: 'Sore Throat & Cough Relief',
                desc: 'Demulcent action (especially with honey) coats pharyngeal mucosa, soothing irritated cough receptors and tonsil inflammation.'
            },
            {
                icon: 'water_drop',
                title: 'Anti-inflammatory',
                desc: 'Hesperidin and eriocitrin downregulate iNOS and COX-2 expression, reducing pro-inflammatory mediators in the respiratory tract.'
            },
        ],
        botanicalFacts: {
            family: 'Rutaceae',
        ...
        preparation: [
            {
                method: 'Warm Lemon Infusion',
                desc: 'Squeeze ½ lemon (15-30 mL) into warm water (<60°C): never boiling.',
                bestFor: 'Hydration, Vitamin C delivery, mild immune support'
            },
            {
                method: 'Lemon-Honey Demulcent',
                desc: '15 mL fresh juice + 1-2 tsp honey in warm water, sip slowly.',
                bestFor: 'Dry irritative cough, sore throat, pharyngitis'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'Addi, M., et al. (2021). An overview of bioactive flavonoids from citrus fruits. Applied Sciences, 12(1), 29.',
                url: 'https://doi.org/10.3390/app12010029'
            },
            {
                text: 'Agarwal, P., et al. (2022). Citrus essential oils in aromatherapy: Therapeutic effects and mechanisms. Antioxidants, 11(12), 2374.',
                url: 'https://doi.org/10.3390/antiox11122374'
            },
        ],
    },
    ...
    'echinacea': {
        ...
        activeConstituents: [
            {
                name: 'Alkamides (Lipophilic Isobutylamides)',
                percentage: '',
                effect: 'Bind to cannabinoid type 2 (CB2) receptors; primary drivers of immunomodulatory effects'
            },
            {
                name: 'Cichoric Acid, Caftaric Acid, Echinacoside (Phenylpropanoids)',
                percentage: '',
                effect: 'Hydrophilic phenolic derivatives; potent antioxidant and cellular protection'
            },
            {
                name: 'Arabinogalactans & Fucogalactoxyloglucans (High-MW Polysaccharides)',
                percentage: '',
                effect: 'Complex water-soluble structures that directly stimulate macro-granulocyte cellular proliferation'
            },
            {
                name: 'Volatile Essential Oils (Borneol, Bornyl acetate, Germacrene D)',
                percentage: '',
                effect: 'Aromatic and minor antimicrobial contributions'
            },
        ],
        moa: [
            {
                title: 'Phagocytosis Activation',
                detail: 'Significantly upregulates operational capacity, migration velocity, and ingestion efficiency of alveolar macrophages and circulating neutrophils, speeding up destruction of cellular pathogens.'
            },
            {
                title: 'Cytokine Cascade Modulation',
                detail: 'Triggers targeted release of immunomodulatory signaling proteins including Interferon (IFN), TNF-α, IL-1, and IL-10, priming the innate immune system for rapid pathogen response.'
            },
            {
                title: 'Hyaluronidase Enzymatic Inhibition',
                detail: 'Directly blocks the bacterial and viral enzyme hyaluronidase, successfully neutralizing the pathogen\'s ability to break down the intercellular matrix and preventing spread of infection into adjacent healthy tissues.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion / Decoction',
                instruction: 'Simmer 1.0-2.0 grams of the dried herb in boiling water for 15 minutes.'
            },
            {
                method: 'CRITICAL TIMING',
                instruction: 'For maximum clinical efficacy, therapy MUST be initiated at the absolute FIRST SIGN of cold or flu symptoms (scratchy throat, minor chills). It is virtually useless if taken after the infection has fully established.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pediatrics (<2 years)',
                notes: 'STRICTLY CONTRAINDICATED: absolutely prohibited due to risk of severe systemic complications.'
            },
            {
                group: 'Pediatrics (2-12 years)',
                notes: 'Not recommended without direct medical supervision: heightened risk of precipitating severe T-cell-mediated allergic manifestations.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Avoid completely: clinical safety and maternal-fetal outcome data have not been established.'
            },
            {
                group: 'Adults',
                notes: 'Primary target demographic. Adult prophylaxis/acute dose: 2.5-6.0 g dried herb daily in divided doses.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Aqueous Infusion / Decoction',
                    dose: '1.0-2.0 g dried herb in boiling water, simmered 15 minutes; 2-3 cups daily.'
                },
                {
                    form: 'Standardized Capsules/Extracts',
                    dose: '2.5-6.0 g dried herb equivalent daily in divided doses. Max 10 consecutive days acute; max 8 weeks prophylactic.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'All forms',
                    instructions: 'Store in a cool, dark, and perfectly dry environment within airtight containers to safeguard the delicate alkamides from thermal breakdown.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                ...
                desc: 'Upregulates macrophage and neutrophil capacity to detect and destroy pathogens faster: proven to reduce cold duration and severity.'
            },
            {
                icon: 'science',
                title: 'Cytokine Priming',
                detail: '',
                desc: 'Triggers targeted release of IFN, TNF-α, IL-1, and IL-10 to prime innate immune system at first sign of infection.'
            },
            {
                icon: 'block',
                title: 'Hyaluronidase Inhibition',
                desc: 'Blocks bacterial/viral enzyme preventing spread of infection into adjacent healthy tissues.'
            },
            {
                icon: 'healing',
                title: 'Topical Wound Healing',
                desc: 'Direct localized application promotes healing of superficial wounds, minor burns, acne, and recurrent boils.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Decoction at First Symptoms',
                desc: 'Simmer 1-2 g dried herb in boiling water for 15 min; 2-3 cups daily. Start IMMEDIATELY at first sign of cold.',
                bestFor: 'Acute URTI prophylaxis and treatment; immune activation'
            },
            {
                method: 'Standardized Capsules / Liquid Extract',
                desc: 'Commercially standardized preparations for consistent dosing.',
                bestFor: 'Prophylactic immune maintenance cycles (max 8 weeks, then 3-week break)'
            },
        ],
        ...
        references: [
            ...
            {text: 'Chevallier, A. (2016). Encyclopedia of Herbal Medicine (3rd ed.). DK Publishing.'},
            {
                text: 'Egyptian Drug Authority — Echinacea purpurea monograph.',
                url: 'https://edaegypt.gov.eg/media/tkbhrjew/echinacea-purpurea-l-moench-%D8%A5%D8%B4%D9%86%D8%B3%D9%8A%D8%A7.pdf'
            },
        ],
    },
    ...
    'black-seed': {
        ...
        activeConstituents: [
            {
                ...
                percentage: '',
                effect: 'Primary core bioactive crystalline phenol; direct 5-LOX enzyme inhibitor; immunomodulator; anti-inflammatory; antidiabetic'
            },
            {
                name: 'Thymohydroquinone',
                percentage: '',
                effect: 'Secondary active phenol with immunomodulatory properties'
            },
            {
                name: 'Nigellone',
                percentage: '',
                effect: 'Provides powerful anti-histaminic action; protects bronchial tissue from histamine-induced spasms; relaxes hyperreactive airways'
            },
            {name: 'p-Cymene (Volatile Oil)', percentage: '', effect: 'Aromatic and minor antimicrobial contributions'},
            {
                name: 'Linoleic Acid & Oleic Acid (Fixed Oil)',
                percentage: '',
                effect: 'Predominantly long-chain unsaturated fatty acids; essential for lipophilic bioavailability of TQ'
            },
            {
                name: 'Nigellicine & Nigellidine (Isoquinoline Alkaloids)',
                percentage: '',
                effect: 'Structurally unique compounds with secondary pharmacological activity'
            },
            {
                name: 'Beta-sitosterol, Vitamins, Minerals',
                percentage: '',
                effect: 'Dense nutritional matrix supporting overall therapeutic activity'
            },
        ],
        moa: [
            {
                title: 'Advanced Immunomodulation',
                detail: 'Significantly accelerates the cytotoxic destructive capacity of Natural Killer (NK) cells and markedly boosts the baseline phagocytic capacity of tissue macrophages.'
            },
            {
                title: 'Targeted Anti-inflammatory Pathway (5-LOX Inhibition)',
                detail: 'Functions as a direct 5-LOX (5-Lipoxygenase) enzyme inhibitor, stopping the production of pro-inflammatory leukotrienes that drive acute allergic and asthmatic bronchospasms.'
            },
        ...
        howToUse: [
            {
                method: 'CRITICAL PREPARATION',
                instruction: 'Whole seeds MUST be crushed or ground IMMEDIATELY before use. Pre-ground seeds or exposure of crushed seeds to open air causes volatile Thymoquinone to evaporate completely, stripping the herb of its medicinal value. Continuous boiling is also strictly prohibited for the same reason.'
            },
            {
                method: 'Lipophilic Bioavailability Protocol',
                instruction: 'Thymoquinone is strictly lipophilic (fat-soluble). Oil or crushed powder MUST be administered WITH or IMMEDIATELY AFTER MEALS to enhance intestinal absorption while minimizing gastric irritation.'
            },
            {
                method: 'Titration Rule',
                instruction: 'Always initiate therapy at the lowest possible baseline dose (2.5 mL of oil or 1.0 g of seeds) for the first week to properly evaluate individual gastric tolerance.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults & Adolescents',
                notes: 'Primary demographic for metabolic and respiratory therapeutic protocols.'
            },
            {
                group: 'Pediatrics',
                notes: 'Requires direct medical supervision with highly precise weight-adjusted dosing.'
            },
            {
                group: 'Pregnancy',
                notes: 'STRICTLY CONTRAINDICATED: oil and concentrated therapeutic extracts can stimulate sudden uterine contractions, presenting severe risk of involuntary abortion.'
            },
            {
                group: 'Lactation',
                notes: 'Clinical safety has not been fully mapped; usage during breastfeeding is NOT RECOMMENDED.'
            },
        ],
        dosage: {
        ...
        storage: {
            forms: [
                {
                    form: 'Whole Seeds & Oil',
                    instructions: 'Store in airtight, amber or dark opaque glass containers in a cool, dry location to prevent light-induced oxidation of delicate fixed and volatile fatty acids.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                ...
                desc: 'Significantly accelerates cytotoxic destructive capacity of Natural Killer cells and boosts macrophage phagocytic activity for comprehensive immune defense.'
            },
            {
                icon: 'bloodtype',
                title: 'Metabolic Support',
                desc: 'Clinical evidence for adjuvant management of Type 2 Diabetes, dyslipidemia (LDL/HDL balance), and mild hypertension.'
            },
            {
                icon: 'spa',
                title: 'Anti-inflammatory',
                desc: 'Broad anti-inflammatory profile via 5-LOX inhibition reduces inflammatory mediators across multiple organ systems.'
            },
        ],
        botanicalFacts: {
            family: 'Ranunculaceae',
        ...
        preparation: [
            {
                method: 'Freshly Crushed Seeds WITH Food',
                desc: 'Crush immediately before use; take with or immediately after meals for optimal TQ absorption. Start with titration dose.',
                bestFor: 'Immune support, asthma, diabetes, hypertension'
            },
            {
                method: 'Cold-Pressed Oil WITH Food',
                desc: '2.5-5 mL cold-pressed oil taken with food; do not heat.',
                bestFor: 'All indications; easier to take than crushed seeds; best bioavailability'
            },
        ],
        ...
        references: [
            {
                text: 'ScienceDirect — Nigella sativa pharmacology.',
                url: 'https://www.sciencedirect.com/science/article/abs/pii/S0041010124003593'
            },
            {text: 'WebMD — Black Seed.', url: 'https://www.webmd.com/vitamins/ai/ingredientmono-901/black-seed'},
            {
                text: 'Frontiers in Pharmacology — Black seed review.',
                url: 'https://www.frontiersin.org/journals/pharmacology/articles/10.3389/fphar.2024.1417013/full'
            },
            {
                text: 'International Journal of Advanced Biological and Biomedical Research — Nigella sativa.',
                url: 'https://www.ijabbr.com/article_712694_0a0a34b2f0cc578baf9052ee287b18d0.pdf'
            },
            {text: 'PubMed — Black seed anti-inflammatory activity.', url: 'https://pubmed.ncbi.nlm.nih.gov/23855426/'},
            {
                text: 'PubMed Central — Nigella sativa therapeutic effects.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4387228/'
            },
            {text: 'Duke, J. A., et al. (2002). Handbook of Medicinal Herbs (2nd ed.). CRC Press.'},
            {text: 'Chevallier, A. (2016). Encyclopedia of Herbal Medicine (3rd ed.). DK Publishing.'},
            {
                text: 'Egyptian Drug Authority — Nigella sativa monograph.',
                url: 'https://www.edaegypt.gov.eg/media/cuobaarg/nigella-sativa-l-_1.pdf'
            },
        ],
    },
    ...
    'astragalus': {
        ...
        activeConstituents: [
            {
                name: 'Astragalan Polysaccharides',
                percentage: '',
                effect: 'Complex high-molecular-weight water-soluble glycans; foundational pillars for adaptogenic and interferonogenic properties; directly stimulate immune cell proliferation'
            },
            {
                name: 'Astragalosides I-X (Triterpenoid Saponins)',
                percentage: '',
                effect: 'Specialized chemical matrix; Astragaloside IV is most pharmacologically active and heavily researched'
            },
            {
                name: 'Quercetin, Kaempferol, Specialized Isoflavones (Bioflavonoids)',
                percentage: '',
                effect: 'Cellular vascular stabilization; antioxidant; anti-inflammatory support'
            },
            {
                name: 'Asparagine, β-sitosterol, Nickel, Chromium (Trace Amino Acids & Minerals)',
                percentage: '',
                effect: 'Dense concentrations of essential trace elements supporting overall metabolic and immune function'
            },
        ],
        moa: [
            {
                title: 'True Adaptogenic Action',
                detail: 'Systemically increases the human body\'s non-specific physiological resistance to severe physical, mental, and environmental stress factors.'
            },
            {
                title: 'Interferonogenic Stimulation',
                detail: 'Directly triggers the endogenous cellular production of Interferon, which plays an essential role in initiating the body\'s primary defense against viral invasions.'
            },
            {
                title: 'T-Cell Signaling Activation',
                detail: 'Potentiates and accelerates the proliferation, maturation, and cytotoxic capacity of T-lymphocytes and Natural Killer (NK) immune cell lines.'
            },
            {
                title: 'Antiviral Synergistic Defense',
                detail: 'Works in synergy with natural cellular processes to stop viral replication cycles, showing documented effectiveness against Coxsackie B and common respiratory cold viruses.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Raw Root Decoction',
                instruction: 'Boil 9-30 grams of the sliced dried root daily in water, allowing it to fully simmer to extract the heavy polysaccharides.'
            },
            {
                method: 'Standardized Dry Extract Capsules',
                instruction: 'Administer 100-150 mg of standardized extract exactly three times daily.'
            },
            {
                method: 'Fluid Extract Dilution (1: 2)',
                instruction: '4.5-8.5 mL administered daily in carefully divided doses. (A 1: 2 dilution contains 1 g of the herb per 2 mL of liquid).'
            },
        ],
        suitableAgeGroups: [
            ...
            {
                group: 'Pediatrics & Adolescents (<18 years)',
                notes: 'NOT RECOMMENDED by the Egyptian Drug Authority (EDA): lack of long-term safety data.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'STRICTLY AVOIDED: clinical safety profile is absent; no verified human fertility or gestational data available.'
            },
        ],
        dosage: {
        ...
        storage: {
            forms: [
                {
                    form: 'All forms',
                    instructions: 'Store within tightly sealed, airtight containers completely protected from ambient moisture and direct sunlight to ensure long-term preservation of active saponins.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'shield',
                title: 'True Adaptogen',
                desc: 'Systemically increases non-specific physiological resistance to physical, mental, and environmental stress factors.'
            },
            {
                icon: 'coronavirus',
                title: 'Interferonogenic',
                desc: 'Triggers endogenous cellular production of Interferon: essential primary defense initiator against viral invasions.'
            },
            {
                icon: 'medical_services',
                title: 'T-Cell & NK Cell Activation',
                desc: 'Potentiates proliferation, maturation, and cytotoxic capacity of T-lymphocytes and Natural Killer immune cells.'
            },
            {
                icon: 'energy_savings_leaf',
                title: 'Anti-fatigue',
                desc: 'Clinically validated for mitigation of profound chronic fatigue and post-viral recovery syndrome.'
            },
        ],
        botanicalFacts: {
            family: 'Fabaceae / Leguminosae',
        ...
        preparation: [
            {
                method: 'Root Decoction',
                desc: 'Boil 9-30 g sliced dried root in water for full simmering to extract heavy polysaccharides.',
                bestFor: 'Immune restoration, respiratory prophylaxis, chronic fatigue'
            },
            {
                method: 'Standardized Capsules',
                desc: '100-150 mg standardized extract three times daily.',
                bestFor: 'Convenient therapeutic dosing for immune prophylaxis and post-viral recovery'
            },
        ],
        ...
        references: [
            ...
            {text: 'Chevallier, A. (2016). Encyclopedia of Herbal Medicine (3rd ed.). DK Publishing.'},
            {
                text: 'Egyptian Drug Authority — Astragalus monograph.',
                url: 'https://www.edaegypt.gov.eg/media/nmfpej2l/astragalus-mongholicus_1.pdf'
            },
        ],
    },
    ...
    'turmeric-immunity': {
        ...
        activeConstituents: [
            {
                name: 'Curcuminoids (3–5%)',
                detail: 'Curcumin (77%), demethoxycurcumin (17%), bisdemethoxycurcumin (3%): lipophilic polyphenolic pigments responsible for anti-inflammatory and antioxidant activity.'
            },
            {
                name: 'Volatile Essential Oils (3–7%)',
                detail: 'ar-Turmerone, alpha-turmerone, beta-turmerone, curlone, zingiberene: contribute anti-inflammatory and antimicrobial actions.'
            },
        ],
        moa: [
            {
                title: 'NF-κB Inhibition',
                detail: 'Curcumin downregulates Nuclear Factor-kappa B (NF-κB), blocking pro-inflammatory cytokines TNF-α, IL-1, and IL-6.'
            },
            {
                title: 'COX-2 & 5-LOX Dual Inhibition',
                detail: 'Suppresses both cyclooxygenase-2 and 5-lipoxygenase, reducing prostaglandin and leukotriene synthesis without gastric toxicity.'
            },
            {
                title: 'Antioxidant: Direct Scavenging & Enzyme Upregulation',
                detail: 'Directly neutralizes ROS/RNS via phenolic groups; also upregulates endogenous SOD, CAT, and GPx antioxidant enzymes.'
            },
            {
                title: 'Hepatoprotective & Choleretic',
                detail: 'Enhances hepatic bile synthesis via cholecystokinin-mediated pathways, accelerating lipid clearance and detoxification.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Powdered Rhizome (with Piperine)',
                instruction: '1–3 g daily with food. Pair with black pepper (piperine) to increase bioavailability by up to 2000%; co-ingestion with dietary fats also improves absorption.'
            },
            {
                method: 'Standardized Extract Capsules',
                instruction: '500–1500 mg daily of extract standardized to 95% curcuminoids, taken with food and piperine for maximum absorption.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults',
                notes: 'Highly recommended, especially for chronic joint conditions and metabolic syndrome.'
            },
            {
                group: 'Elderly',
                notes: 'Beneficial for geriatric arthritis; reduces reliance on NSAIDs. Monitor renal function.'
            },
            {
                group: 'Pregnant Women',
                notes: 'Culinary amounts safe. Concentrated therapeutic extracts STRICTLY CONTRAINDICATED.'
            },
            {
                group: 'Children',
                notes: 'Safe in dietary quantities; medicinal supplementation not recommended without supervision.'
            },
        ],
        dosage: {
            ...
            forms: [
                ...
                {
                    form: 'Standardized Extract Capsules (95% curcuminoids)',
                    dose: '500–1500 mg daily, with piperine and food.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Powder & Extract Capsules',
                    storage: 'Airtight, light-resistant containers (amber glass/HDPE) in cool, dry environment (15–25°C). Curcumin is highly photosensitive: protect from direct UV light.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'healing',
                title: 'Multi-Pathway Anti-Inflammatory',
                desc: 'Curcumin simultaneously blocks NF-κB, COX-2, and 5-LOX: the three main inflammatory highways: reducing both prostaglandin and cytokine output without the GI side effects of NSAIDs.'
            },
            {
                icon: 'shield',
                title: 'Potent Dual Antioxidant',
                desc: 'Directly scavenges ROS/RNS while also upregulating the body\'s own antioxidant enzymes (SOD, CAT, GPx), providing amplified cellular protection.'
            },
            {
                icon: 'self_improvement',
                title: 'Joint Health & Arthritis Relief',
                desc: 'Evidence-based supportive phytotherapy for osteoarthritis and rheumatoid arthritis, reducing joint pain and swelling with a superior GI safety profile compared to NSAIDs.'
            },
            {
                icon: 'local_pharmacy',
                title: 'Hepatoprotective & Choleretic',
                desc: 'Enhances bile synthesis and gallbladder function via cholecystokinin pathways, supporting liver detoxification and fat metabolism.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Golden Milk (Turmeric Latte)',
                desc: 'Mix 1 tsp turmeric + pinch of black pepper + 250 mL warm milk + honey. Fat and piperine together optimize curcumin absorption.',
                bestFor: 'Daily anti-inflammatory support, joint health'
            },
            {
                method: 'Standardized Capsule Extract',
                desc: 'Pharmaceutical-grade capsules standardized to 95% curcuminoids, co-formulated with BioPerine (piperine) for maximum bioavailability.',
                bestFor: 'Osteoarthritis, rheumatoid arthritis, therapeutic dosing'
            },
        ],
    ...
    'rosemary-immunity': {
        ...
        moa: [
            ...
            {
                title: 'Stimulation of Hair Follicles (Anti-Alopecia)',
                detail: 'Carnosic acid stimulates local microcirculation and tissue perfusion. Acts as mild 5α-reductase inhibitor, disrupting conversion of testosterone into dihydrotestosterone (DHT).'
            },
        ],
        uses: [
        ...
        benefits: [
            {
                icon: 'healing',
                title: 'Anti-inflammatory',
                desc: 'Downregulates COX-2 and iNOS, suppressing pro-inflammatory cytokines and leukotrienes for natural inflammation modulation.'
            },
            {
                icon: 'shield',
                title: 'Antioxidant Protection',
        ...
        preparation: [
            {
                method: 'Oral Herbal Tea',
                desc: 'Steep 1-2 g dried leaves covered at 85-90°C for 10-15 minutes.',
                bestFor: 'Anti-inflammatory support, cognitive enhancement, antioxidant maintenance'
            },
            {
                method: 'Topical Essential Oil',
                desc: 'Dilute in carrier oil; massage into affected area or scalp.',
                bestFor: 'Musculoskeletal pain, hair loss, scalp antimicrobial'
            },
        ],
    ...
    'garlic-immunity': {
        ...
        activeConstituents: [
            {
                name: 'Alliin & Allicin (Organosulfur Compounds)',
                percentage: '',
                effect: 'Primary antimicrobial and anti-inflammatory activity; allicin forms transiently via alliinase enzyme activation upon tissue disruption'
            },
            {
                name: 'Ajoene, DADS, DATS (Oil-soluble Organosulfur Metabolites)',
                percentage: '',
                effect: 'Secondary antimicrobial, anti-inflammatory, and circulatory-supporting effects'
            },
            {
                name: 'Quercetin Glycosides & Phenolic Acids (Polyphenolic Flavonoids)',
                percentage: '',
                effect: 'Localized scavenging of reactive oxygen species (ROS); antioxidant protection'
            },
            {
                name: 'Selenium & Elemental Sulfur (Trace Minerals)',
                percentage: '',
                effect: 'Supports immune enzyme function and antioxidant defense systems'
            },
            {
                name: 'Vitamin C (Ascorbic Acid) & Vitamin B6 (Pyridoxine)',
                percentage: '',
                effect: 'Metabolic co-factors supporting immune cell metabolism and collagen synthesis'
            },
            {
                name: 'Sulfur-Containing Amino Acids',
                percentage: '',
                effect: 'Support keratin synthesis and immune cell signaling pathways'
            },
        ],
        moa: [
            {
                title: 'Antimicrobial & Antifungal Action',
                detail: 'Allicin and related organosulfur compounds exert potent broad-spectrum antimicrobial and antimycotic actions against bacteria, viruses, and fungi.'
            },
            {
                title: 'Anti-inflammatory Pathway Inhibition',
                detail: 'Inhibits COX and LOX enzymes and suppresses NF-κB signaling, reducing production of pro-inflammatory cytokines TNF-α, IL-1β, and IL-6.'
            },
            {
                title: 'Immunomodulation',
                detail: 'Enhances NK cell activity, macrophage phagocytosis, and T-cell proliferation, strengthening both innate and adaptive immune responses.'
            },
            {
                title: 'Cardiovascular Protection',
                detail: 'H2S release from organosulfur compounds induces vasodilation; inhibits platelet aggregation and LDL oxidation, reducing cardiovascular risk.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Raw Crushed Garlic',
                instruction: 'Crush 1-2 cloves and allow 5-10 minutes for alliinase enzyme activation before consuming. Take with food to reduce gastric irritation. 1-2 cloves daily.'
            },
            {
                method: 'Aged Garlic Extract (Capsules)',
                instruction: 'Take standardized aged garlic extract capsules as directed (typically 600-1200 mg daily). Odorless and well tolerated.'
            },
            {
                method: 'Garlic Tea (Infusion)',
                instruction: 'Steep 2-3 crushed cloves in boiling water for 10 minutes. Strain and consume. Add honey and lemon for palatability.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults',
                notes: 'Safe at culinary and therapeutic doses. Monitor if on anticoagulants or antihypertensives.'
            },
            {
                group: 'Children (above 6 years)',
                notes: 'Culinary amounts generally safe. Medicinal doses should be supervised by a healthcare provider.'
            },
            {
                group: 'Pregnant Women',
                notes: 'Culinary amounts considered safe. High medicinal doses should be avoided: potential uterine stimulant effects at very high doses.'
            },
            {
                group: 'Elderly',
                notes: 'Beneficial for cardiovascular and immune support. Monitor for interactions with anticoagulant medications.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Fresh Raw Garlic',
                    dose: '1-2 crushed cloves daily (allow 5-10 min before consuming for allicin formation).'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Fresh Garlic Bulbs',
                    instructions: 'Store in a cool, dry, well-ventilated place away from light. Do not refrigerate unpeeled bulbs. Use within 3-6 months.'
                },
                {
                    form: 'Aged Garlic Extract Capsules',
                    instructions: 'Store at room temperature in original packaging. Keep away from heat, humidity, and direct sunlight.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                ...
                desc: 'Enhances NK cell activity, macrophage phagocytosis, and T-cell proliferation for comprehensive innate and adaptive immune support.'
            },
            {
                icon: 'healing',
                title: 'Anti-inflammatory',
                desc: 'COX/LOX inhibition and NF-κB suppression reduce pro-inflammatory cytokine production without gastric side effects of NSAIDs.'
            },
            {
                icon: 'favorite',
                title: 'Cardiovascular Protection',
                desc: 'Vasodilation via H2S, platelet aggregation inhibition, and LDL oxidation reduction support heart health.'
            },
            {
                icon: 'sanitizer',
                title: 'Broad-Spectrum Antimicrobial',
                desc: 'Allicin suppresses bacteria, viruses, and fungi, supporting respiratory and systemic defense.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Raw Crushed Garlic (Oral)',
                desc: 'Crush 1-2 cloves, wait 5-10 min for allicin activation, consume with food daily.',
                bestFor: 'Immune support, anti-inflammatory, cardiovascular health'
            },
            {
                method: 'Aged Garlic Extract Capsules',
                desc: 'Standardized odorless supplement for consistent therapeutic dosing.',
                bestFor: 'All indications without strong garlic odor; preferred for long-term use'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'PubMed Central — Garlic antimicrobial properties.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3874089'
            },
            {
                text: 'National Center for Complementary and Integrative Health — Garlic.',
    ...
    'rocket': {
        ...
        activeConstituents: [
            {
                name: 'Isothiocyanates',
                detail: 'Primarily Erucin and secondary volatile organosulfur compounds resulting from glucosinolate hydrolysis.'
            },
            {
                name: 'Fixed Fatty Acids',
                detail: 'High percentages of Oleic acid, Linoleic acid, and naturally occurring physiological concentrations of Erucic acid.'
            },
            {
                name: 'Glucosinolates',
                detail: 'Chiefly Glucoerucin, serving as the biological precursors to functional active sulfur components.'
            },
            {
                name: 'Vitamins & Micronutrients',
                detail: 'High structural densities of Vitamin A, C, and K, supplemented with bioavailable Iron, Magnesium, and elemental Sulfur.'
            },
        ...
        moa: [
            {
                ...
                detail: 'Eruca sativa enhances scalp health and follicular vitality primarily via its dense organosulfur and flavonoid content. These compounds exert potent localized antioxidant actions that neutralize free radicals within the follicular niche. Experimental evidence points towards a significant enhancement of capillary microcirculation surrounding the dermal papilla due to mild hyperemic effects of isothiocyanates. This increased localized blood perfusion increases the delivery of oxygen and essential structural micronutrients, reducing premature breakage and supporting the physiological anagen phase of hair growth.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standard Scientific Extraction (Seed Oil)',
                instruction: 'Industrial cold-pressing of high-quality Eruca sativa seeds to safeguard volatile sulfur complexes and delicate long-chain unsaturated fatty acids from thermal degradation.'
            },
            {
                method: 'Fresh Leaf Extract',
                instruction: 'Mechanically blend fresh, meticulously sanitized rocket leaves with minimal water, filtering through a sterile fine-mesh cloth to yield a dense green fluid mask. Apply directly onto the scalp for 30–60 minutes prior to routine washing.'
            },
            {
                method: 'Infused Macerate Seed Oil',
                instruction: 'Lightly bruise whole rocket seeds to fracture the outer seed coats. Inoculate into a carrier oil matrix (such as Sweet Almond Oil) inside a sealed vessel. Macerate in a dark, warm environment for 14 calendar days with daily agitation, followed by fine filtration.'
            },
        ],
        suitableAgeGroups: [
            ...
            {
                group: 'Children',
                notes: 'Generally safe; highly diluted oil configurations or mild leaf juices are strictly preferred to match delicate pediatric skin.'
            },
            {group: 'Pregnancy', notes: 'Safe for conventional, moderate cosmetic topical use.'},
            {
                group: 'Frequency',
                notes: 'Aqueous leaf juice can be applied twice weekly; the cold-pressed seed oil is massaged thoroughly into the scalp for 5–10 minutes twice weekly prior to cleansing.'
            },
        ],
        overdose: {
            symptoms: [
        ...
        storage: {
            forms: [
                {
                    form: 'Fresh Leaf Extract',
                    instructions: 'Highly unstable; must be compounded and applied immediately due to rapid enzymatic oxidation of active markers.'
                },
                {
                    form: 'Cold-Pressed Seed Oil',
                    instructions: 'Highly stable if preserved within dark amber glass containers, strictly protected from light and elevated thermal indices, for up to 12 months.'
                },
            ],
        },
        marketedProducts: [
    ...
    'garlic': {
        ...
        activeConstituents: [
            {
                ...
                detail: 'Alliin (the primary stable precursor) and Allicin (diallyl thiosulfinate), which is transiently formed via mechanical tissue disruption by the enzyme alliinase. Secondary oil-soluble metabolites include Ajoene, Diallyl disulfide (DADS), and Diallyl trisulfide (DATS).'
            },
            {
                name: 'Polyphenolic Flavonoids',
                detail: 'Primarily Quercetin glycosides and phenolic acids, contributing to localized scavenging of reactive oxygen species (ROS).'
            },
            {
                name: 'Trace Minerals',
                detail: 'Bioavailable Selenium and high structural densities of elemental Sulfur, critical for maintaining epithelial integrity.'
            },
            {
                name: 'Vitamins',
                detail: 'Vitamin C (Ascorbic Acid) and Vitamin B6 (Pyridoxine), acting as metabolic co-factors.'
            },
            {
                name: 'Sulfur-Containing Amino Acids',
                detail: 'Non-protein amino acids that support keratin synthesis and cross-linking pathways.'
            },
        ],
        moa: [
            {
                title: 'Mechanism of Action',
                detail: 'Allium sativum supports the scalp ecosystem and follicular units through multi-targeted pharmacological pathways. Its prominent organosulfur volatile fraction, spearheaded by allicin, exerts potent broad-spectrum antimicrobial and antimycotic actions, directly suppressing opportunistic cutaneous pathogens like Malassezia furfur. Local topical application induces mild counter-irritation and local vasodilation via transient receptor potential (TRP) channels, augmenting microvascular blood perfusion to the dermal papilla. Furthermore, its bioavailable sulfur and selenium profiles furnish necessary building blocks for cross-linking disulfide bonds within the keratin matrix of the growing hair shaft, which mechanically optimizes tensile strength and decreases premature structural breakage.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standard Scientific Extraction',
                instruction: 'Extraction of garlic oil via steam distillation or organic solvent extraction to standardize the concentration of stable diallyl sulfides, or cold expression to isolate temporary allicin fractions under temperature-controlled conditions.'
            },
            {
                method: 'Home-made Formulations (Infused Garlic Oil)',
                instruction: 'Lightly crush or macerate fresh garlic cloves to rupture cellular walls and activate the alliinase enzyme (allow 5–10 minutes for full enzymatic conversion of alliin to active allicin). Submerge the crushed matrices into a stable lipophilic carrier (such as Olive Oil or Coconut Oil) inside an airtight glass container. Macerate for 5 to 7 days in a cool environment away from direct actinic radiation, filter extensively utilizing sterile cloth, and collect the oil.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults',
                notes: 'Completely indicated for regular topical use when adequately diluted in standard carrier oils.'
            },
            {
                group: 'Children',
                notes: 'Highly restricted. Avoid concentrated extracts on pediatric scalps due to high epidermal permeability and susceptibility to chemical micro-burns.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Generally safe for conventional, low-frequency cosmetic topical use; avoid highly concentrated, occlusive, or widespread applications due to systemic absorption of volatile metabolites.'
            },
            {
                group: 'Frequency',
                notes: 'Topically massaged into the designated scalp areas 1 to 2 times per week as a pre-shampoo mask treatment, followed by thorough washing.'
            },
        ],
        overdose: {
            symptoms: [
        ...
        storage: {
            forms: [
                {
                    form: 'Fresh Homemade Extractions',
                    instructions: 'Must be strictly refrigerated (2–8°C) and completely consumed within 3 to 5 days to eliminate the biochemical degradation of allicin and avoid any anaerobic microbial risks.'
                },
                {
                    form: 'Commercial Garlic Oils',
                    instructions: 'Store inside sealed, dark amber glass containers protected from humidity, excessive temperature fluctuations, and direct sunlight.'
                },
            ],
        },
        marketedProducts: [
    ...
    'senna-constipation': {
        ...
        activeConstituents: [
            {
                name: 'Sennosides A & B (Dianthrone Glycosides)',
                percentage: '~80% of total activity',
                effect: 'Key laxative prodrugs; hydrolyzed by colonic microbiota to active rheinthrone which stimulates peristalsis and modifies electrolyte secretion'
            },
            {
                name: 'Sennosides C & D',
                percentage: '~20% of total activity',
                effect: 'Minor anthraquinone glycosides contributing to overall laxative effect'
            },
            {
                name: 'Anthraquinone Glycosides (Dianthrones 75-80%, Anthrones 20-25%)',
                percentage: '',
                effect: 'Collectively responsible for the stimulant laxative property through bacterial prodrug activation in the colon'
            },
        ],
        moa: [
            {
                title: 'Prodrug Activation by Gut Microbiota',
                detail: 'Sennosides are hydrophilic prodrugs that pass unabsorbed through the small intestine. Upon reaching the colon, bacterial beta-glycosidases hydrolyze them into the active metabolite rheinthrone, which then exerts its laxative effects locally.'
            },
            {
                title: 'Intestinal Irritation and Motility Enhancement',
                detail: 'Rheinthrone stimulates the colonic mucosa, causing local irritation that enhances propulsive peristalsis and shortens colonic transit time, driving bowel evacuation.'
            },
            {
                title: 'Fluid and Electrolyte Modulation',
                detail: 'Rheinthrone inhibits Na+/K+-ATPase and opens chloride channels in the colonic mucosa, inhibiting net water absorption and increasing secretion of water and electrolytes into the intestinal lumen, producing a soft, bulky stool.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Senna Tea)',
                instruction: 'Steep 1–2 g of dried Senna leaves in 150 mL of boiling water in a covered vessel for 10 to 15 minutes. Important Note: Do not boil the leaves directly for a prolonged duration, as excessive thermal exposure increases the extraction of harsh resins that cause severe abdominal cramping. Strain the loose leaves. It is recommended to add a slice of ginger or peppermint leaves as a carminative adjuvant to help soothe the gut and mitigate the "griping" (cramping) effect. Best administered at night before bedtime.'
            },
            {
                method: 'Standardized Tablets / Granules',
                instruction: 'Take as directed on the product (typically 15–30 mg sennosides once daily at bedtime for adults). Do not exceed maximum daily dose of 30 mg hydroxyanthracene glycosides. Use only for short periods.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults and Adolescents (>12 years)',
                notes: '15–30 mg of sennosides once daily (usually taken at bedtime). Maximum: 30 mg/day. Short-term use only.'
            },
            {
                group: 'Children 6–12 years',
                notes: '7.5–15 mg of sennosides once daily (often administered as half a tablet or 5 mL of syrup depending on the concentration). Strictly under medical supervision only.'
            },
            {
                group: 'Children 2–6 years',
                notes: '2.5–5 mg of sennosides once daily. Strictly under direct medical supervision only.'
            },
            {group: 'Children under 2 years', notes: 'Strictly Contraindicated.'},
            {
                group: 'Pregnancy & Lactation',
                notes: 'Not recommended. Use during the first trimester is strictly avoided due to insufficient safety data regarding potential genotoxic risks of certain anthraquinones. Should only be considered under strict medical advice if dietary modifications and bulk-forming laxatives fail. Although only negligible amounts of active rheinthrone are excreted in breast milk, use during lactation is discouraged due to a lack of clinical data and the risk of inducing diarrhea or colic in the infant.'
            },
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Senna Leaf Tea',
                    dose: '1–2 g dried leaves steeped 10–15 min in 150 mL boiling water (in a covered vessel); taken at bedtime. Do not boil leaves directly.'
                },
                {
                    form: 'Standardized Tablets (e.g., 7.5 mg sennosides)',
                    dose: 'Adults: 2–4 tablets at bedtime. Children 6–12: 1–2 tablets (often half a tablet). Per product instructions.'
                },
                {
                    form: 'Granules / Syrup',
                    dose: 'As per product concentration and age group; typically 5–10 mL for children 6–12 years.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Temperature',
                    storage: 'Store in a cool, dry place at controlled room temperature, ideally between 15°C to 25°C. Keep away from excessive heat sources.'
                },
                {
                    form: 'Light Protection',
                    storage: 'Store in light-resistant containers (amber glass bottles or opaque packaging) as direct sunlight degrades anthraquinone glycosides.'
                },
                {
                    form: 'Moisture Control',
                    storage: 'Keep the container tightly closed. High humidity promotes mold growth and triggers the hydrolytic breakdown of active chemical compounds.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Senna is a safe, natural herb that can be used daily to lose weight and flatten the stomach.',
                fact: 'Senna is NOT a weight-loss agent. Any weight lost while using Senna is actually "Water Weight" (fluid loss), not fat loss. Using it long-term for weight control is dangerous and medically discouraged.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'medical_services',
                title: 'Clinically Approved Stimulant Laxative',
                desc: 'WHO and EMA monograph-endorsed short-term treatment for occasional or acute constipation with predictable bowel evacuation in 6-12 hours.'
            },
            {
                icon: 'cleaning_services',
                title: 'Pre-procedure Bowel Cleansing',
                desc: 'Used under medical supervision for bowel clearance before colonoscopy, abdominal X-rays, or surgical interventions.'
            },
            {
                icon: 'timer',
                title: 'Rapid and Reliable Onset',
                desc: 'Produces a predictable laxative effect within 6-12 hours, typically overnight when taken at bedtime.'
            },
            {
                icon: 'science',
                title: 'Dual Mechanism Action',
                desc: 'Simultaneously stimulates colonic peristalsis (motility) and modifies electrolyte secretion into the intestinal lumen via Na+/K+-ATPase inhibition.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Aqueous Infusion (Standard Home Use)',
                desc: 'Steep 1-2 g dried leaves in 150 mL boiling water in a covered vessel for 10-15 min. Strain well. Add ginger or peppermint to reduce griping.',
                bestFor: 'Short-term constipation relief; taken at bedtime for morning effect'
            },
            {
                method: 'Standardized Extract (Commercial)',
                desc: 'Tablets and granules standardized to specific sennoside content (e.g., 7.5 mg or 12.5 mg sennoside per tablet) following EMA/WHO monograph guidelines.',
                bestFor: 'Precise dosing; bowel preparation for medical procedures'
            },
        ],
        ...
        references: [
            {
                text: 'European Medicines Agency — Senna leaf herbal monograph.',
                url: 'https://www.ema.europa.eu/en/medicines/herbal/sennae-folium'
            },
            {
                text: 'WHO — Senna monograph (iris.who.int).',
                url: 'https://iris.who.int/server/api/core/bitstreams/6e21eaaa-d157-421d-a136-eb61964de18c/content'
            },
            ...
            {
                text: 'EMA — Senna leaf public summary (PDF).',
                url: 'https://www.ema.europa.eu/en/documents/herbal-summary/senna-leaf-summary-public_en.pdf'
            },
            {
                text: 'EMA — Final assessment report on Senna alexandrina (PDF).',
                url: 'https://www.ema.europa.eu/en/documents/herbal-summary/final-assessment-report-senna-alexandrina-mill-cassia-senna-l-cassia-angustifolia-vahl-1-folium-and-fructus-revision-1_en.pdf-0'
            },
            {
                text: 'Egyptian Drug Authority — Egyptian Herbal Monograph 2023.',
                url: 'https://edaegypt.gov.eg/media/l40dm3jl/egyptian-herbal-monograph_2023.pdf'
            },
        ],
    },
    ...
    'psyllium-constipation': {
        ...
        activeConstituents: [
            {
                name: 'Mucilage (Arabinoxylans)',
                percentage: '10–30% of husk weight',
                effect: 'High-molecular-weight heteropolysaccharides; exceptionally hydrophilic: absorb up to 40× weight in water, forming viscous gel that resists GI enzymatic degradation'
            },
        ],
        moa: [
            {
                title: 'Hydration Phase',
                detail: 'Upon ingestion with adequate fluids, the mucilage evades small intestinal digestion, absorbing intraluminal water within the gut cavity.'
            },
            {
                title: 'Lumen Expansion',
                detail: 'The formation of a stable, hydrated gel matrix significantly increases the total physical volume (bulk) and moisture content of the fecal mass, softening its consistency.'
            },
            {
                title: 'Mechanical Trigger',
                detail: 'The expanded bulk exerts direct mechanical radial stretch on the mechanoreceptors located within the smooth muscle walls of the colon. This activates the intrinsic myenteric reflex, stimulating propulsive peristalsis.'
            },
            {
                title: 'Bacterial Fermentation Support',
                detail: 'The arabinoxylans undergo partial anaerobic fermentation by the colonic microbiota, generating Short-Chain Fatty Acids (SCFAs) such as acetate, propionate, and butyrate. These SCFAs provide trophic energy to the colonic mucosa (colonocytes) and modulate motility.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Preparation',
                instruction: 'Mix 1 sachet or 1 tablespoon (approximately 5–10 g) into a full glass (250 mL) of cool water, milk, or juice. Stir rapidly and consume immediately before the gelatinization process renders it too viscous to swallow.'
            },
            {
                method: 'Follow-up Hydration (Mandatory)',
                instruction: 'Drink an additional full glass of water immediately after ingestion.'
            },
            {
                method: 'Timing',
                instruction: 'May be administered at any point of the day. However, it must NEVER be taken immediately before bedtime to avoid esophageal or intestinal stagnation during recumbency.'
            },
            {
                method: 'Daily Fluid Maintenance',
                instruction: 'Patients must maintain an overall high fluid intake (6 to 8 glasses of water daily) to avoid mechanical fecal impaction.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults & Adolescents (>12 years)',
                notes: '5–10 grams taken 1–3 times daily depending on clinical severity. Maximum: 30 g/day. Always with adequate fluid.'
            },
            {
                group: 'Children (6–12 years)',
                notes: '2.5–5 grams (half of the adult dose) administered 1–2 times daily. Mandatory fluid monitoring. Ensure the child can swallow the mixture properly to avoid choking risks.'
            },
            {
                group: 'Children (<6 years)',
                notes: 'Dosage must be determined by a pediatrician. Generally not recommended for self-medication in this age group.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Category B (Safe). Established as the preferred first-line therapeutic agent for gestational constipation. Actions are purely mechanical and intraluminal; not absorbed systemically and poses no fetal risk. Safe during lactation.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Effervescent Sachets (e.g., Fybogel)',
                    dose: '1 sachet (3.5 g ispaghula husk) dissolved in 150 mL water, taken 2× daily morning and evening.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Powder / Sachets',
                    storage: 'Store in a cool, dry place below 25°C in tightly sealed, airtight containers. Absolute protection from ambient moisture and high humidity is mandatory, as premature exposure to water vapor initiates internal swelling and destroys the plant\'s therapeutic capacity before usage.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Psyllium is strictly an OTC drug for treating acute constipation attacks.',
        ...
        benefits: [
            {
                icon: 'favorite',
                title: 'First-Line Constipation Therapy',
                desc: 'EMA and WHO monograph-endorsed non-habit-forming bulk-forming laxative; safe for long-term use, pregnancy, and IBS management unlike stimulant laxatives.'
            },
            {
                icon: 'bar_chart',
                title: 'Cholesterol & Glucose Management',
                desc: 'Viscous gel binds bile acids and dietary cholesterol, lowering LDL. When taken with meals, flattens postprandial glucose spikes in Type 2 Diabetes.'
            },
            {
                icon: 'water_drop',
                title: 'Stool Softening & Bowel Regulation',
                desc: 'Absorbs up to 40× its weight in water, forming a gel that softens stool and relieves straining in hemorrhoids, anal fissures, and post-surgical patients.'
            },
            {
                icon: 'spa',
                title: 'IBS Symptom Normalizer',
                desc: 'Normalizes stool consistency and transit times in both IBS-C and alternating IBS, reducing urgency, cramping, and discomfort.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                ...
                desc: 'Mix 5–10 g powder in 250 mL of cool water or juice, stir rapidly, and consume immediately before gelatinization. Always follow with another full glass of fluid.',
                bestFor: 'Chronic constipation, IBS, bowel regulation, hemorrhoid relief'
            },
            {
                method: 'Effervescent Sachets',
                desc: 'Dissolve sachet in water (creates a fizzy, palatable suspension). Take 2× daily morning and evening after meals.',
                bestFor: 'Better compliance and palatability vs. plain powder'
            },
        ],
        ...
        references: [
            {
                text: 'Egyptian Drug Authority — Plantago ovata monograph.',
                url: 'https://share.google/lH8q4stDezqsL7jNQ'
            },
            {
                text: 'European Medicines Agency — Plantago ovata herbal monograph.',
                url: 'https://www.ema.europa.eu/en/medicines/herbal/plantaginis-ovatae-seminis-tegumentum'
            },
            {
                text: 'EMA — Community herbal monograph on Plantago ovata (PDF).',
                url: 'https://www.ema.europa.eu/en/documents/herbal-monograph/final-community-herbal-monograph-plantago-ovata-forssk-semen_en.pdf'
            },
            {
                text: 'ScienceDirect — Psyllium husk review.',
                url: 'https://www.sciencedirect.com/science/article/abs/pii/S092422441830791X'
            },
            ...
            {
                text: 'NCBI LactMed — Psyllium.',
                url: 'https://www.ncbi.nlm.nih.gov/books/n/lactmed/LM471/?report=reader'
            },
            {text: 'PubMed Central — Psyllium in pregnancy.', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3418980'},
            {
                text: 'PubMed Central — Psyllium fiber and health outcomes.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12422764/'
            },
        ],
    },
    ...
    'castor-constipation': {
        ...
        activeConstituents: [
            {
                ...
                percentage: '85–90% of total fatty acid content',
                effect: 'Active metabolite released by pancreatic lipase; selective prostanoid receptor agonist (SEP_3/SEP_4) triggering intense small-intestinal peristalsis and fluid secretion'
            },
        ],
        moa: [
            {
                title: 'Enzymatic Activation (The Pro-drug Effect)',
                detail: 'Castor oil itself is pharmacologically inactive. Once it reaches the small intestine, it is hydrolyzed by pancreatic lipase enzymes, breaking down the triglycerides into glycerol and ricinoleic acid — the active metabolite.'
            },
            {
                title: 'Receptor Binding (Molecular Level)',
                detail: 'Ricinoleic acid acts as a selective agonist for specific prostanoid receptors: it binds to SEP_3 and SEP_4 receptors on the smooth muscle cells of the intestinal wall. This binding mimics the action of natural prostaglandins, triggering immediate and strong muscle contractions.'
            },
            {
                title: 'Stimulation of Peristalsis',
                detail: 'Unlike Senna (which primarily affects the colon), ricinoleic acid stimulates the small intestine. It causes massive peristalsis — rapid, wave-like contractions that push contents forward quickly — and decreased transit time so fast that the body cannot absorb water.'
            },
            {
                title: 'Secretory Effect (Electrolyte Alteration)',
                detail: 'Ricinoleic acid alters cell membrane permeability of the intestinal mucosa: it inhibits the Na/K ATPase pump (blocking sodium and potassium absorption) and stimulates the secretion of water and electrolytes into the intestinal lumen, keeping the stool liquid and voluminous for rapid evacuation.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Oral Administration with Juice',
                instruction: 'Mix the prescribed dose thoroughly with a glass of cold orange, lemon, or apple juice to mask the viscous texture and unpleasant taste. Chilling the oil prior to administration helps suppress the gag reflex and reduce nausea. Alternatively, mix with cold ginger ale. Drink at least 6–8 glasses of water throughout the day to replace lost intraluminal fluids and prevent systemic dehydration. Onset of action: 2–6 hours.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults & Adolescents (>12 years)',
                notes: '15–60 mL as a single oral dose. Onset: 2–6 hours. Mandatory copious fluid intake (6–8 glasses of water) throughout the day.'
            },
            {group: 'Children (2–11 years)', notes: '5–15 mL administered strictly under direct medical supervision.'},
            {
                group: 'Children (<2 years)',
                notes: 'Strictly Contraindicated. No safe clinical data is available for infants; it can precipitate life-threatening dehydration and rapid electrolyte imbalance.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Strictly Contraindicated (Category X). Ricinoleic acid stimulates uterine smooth muscle contractions, posing a high risk of premature labor, uterine hemorrhage, or miscarriage. Safe clinical data is absent during lactation.'
            },
            {
                group: 'Geriatrics (65+ years)',
                notes: 'Generally discouraged due to increased susceptibility to orthostatic hypotension from rapid dehydration and physical strain.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Castor Oil (Oral)',
                    dose: 'Adults: 15–60 mL single dose chilled and mixed in cold citrus juice or ginger ale. Children 2–11 years: 5–15 mL under medical supervision. Always chilled and mixed in cold juice.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Castor Oil',
                    storage: 'Store in well-filled, tightly closed, light-resistant containers in a cool place, ideally below 25°C. Protection from direct sunlight is required to prevent oxidation and rancidity of the unsaturated fatty acid fractions.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Castor oil is a safe, natural daily detox agent to cleanse the gut and promote hair growth inside the eyes safely.',
                fact: 'Castor oil is a severe, high-potency purgative; chronic use for "detox" is dangerous and can cause permanent damage to the myenteric plexus (intestinal nerves). Furthermore, while used topically for scalp or eyelash hair growth, direct contact with the ocular mucosa causes severe chemical irritation and conjunctivitis.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'bolt',
                title: 'Rapid Powerful Evacuation',
                desc: 'Produces bowel evacuation within 2–6 hours via prostanoid receptor agonism in the small intestine: significantly faster than senna (6–12 h) or psyllium.'
            },
            {
                icon: 'medical_services',
                title: 'Bowel Preparation Standard',
                desc: 'Established tool for pre-procedure bowel cleansing before colonoscopy, X-rays, and surgical interventions under medical supervision.'
            },
            {
                icon: 'science',
                title: 'Dual Mechanism Action',
                desc: 'Ricinoleic acid simultaneously stimulates SEP_3/SEP_4 prostanoid receptors (motility) and inhibits Na+/K+-ATPase (fluid secretion) for complete, rapid evacuation.'
            },
            {
                icon: 'warning',
                title: 'Strictly Short-term Only',
                desc: 'Chronic use causes permanent myenteric plexus damage (Lazy Bowel Syndrome). Only for acute short-term use under medical guidance: never for routine constipation or weight loss.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Cold-pressed Oil (Oral)',
                desc: 'Chill the oil before administration. Mix 15–60 mL in cold citrus juice and consume as a single dose. Mandatory copious hydration (6–8 glasses/day) throughout the day.',
                bestFor: 'Acute constipation; short-term rapid bowel evacuation; pre-procedure bowel preparation'
            },
        ],
        ...
        references: [
            {
                text: 'European Medicines Agency — Ricinus communis herbal monograph.',
                url: 'https://www.ema.europa.eu/en/medicines/herbal/ricini-oleum'
            },
            {
                text: 'EMA — European Union herbal monograph on Ricinus communis L. oleum (PDF).',
                url: 'https://www.ema.europa.eu/en/documents/herbal-monograph/final-european-union-herbal-monograph-ricinus-communis-l-oleum_en.pdf'
            },
            {text: 'PubChem — Castor oil.', url: 'https://pubchem.ncbi.nlm.nih.gov/compound/Castor-oil'},
            {
                text: 'Healthline — Castor Oil for Constipation.',
                url: 'https://www.healthline.com/health/digestive-health/castor-oil-for-constipation'
            },
    ...
    'peppermint-diarrhea': {
        ...
        activeConstituents: [
            {
                name: 'Menthol (30–55%)',
                percentage: '30–55% of volatile oil',
                effect: 'L-type Ca²⁺ channel blocker in intestinal smooth muscle (antispasmodic); TRPM8 cold receptor agonist (visceral analgesia); primary active principle'
            },
            {
                name: 'Menthone (14–32%)',
                percentage: '14–32%',
                effect: 'Precursor ketone synergizing with menthol in antispasmodic action'
            },
            {
                name: 'Menthofuran (1–9%)',
                percentage: '1–9%',
                effect: 'Minor component; potential hepatotoxin at high concentrations: must be monitored'
            },
            {
                name: 'Rosmarinic Acid & Flavonoids (Luteolin, Apigenin, Eriocitrin)',
                percentage: '',
                effect: 'Anti-inflammatory, gastroprotective, and systemic antioxidant actions'
            },
        ],
        moa: [
            {
                title: 'Calcium Channel Antagonism (Antispasmodic)',
                detail: 'Menthol acts as a natural voltage-gated L-type calcium channel blocker in intestinal smooth muscle. Inhibits extracellular Ca²⁺ influx, preventing sustained contractions, resolving GI spasms, hypermotility, and excessive bowel movements.'
            },
            {
                title: 'TRPM8 Receptor Activation (Visceral Analgesia)',
                detail: 'Menthol selectively activates TRPM8 cold receptors in GI afferent nerve fibers, eliciting a local cooling and desensitizing effect, inducing mild analgesia over hyperalgesic visceral walls.'
            },
            {
                title: 'Carminative & Surface Tension Reduction',
                detail: 'Relaxes the lower esophageal sphincter (LES), facilitating expulsion of trapped gas, rapidly mitigating flatulence, bloating, and epigastric tension.'
            },
            {
                title: 'Antimicrobial & Anti-inflammatory',
                detail: 'Direct bacteriostatic efficacy against standard GI pathogens; inhibits local pro-inflammatory eicosanoid cascades by suppressing leukotriene and prostaglandin production.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Enteric-Coated Oil Capsules',
                instruction: 'Take 0.2–0.4 mL (180–360 mg) 3× daily, 30–60 minutes before meals. MUST be enteric-coated: swallow whole, never crush or chew.'
            },
            {
                method: 'Peppermint Tea (Aqueous Infusion)',
                instruction: 'Steep 1.5–3 g dried leaves in 150 mL boiling water in a covered vessel for 5–10 minutes (covering preserves volatile menthol). Drink warm 2–3 times daily.'
            },
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Children (<4 years)',
                notes: 'Pure peppermint oil STRICTLY CONTRAINDICATED: menthol near nasal mucosa can trigger fatal laryngeal/bronchial spasms and respiratory arrest.'
            },
            {
                group: 'Children (>4 years)',
                notes: 'Mild aqueous infusions (tea) generally safe. Avoid concentrated oil products.'
            },
            {
                group: 'Pregnant & Breastfeeding Women',
                notes: 'Food-grade tea usage considered safe. High therapeutic doses of concentrated essential oils AVOIDED due to potential emmenagogue actions.'
            },
            {
                group: 'Geriatrics',
                notes: 'Safe, but requires clinical profiling due to higher prevalence of hiatal hernia or GERD.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    ...
                    dose: '0.2–0.4 mL (180–360 mg) 3× daily, 30–60 min before meals. Swallow whole: never crush.'
                },
                {
                    form: 'Peppermint Tea',
                    dose: '1.5–3 g dried leaves in 150 mL boiling water (covered), 5–10 min steep. 2–3× daily.'
                },
        ...
        storage: {
            forms: [
                ...
                {
                    form: 'Enteric-Coated Capsules',
                    storage: 'Original packaging below 25°C, away from moisture and heat.'
                },
                {
                    form: 'Volatile Oil Products',
                    storage: 'Hermetically sealed to prevent evaporation and compositional oxidation.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Peppermint oil is an appropriate curative drug for severe, high-fever infectious bacterial or amoebic dysentery.',
                fact: 'Peppermint oil holds no in-vivo curative efficacy against virulent invasive enteropathogens nor does it resolve clinical dehydration. It serves as an exceptional, clinically validated supportive/antispasmodic phytotherapy targeting functional bowel hypermotility, cramping, and IBS symptoms.'
            },
        ],
        marketedProducts: [
            {name: 'Colpermin Capsules (Enteric-coated Peppermint oil 187 mg)', image: '/images/Picture280.jpeg'},
            {
                name: 'IBgard Capsules (Sustained-release peppermint oil microspheres)',
                image: '/images/IBgard Capsules.jpeg'
            },
        ],
        benefits: [
            {
                icon: 'spa',
                title: 'Gold Standard for IBS',
                desc: 'Multiple meta-analyses confirm peppermint oil capsules significantly reduce IBS pain, stool frequency, and urgency: endorsed by EMA as validated phytotherapy.'
            },
            {
                icon: 'air',
                title: 'Natural GI Smooth Muscle Relaxant',
                desc: 'Menthol\'s L-type Ca²⁺ channel blockade resolves painful intestinal spasms and hypermotility without habit formation.'
            },
            {
                icon: 'thermostat',
                title: 'Visceral Analgesia via TRPM8',
                desc: 'TRPM8 cold receptor activation in GI afferent nerves induces cooling analgesia, desensitizing hyperalgesic visceral walls and reducing chronic gut pain.'
            },
            {
                icon: 'bubble_chart',
                title: 'Rapid Gas Relief',
                desc: 'Carminative action mitigates flatulence, painful bloating, and epigastric tension by relaxing the LES and facilitating gas expulsion.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Enteric-Coated Capsule',
                desc: 'Pharmaceutical-grade capsule standardized to peppermint oil content. Delivers menthol to the small intestine and colon while bypassing the stomach.',
                bestFor: 'IBS; GI spasms; functional diarrhea'
            },
            {
                method: 'Aqueous Infusion (Tea)',
                desc: 'Steep 1.5–3 g dried leaves in 150 mL boiling water in a COVERED vessel for 5–10 minutes. Covering is essential to preserve volatile menthol.',
                bestFor: 'Mild GI discomfort, nausea, flatulence, bloating'
            },
        ],
        ...
        references: [
            {
                text: 'National Center for Complementary and Integrative Health — Peppermint Oil.',
            ...
            {
                text: 'PubMed Central — Peppermint biological activity review.',
                url: 'https://share.google/hD2KOnWY8C07TwKo6'
            },
        ],
    },
    ...
    'chamomile-diarrhea': {
        ...
        activeConstituents: [
            {
                name: 'Chamazulene',
                percentage: 'Formed from matricin during distillation',
                effect: 'COX and 5-LOX inhibitor; powerful anti-inflammatory; characteristic deep blue color of distilled chamomile oil'
            },
            {
                name: 'α-Bisabolol & Bisabolol Oxides',
                percentage: '',
                effect: 'Antispasmodic, anti-inflammatory, and antimicrobial; promotes mucosal healing and ulceration recovery'
            },
            {
                name: 'Apigenin-7-glucoside (Flavone)',
                percentage: 'Predominant hydrophilic flavonoid',
                effect: 'Competitive GABA-A benzodiazepine receptor ligand; mild sedation and anxiolytic; spasmolytic via Ca²⁺ channel blockade and PDE inhibition'
            },
            {
                name: 'Coumarins (Umbelliferone, Herniarin)',
                percentage: '',
                effect: 'Secondary smooth muscle relaxation; monitor in patients on anticoagulants'
            },
        ],
        moa: [
            {
                title: 'COX/5-LOX Inhibition (Anti-inflammatory)',
                detail: 'Chamazulene and α-bisabolol directly inhibit cyclooxygenase (COX) and 5-lipoxygenase (5-LOX) pathways, significantly reducing synthesis of pro-inflammatory prostaglandins and leukotrienes, mitigating intestinal mucosal irritation and edema.'
            },
            {
                title: 'Antispasmodic via Ca²⁺ & PDE Inhibition',
                detail: 'Apigenin and bisabolol synergistically block voltage-dependent calcium channels and inhibit intracellular cyclic nucleotide phosphodiesterases, effectively resolving smooth muscle hyperreactivity, abdominal cramping, and bloating.'
            },
            {
                title: 'GABA-A Receptor Agonism (Sedative/Anxiolytic)',
                detail: 'Apigenin acts as a competitive ligand for central GABA-A benzodiazepine receptors, inducing mild sedation and reducing psychosomatic GI distress in stress-induced bowel disorders.'
            },
            {
                title: 'Mucosal Soothing & Antimicrobial',
                detail: 'Bacteriostatic action against common GI pathogens; local demulcent effect over gastric and intestinal mucosa, accelerating healing of ulcerations.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Chamomile Tea (Aqueous Infusion)',
                instruction: 'Steep 2–3 g of dried flower heads in 150–250 mL boiling water in a covered vessel for 5–10 minutes (covering prevents loss of volatile oils, particularly chamazulene). Take 3–4 times daily between meals.'
            },
            {
                method: 'Standardized Capsules / Extracts',
                instruction: '200–500 mg taken 2–3 times per day, standardized to apigenin or volatile oil content.'
            },
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Children',
                notes: 'Very mild, well-diluted aqueous infusions safe for infantile colic and mild GI discomfort: under medical supervision.'
            },
            {
                group: 'Pregnant & Breastfeeding Women',
                notes: 'Standard culinary tea doses generally safe. High therapeutic doses or concentrated extracts AVOIDED due to theoretical uterine stimulation risks.'
            },
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Chamomile Tea',
                    dose: '2–3 g dried flowers steeped 5–10 min (covered) in 150–250 mL water. 3–4× daily between meals.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Flower Heads / Standardized Formulations',
                    storage: 'Tightly sealed, airtight, light-resistant containers below 25°C. Prevent moisture absorption, volatile oil volatilization, and photodegradation of chamazulene.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Chamomile tea alone can cure severe, infectious bacterial or amoebic diarrhea instantly.',
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Gentle GI Anti-inflammatory',
                desc: 'Chamazulene and bisabolol inhibit both COX and 5-LOX pathways, reducing mucosal inflammation in gastritis, IBS, and mild diarrhea: without the GI side effects of NSAIDs.'
            },
            {
                icon: 'self_improvement',
                title: 'GABA-A Anxiolytic for Gut-Brain Axis',
                desc: 'Apigenin\'s GABA-A receptor binding calms psychosomatic GI distress and anxiety, addressing the gut-brain connection in stress-induced bowel disorders.'
            },
            {
                icon: 'healing',
                title: 'Mucosal Healing & Demulcent',
                desc: 'α-Bisabolol soothes and accelerates healing of gastric and intestinal ulcerations, protecting the mucosal lining during acute GI inflammation.'
            },
            {
                icon: 'local_florist',
                title: 'Infantile Colic Relief',
                desc: 'Mild chamomile infusions have clinical evidence for safely reducing infantile colic symptoms through GI smooth muscle relaxation.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Aqueous Infusion (Tea)',
                desc: 'Steep 2–3 g dried flower heads in 150–250 mL boiling water in a COVERED vessel for 5–10 minutes. Covering is critical to prevent loss of volatile chamazulene.',
                bestFor: 'Mild diarrhea, GI spasms, gastritis, flatulence, infantile colic, mild insomnia'
            },
            {
                method: 'Standardized Capsule Extract',
                desc: 'Pharmaceutical-grade capsules standardized to apigenin content for consistent therapeutic outcomes.',
                bestFor: 'IBS, anxiety-associated GI distress, precise dosing'
            },
        ],
        ...
        references: [
            {
                text: 'National Center for Complementary and Integrative Health — Chamomile.',
            ...
            {text: 'PubMed — Chamomile pharmacological studies.', url: 'https://pubmed.ncbi.nlm.nih.gov/16635985/'},
            {
                ...
                url: 'https://www.ema.europa.eu/en/medicines/herbal/matricaria-flower'
            },
    ...
    'clove': {
        ...
        activeConstituents: [
            {
                name: 'Eugenol (70–90% of essential oil)',
                detail: 'Primary phenolic compound responsible for antimicrobial, local anesthetic, anti-inflammatory, and mild analgesic effects.'
            },
            {
                name: 'Eugenol Acetate, β-Caryophyllene, α-Humulene',
                detail: 'Secondary sesquiterpenes contributing antimicrobial and anti-inflammatory activity.'
            },
        ],
        moa: [
            {
                title: 'Cell Membrane Disruption',
                detail: 'The hydroxyl group (-OH) of eugenol disrupts bacterial lipid bilayers, increasing membrane permeability and causing leakage of vital intracellular materials.'
            },
            {
                title: 'Protein & Enzyme Inhibition',
                detail: 'Eugenol penetrates microbial cells and inhibits protein and DNA synthesis, preventing multiplication.'
            },
            {
                title: 'Biofilm Prevention',
                detail: 'Blocks formation of bacterial biofilms, effective against dental plaque-forming pathogens.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Antiseptic Mouthwash (Infusion)',
                instruction: 'Boil a cup of water, steep 5–6 whole cloves until cool, strain and use as antibacterial mouthwash. Do not swallow.'
            },
            {
                method: 'Topical Application',
                instruction: 'Mix 10–15 drops of clove essential oil per ounce of carrier oil (coconut or olive). Apply with cotton ball to affected area. Never apply undiluted.'
            },
        ],
        suitableAgeGroups: [
            {group: 'Adults', notes: 'Oral and topical use appropriate when properly diluted.'},
            {
                ...
                notes: 'Topical only under adult supervision; dilute well in carrier oil. No internal use.'
            },
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Mouthwash (Infusion)',
                    dose: '5–6 cloves steeped in 1 cup water. Use as rinse; do not swallow.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Whole Cloves / Essential Oil',
                    storage: 'Cool, dark, dry environment (15–25°C) in airtight containers. Protect from heat and moisture to prevent essential oil degradation.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'sanitizer',
                title: 'Broad-Spectrum Oral Antiseptic',
                desc: 'Eugenol disrupts bacterial membranes and blocks biofilm formation, making clove one of the most effective natural agents against dental caries-causing bacteria.'
            },
            {
                icon: 'healing',
                title: 'Natural Topical Analgesic',
                desc: 'Acts as a selective local anesthetic on dental and mucosal pain receptors, providing rapid temporary relief for toothaches and sore gums without systemic side effects.'
            },
            {
                icon: 'science',
                title: 'Anti-Biofilm & Antifungal',
                desc: 'Prevents Candida and bacterial biofilm formation on oral and skin surfaces, providing protective anti-infective action without promoting antibiotic resistance.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Clove Oil Dental Application',
                desc: 'Dilute 2 drops clove essential oil in 1 tsp olive oil. Apply with cotton ball directly to painful tooth or gum area for temporary relief.',
                bestFor: 'Toothache, sore gums, oral ulcers'
            },
            {
                method: 'Clove Mouthwash Infusion',
                desc: 'Steep 5–6 cloves in boiling water until cool, strain and rinse mouth for 30 seconds. Do not swallow.',
                bestFor: 'Oral hygiene, gum inflammation, bad breath'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'Darwin Nutrition — Clove active constituents.',
                url: 'https://www.darwin-nutrition.fr/en/active/clove'
            },
        ],
    },
    ...
    'dandelion': {
        ...
        activeConstituents: [
            {
                name: 'Potassium Salts (Leaves, 3–5%)',
                detail: 'Exceptionally high endogenous potassium content continuously compensates for potassium excreted during diuresis: maintaining electrolyte balance unlike synthetic diuretics.'
            },
            {
                name: 'Flavonoids (Luteolin) & Coumarins',
                detail: 'Act on renal tubules to stimulate water excretion and provide anti-inflammatory support.'
            },
            {
                name: 'Sesquiterpene Lactones (Roots)',
                detail: 'Bitter principles stimulate bile secretion (choleretic effect) improving upper GI digestion and lipolysis.'
            },
        ],
        moa: [
            {
                title: 'Aquaretic Effect (Potassium-Sparing)',
                detail: 'High potassium + flavonoids act on renal tubules to stimulate water excretion without accelerating electrolyte depletion, unlike loop or thiazide diuretics.'
            },
            {
                title: 'Potassium Self-Replacement',
                detail: 'Unlike conventional diuretics that cause hypokalemia, dandelion\'s endogenous potassium compensates for renal potassium loss during diuresis.'
            },
            {
                title: 'Choleretic Effect (Root)',
                detail: 'Sesquiterpene lactone bitter compounds stimulate gustatory receptors, inducing increased bile secretion and improving hepatic and GI digestion.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Dandelion Leaf Tea',
                instruction: 'Steep 4–10 g dried leaves in 150–200 mL boiling water (covered) for 10 minutes. Consume up to 3 times daily. Maintain high fluid intake throughout the day.'
            },
        ...
        suitableAgeGroups: [
            {
                group: 'Adults',
                notes: 'Safe at therapeutic doses with adequate hydration. Monitor BP if taking antihypertensives.'
            },
            {group: 'Elderly', notes: 'Use with caution in cardiovascular disease. Close BP monitoring required.'},
            {
                group: 'Children (<12 years)',
                notes: 'Not recommended for self-medication: insufficient pediatric safety data.'
            },
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Leaves / Tea Sachets',
                    storage: 'Store dried loose leaves or packaged tea in tightly sealed, light-resistant containers in a cool, dry place. Absolute protection from moisture and high humidity is mandatory, as dandelion leaves are highly hygroscopic and highly prone to fungal and mold spoilage.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Dandelion roots work with the exact same mechanism and potency as dandelion leaves for renal diuresis.',
                fact: 'The leaves operate primarily as a potent diuretic (aquaretic) due to their high potassium and flavonoid content. In contrast, the roots target hepatic and digestive pathways, acting chiefly as a bitter choleretic and prebiotic due to their high concentration of sesquiterpene lactones and inulin.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'water_drop',
                title: 'Potassium-Sparing Diuretic',
                desc: 'Unlike loop or thiazide diuretics that deplete potassium, dandelion\'s own high potassium content self-replenishes what is excreted: a unique safety profile in natural diuresis.'
            },
            {
                icon: 'cleaning_services',
                title: 'Urinary Tract Flushing',
                desc: 'Increases urine volume to mechanically flush micro-crystals and bacteria from the urinary tract, supporting UTI prevention and urological health.'
            },
            {
                icon: 'favorite',
                title: 'Liver & Bile Support',
                desc: 'Root sesquiterpene lactones stimulate bile production and flow, supporting hepatic detoxification and fat digestion.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Diuretic Leaf Tea',
                desc: 'Steep 4–10 g fresh or dried dandelion leaves in covered 200 mL boiling water for 10 minutes. Drink up to 3 cups daily. Always maintain generous fluid intake.',
                bestFor: 'Fluid retention, mild edema, urinary flushing'
            },
            {
                method: 'Choleretic Root Decoction',
                desc: 'Gently boil 2–5 g dried root in 200 mL water for 10 minutes. Strain and drink. Used specifically for liver and bile support.',
                bestFor: 'Digestive support, bile stimulation, liver health'
            },
        ],
        relatedPlants: ['parsley', 'stinging-nettle', 'cranberry'],
        references: [
            {
                text: 'Egyptian Drug Authority — Taraxacum officinale monograph.',
                url: 'https://edaegypt.gov.eg/media/pozoqoej/taraxacum-officinale-weber_2025-2.pdf'
            },
            {text: 'WebMD — Dandelion.', url: 'https://www.webmd.com/vitamins/ai/ingredientmono-706/dandelion'},
            {
                text: 'Science Insights — Dandelion leaf health benefits.',
                url: 'https://scienceinsights.org/what-is-dandelion-leaf-good-for-health-benefits/'
            },
            {
                text: 'Verywell Health — Natural Diuretics.',
                url: 'https://www.verywellhealth.com/natural-diuretics-8546926'
            },
            {
                text: 'Biology Insights — Is Dandelion Tea a Laxative or a Diuretic?',
                url: 'https://biologyinsights.com/is-dandelion-tea-a-laxative-or-a-diuretic/'
            },
            {
                text: 'European Medicines Agency — Taraxacum folium herbal monograph.',
                url: 'https://www.ema.europa.eu/en/medicines/herbal/taraxaci-folium'
            },
        ],
    },
    ...
    'parsley': {
        ...
        activeConstituents: [
            {
                name: 'Apiol (60–80% of seed essential oil)',
                detail: 'Inhibits renal tubular Na⁺/K⁺-ATPase pump, trapping sodium in tubular lumen and forcing fluid clearance: osmotic/aquaretic effect.'
            },
            {
                name: 'Myristicin (10–30% of seed oil)',
                detail: 'Direct renal vasodilator; relaxes afferent arterioles, increasing renal blood flow and glomerular filtration rate (GFR).'
            },
            {
                name: 'Apiin (2.5–4%), Potassium (554 mg/100g), Vitamin C (133 mg/100g)',
                detail: 'Potassium creates osmotic drag; Vitamin C and flavonoids lower urinary calcium and increase citrate, preventing calcium oxalate crystal formation.'
            },
        ],
        moa: [
            {
                title: 'Na⁺/K⁺-ATPase Inhibition (Aquaretic)',
                detail: 'Apiol inhibits the basolateral Na⁺/K⁺-ATPase pump in renal tubules, trapping sodium in the tubular lumen, preventing water reabsorption and forcing urine output.'
            },
            {
                title: 'Renal Vasodilation (↑GFR)',
                detail: 'Myristicin relaxes afferent arterioles, increasing renal blood flow and glomerular filtration rate to generate downstream hydraulic pressure for urinary flushing.'
            },
            {
                title: 'Anti-urolithic Kinetic Alteration',
                detail: 'Vitamin C and flavonoids lower urinary calcium excretion and increase citrate output, shifting urinary pH to inhibit calcium oxalate micro-crystal nucleation and aggregation.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Parsley Leaf Tea',
                instruction: 'Steep 2–4 g dried leaves in 150 mL boiling water (covered) for 10–15 minutes. Take up to 3 times daily. Consume with ample water throughout the day.'
            },
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Elderly with Renal Disease',
                notes: 'Highly discouraged in compromised kidney function: potential structural tissue overload.'
            },
        ],
        dosage: {
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Leaves / Essential Oil',
                    storage: 'Must be stored in airtight, hermetically sealed, amber glass containers to fully eliminate light exposure and moisture absorption. Storage temperatures must remain strictly below 25°C to prevent the rapid thermal volatilization and degradation of Apiol and Myristicin.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Consuming large quantities of parsley tea can completely dissolve and liquefy large, structural staghorn or coral-like kidney stones.',
                fact: 'Parsley operates purely as an irrigation, aquaretic, and prophylactic agent. It effectively flushes out micro-crystals and sand-like gravels before they aggregate into major stones, but large, structurally established, or impacted calculi require shockwave lithotripsy or surgical intervention.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'water_drop',
                title: 'Dual-Mechanism Aquaretic',
                desc: 'Apiol blocks tubular sodium reabsorption while myristicin raises GFR via renal vasodilation: a two-point mechanism providing efficient urinary output without the electrolyte disruption of loop diuretics.'
            },
            {
                icon: 'science',
                title: 'Anti-urolithic Protection',
                desc: 'Vitamin C and flavonoids shift urinary chemistry to prevent calcium oxalate micro-crystal nucleation, acting as a preventive flush before small crystals can aggregate into kidney stones.'
            },
            {
                icon: 'nutrition',
                title: 'Nutritional Powerhouse',
                desc: 'Exceptional potassium (554 mg/100g), vitamin C (133 mg/100g), and vitamin K1: providing bone health, vascular support, and immune function alongside its diuretic properties.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Diuretic Leaf Infusion',
                desc: 'Steep 2–4 g dried parsley leaves in 150 mL boiling water (covered) for 10–15 minutes. Drink up to 3 cups daily with generous water intake throughout.',
                bestFor: 'Urinary flushing, kidney stone prevention, fluid retention'
            },
        ],
        relatedPlants: ['dandelion', 'halfabar', 'fennel'],
        references: [
            {
                text: 'PubMed — Petroselinum crispum diuretic activity.',
                url: 'https://pubmed.ncbi.nlm.nih.gov/11849841/'
            },
            {
                text: 'ScienceDirect — Parsley: Bioactive compounds and health benefits (book chapter).',
                url: 'https://www.sciencedirect.com/science/chapter/edited-volume/abs/pii/B978012809286600025X'
            },
            {text: 'WebMD — Parsley health benefits.', url: 'https://www.webmd.com/diet/health-benefits-parsley'},
            {
                text: 'ResearchGate — Comparative evaluation of diuretic activity of parsley.',
                url: 'https://www.researchgate.net/publication/331413321_Comparative_Evaluation_of_Diuretic_Activity_of_Ethanolic_Extracts_of_Celery_Apium_graveolens_and_Parsley_Petroselinum_crispum_in_Male_Rats'
            },
            {
                text: 'Azerbaijan Pharmaceutical Journal — Diuretic activity of Petroselinum crispum.',
                url: 'https://www.azpharmjournal.com/en/2024-volume-23-issue-1/assessment-of-the-diuretic-activity-of-petroselinum-crispum-aqueous-leaves-extract-in-wistar-rats/'
            },
            {
                text: 'WikiFarmer — Parsley uses and health benefits.',
                url: 'https://wikifarmer.com/library/en/article/parsley-uses-nutritional-value-and-health-benefits'
            },
        ],
    },
    ...
    'witch-hazel': {
        ...
        activeConstituents: [
            {
                name: 'Gallotannins (Hamamelitannin)',
                detail: 'Primary polyphenolic tannins mediating the astringent, protein-precipitating, and antibacterial actions.'
            },
            {
                name: 'Flavonoids (Procyanidins, Catechins, Flavonols)',
                detail: 'Anti-inflammatory and antioxidant flavonoid complex that downregulates pro-inflammatory cytokines and cellular exudates.'
            },
        ],
        moa: [
            {
                title: 'Protein Precipitation (Astringent Barrier)',
                detail: 'Tannins chemically bind and coagulate superficial dermal and mucosal proteins, creating a protective micro-barrier that contracts tissue, tightens pores, and controls weeping wounds.'
            },
            {
                title: 'Microvascular Vasoconstriction',
                detail: 'Reduces local blood flow to inflamed tissue, decreasing erythema, edema, and wound exudate.'
            },
            {
                title: 'Anti-inflammatory via Cytokine Downregulation',
                detail: 'Flavonoid and galloyl fractions downregulate pro-inflammatory cytokines, reducing redness and swelling in skin conditions.'
            },
            {
                title: 'Broad-Spectrum Antimicrobial',
                detail: 'Tannins exhibit activity against Gram-positive and Gram-negative bacteria, and inhibitory effects against enveloped viruses including Herpes simplex.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Topical Application',
                instruction: 'Clean area with mild soap and water. Saturate a cotton pad with witch hazel liquid and dab gently onto affected area. Do not scrub on broken skin.'
            },
            {
                method: 'Acne Toner',
                instruction: 'Apply with cotton pad after washing face to remove excess oil and purify pores. Use morning and evening.'
            },
        ],
        suitableAgeGroups: [
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Witch Hazel Distillate (Topical)',
                    dose: 'Apply to affected area up to 3–4 times daily as needed.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Commercial Witch Hazel Distillate / Extracts',
                    storage: 'Store in a cool, dark place at room temperature. Keep tightly sealed to prevent oxidation of tannins and evaporation of any alcohol content.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Dual Astringent & Antiseptic',
                desc: 'Tannins create a protective protein-barrier over wounds and pores, simultaneously tightening tissue and blocking bacterial colonization without harsh chemical irritation.'
            },
            {
                icon: 'water_drop',
                title: 'Vasoconstricting Anti-inflammatory',
                desc: 'Rapidly reduces local blood flow to inflamed tissue, visibly decreasing redness, swelling, and exudate in hemorrhoids, insect bites, and skin reactions.'
            },
            {
                icon: 'face',
                title: 'Acne & Oil Control',
                desc: 'Removes excess sebum and tightens dilated pores while its anti-inflammatory action reduces acne papule redness: without the drying harshness of alcohol-based chemical toners.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Wound Care Application',
                desc: 'Dampen a cotton pad with witch hazel distillate. Gently blot (do not scrub) the cleaned wound to remove bacteria and reduce minor bleeding.',
                bestFor: 'Minor cuts, scrapes, post-shave irritation'
            },
            {
                method: 'Acne Face Toner',
                desc: 'After cleansing, sweep a witch hazel-soaked cotton pad across the face (avoiding eyes). Allow to dry before moisturizing.',
                bestFor: 'Oily skin, acne, enlarged pores, blackheads'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'PubMed Central — Witch hazel pharmacology.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12250947'
            },
    ...
    'halfabar': {
        ...
        activeConstituents: [
            {
                name: 'Proximadiol (>75% of sesquiterpenoid fraction)',
                detail: 'Primary crystalline sesquiterpene diol; selective non-atropinic calcium channel blocker in ureteric walls: the pharmacological quality control marker.'
            },
            {
                name: 'Piperitone (60–85% of volatile oil)',
                detail: 'Dominant monoterpene ketone; renal vasodilator increasing GFR and hydraulic flushing pressure.'
            },
        ],
        moa: [
            {
                title: 'Ureteric Smooth Muscle Relaxation',
                detail: 'Proximadiol acts as a highly selective, non-atropinic calcium channel blocker within the ureteric walls. It induces deep relaxation and dilates the ureteric segment directly below an impacted stone site to expand the passage. Crucially, it achieves this without arresting upper ureteric propulsion, thereby preserving propulsive peristalsis.'
            },
            {
                title: 'Renal Vasodilation & Hydraulic Flushing',
                detail: 'Piperitone causes localized renal vasodilation, increasing Renal Blood Flow (RBF) and elevating the Glomerular Filtration Rate (GFR). This generates steady downstream hydraulic pressure that assists in pushing calculi forward.'
            },
            {
                title: 'Systemic Visceral Spasmolysis',
                detail: 'Extra-renally, both Piperitone and Proximadiol cross-react with smooth muscle voltage-gated calcium channels in the gastrointestinal and respiratory tracts, systematically reducing smooth muscle hyper-reactivity and relieving visceral spasms.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Herbal Decoction',
                instruction: 'Boil 5–10 g dried grass in 200–250 mL water for 10 minutes (covered). Strain, consume warm, 2–3× daily.'
            },
        ],
        suitableAgeGroups: [
            ...
            {
                group: 'Elderly (65+)',
                notes: 'Exceptionally safe: avoids systemic hypotension, tachycardia, dry mouth of synthetic anticholinergics.'
            },
        ...
        storage: {
            forms: [{
                form: 'Must be kept in airtight, moisture-proof containers to fully lock in the volatile\n' +
                    ...
                    'chemical reactions.',
                storage: 'Airtight, moisture-proof containers below 30°C in dark, dry environment.'
            }],
        },
        factsAndMyths: [
            {
                myth: 'Halfabar chemically liquefies and dissolves large, solid calcium stone structures into liquid form inside the kidney.',
                fact: 'It does not alter the size or chemical structure of the stone; instead, it dynamically widens the biological highway (the ureter) and maintains downstream peristaltic propulsion to allow the body to physically push the stone out safely.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'medical_services',
                title: 'Selective Ureteric Stone Expulsion',
                desc: 'Proximadiol uniquely relaxes the ureteric passage below a stone while preserving propulsive peristalsis above: creating a controlled biological highway for stone expulsion without systemic side effects.'
            },
            {
                icon: 'water_drop',
                title: 'Renal Hydraulic Flushing',
                desc: 'Piperitone-driven renal vasodilation increases GFR and generates downstream hydraulic pressure that pushes calculi forward while flushing the urinary tract.'
            },
            {
                icon: 'psychology',
                title: 'Elderly-Safe Antispasmodic',
                desc: 'Achieves ureteric muscle relaxation through selective calcium channel blockade without the anticholinergic side effects (hypotension, tachycardia, dry mouth) common with synthetic agents.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Halfabar Decoction',
                desc: 'Boil 5–10 g dried Halfabar grass in 200–250 mL water for 10 minutes in covered vessel. Strain, cool, consume warm. Take 2–3 times daily.',
                bestFor: 'Ureteric stone expulsion, renal colic relief, urinary stasis prevention'
            },
        ],
        relatedPlants: ['dandelion', 'cranberry', 'clove'],
        references: [
            {
                text: 'Egyptian Drug Authority — Cymbopogon proximus monograph.',
                url: 'https://edaegypt.gov.eg/media/s1gedchr/camel-grass-weed-tooth'
            },
            {text: 'PubMed Central — Halfabar pharmacology.', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12256221'},
            {
                text: 'ResearchGate — Cymbopogon proximus medicinal use.',
                url: 'https://www.researchgate.net/publication/393170950_Pharmacological_basis_for_medicinal_use_of_Cymbopogon_proximus'
            },
            {text: 'DOAJ — Halfabar research.', url: 'https://doaj.org/article/b361bfdea23843e5aad4b60a5e6066a3'},
            {
                text: 'Egyptian Drug Authority — Cymbopogon proximus full monograph.',
                url: 'https://dev.edaegypt.gov.eg/media/0jnppjtj/cymbopogon-proximus_1.pdf'
            },
        ],
    },
    ...
    'pygeum': {
        ...
        activeConstituents: [
            {
                name: 'β-sitosterol & Phytosterols',
                detail: 'Inhibit androgen binding to prostatic tissue and reduce pro-inflammatory eicosanoid synthesis.'
            },
            {
                name: 'Ursolic & Oleanolic Acid Triterpenes',
                detail: 'Anti-proliferative and anti-edematous; inhibit 5-LOX inflammatory pathway in prostate tissue.'
            },
            {
                name: 'Ferulic Acid Esters & Docosanol',
                detail: 'Reduce prolactin-stimulated testosterone uptake in prostate, lowering proliferative signals.'
            },
        ],
        moa: [
            {
                title: 'Growth Factor Inhibition (Anti-proliferative)',
                detail: 'Inhibits FGF and EGF-mediated prostatic hyperproliferation: addressing root cause of BPH rather than just symptoms.'
            },
            {
                title: '5-LOX Inhibition & Anti-edematous',
                detail: 'Reduces inflammatory prostaglandins and leukotrienes in prostatic tissue, decreasing glandular edema and urethral obstruction.'
            },
            {
                title: 'Aromatase Inhibition',
                detail: 'Reduces testosterone-to-estrogen conversion, decreasing age-related estrogenic contribution to prostate enlargement.'
            },
            {
                title: 'Bladder Detrusor Regulation',
                detail: 'Improves bladder muscle tone, enhancing urine stream and reducing post-void residual urine volume.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standardized Bark Extract (Capsules)',
                instruction: '50–100 mg daily, standardized to 12–14% phytosterols. Take with food. Often combined with Saw Palmetto for enhanced efficacy.'
            },
        ],
        suitableAgeGroups: [
        ...
        dosage: {
            ...
            forms: [{
                form: 'Standardized Bark Extract Capsules',
                dose: '50–100 mg/day standardized to 12–14% total phytosterols.'
            }],
        },
        overdose: {
        ...
        storage: {
            forms: [{
                form: 'Standardized Extract Capsules',
                storage: 'Cool, dry, dark place below 25°C in airtight containers.'
            }],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'medical_services',
                title: 'Growth Factor Anti-proliferative',
                desc: 'Uniquely targets BPH root cause by inhibiting FGF and EGF-mediated prostate growth signaling: complementing the DHT-blocking mechanism of Saw Palmetto.'
            },
            {
                icon: 'water_drop',
                title: 'Bladder Function Improvement',
                desc: 'Improves detrusor muscle tone, providing measurable increases in urinary stream and significant reduction in post-void residual urine volume.'
            },
            {
                icon: 'healing',
                title: 'Prostatic Anti-edematous',
                desc: '5-LOX inhibition and aromatase blockade reduce glandular edema and estrogenic contributions to prostate growth, addressing both inflammatory and hormonal BPH mechanisms.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Standardized Capsule',
                desc: 'Take 50–100 mg standardized bark extract (12–14% phytosterols) with a meal. Often combined with Saw Palmetto for synergistic BPH relief.',
                bestFor: 'BPH, LUTS, nocturia'
            },
        ],
        relatedPlants: ['saw-palmetto', 'stinging-nettle-root', 'stinging-nettle'],
        references: [
            {
                text: 'National Center for Complementary and Integrative Health — Pygeum.',
    ...
    'saw-palmetto': {
        ...
        activeConstituents: [
            {
                name: 'Lipidosterolic Fraction (85–95% of extract)',
                detail: 'Fatty acid complex (oleic, lauric, myristic, palmitic acids): primary 5-alpha reductase inhibitors.'
            },
            {
                name: 'β-sitosterol & Phytosterols',
                detail: 'DHT receptor antagonism and anti-inflammatory eicosanoid modulation.'
            },
        ],
        moa: [
            {
                title: 'Dual 5-Alpha Reductase Inhibition (Type 1 & 2)',
                detail: 'Blocks both isoforms converting testosterone to DHT (dihydrotestosterone), reducing intraprostatic DHT and growth stimulus.'
            },
            {
                title: 'DHT Receptor Antagonism',
                detail: 'Competes with DHT at androgen receptors in prostate cells, further reducing androgenic growth signaling.'
            },
            {
                title: 'COX/5-LOX Anti-inflammatory',
                detail: 'Reduces prostaglandin and leukotriene synthesis in prostatic tissue, decreasing inflammatory edema.'
            },
            {
                title: 'Alpha-1 Adrenergic Antagonism',
                detail: 'Relaxes smooth muscle in bladder neck and prostate stroma, improving urine flow: similar to synthetic alpha-blockers.'
            },
        ],
        uses: [
            'Symptomatic relief of mild-to-moderate BPH (LUTS Stages I–II)',
        ...
        howToUse: [
            {
                method: 'Standardized Lipidosterolic Extract (Capsules)',
                instruction: '320 mg daily standardized to 85–95% fatty acids and sterols. Take with food. Tea preparations are clinically ineffective.'
            },
        ],
        suitableAgeGroups: [
            {group: 'Adult Men (40+)', notes: 'Primary target population for mild-to-moderate BPH.'},
        ...
        dosage: {
            ...
            forms: [{
                form: 'Standardized Lipidosterolic Extract Capsules',
                dose: '320 mg/day. Tea/infusion preparations: clinically ineffective.'
            }],
        },
        overdose: {
        ...
        storage: {
            forms: [{
                form: 'Lipidosterolic Extract Capsules',
                storage: 'Cool, dry, dark environment below 25°C. Lipid fraction susceptible to oxidative rancidity: protect from heat and air.'
            }],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'medical_services',
                title: 'Dual 5-Alpha Reductase Inhibition',
                desc: 'Blocks BOTH Type 1 and Type 2 5-alpha reductase isoforms: more comprehensive DHT reduction than synthetic finasteride (Type 2 only), with significantly fewer sexual side effects.'
            },
            {
                icon: 'water_drop',
                title: 'Four-Pathway LUTS Relief',
                desc: 'Combines 5-alpha reductase inhibition, DHT receptor blockade, anti-inflammatory action, and alpha-1 adrenergic smooth muscle relaxation: addressing LUTS through 4 simultaneous mechanisms.'
            },
            {
                icon: 'science',
                title: 'Best-Evidenced Herbal BPH Agent',
                desc: 'The most extensively studied phytomedicine for BPH, with multiple RCTs demonstrating LUTS efficacy comparable to finasteride and alpha-blockers with superior tolerability.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Standardized Lipidosterolic Capsule',
                desc: 'Take one 320 mg standardized capsule with a meal for maximum fat-assisted absorption. Do not substitute with tea.',
                bestFor: 'BPH, LUTS, nocturia, urinary hesitancy'
            },
        ],
        relatedPlants: ['pygeum', 'stinging-nettle-root', 'stinging-nettle'],
        references: [
            {
                text: 'National Center for Complementary and Integrative Health — Saw Palmetto.',
            ...
            {
                text: 'European Medicines Agency — Serenoa repens herbal monograph.',
                url: 'https://www.ema.europa.eu/en/medicines/herbal/serenoa-repens'
            },
    ...
    'stinging-nettle-root': {
        ...
        activeConstituents: [
            {
                name: 'Lignans (Root-specific)',
                detail: 'Bind competitively to SHBG (Sex Hormone-Binding Globulin), blocking its interaction with prostatic cell membranes and preventing androgen receptor activation.'
            },
            {
                name: 'UDA Lectins (Urtica dioica Agglutinin)',
                detail: 'Bind EGF receptors on prostate cells, arresting hyperplastic tissue growth: a unique mechanism not shared by other herbal BPH agents.'
            },
            {
                name: 'β-sitosterol, Scopoletin, Coumarins',
                detail: 'Anti-inflammatory (COX-2, 5-LOX, NF-κB inhibition), antioxidant, and weak 5-alpha reductase inhibition.'
            },
        ],
        moa: [
            {
                title: 'SHBG Receptor Blockade (Hormonal Modulation)',
                detail: 'Lignans occupy SHBG receptors on prostatic cell membranes, preventing SHBG-androgen complexes from binding and blocking hormone-induced prostate growth.'
            },
            {
                title: 'EGF Receptor Blockade (Anti-proliferative)',
                detail: 'UDA lectins bind EGF receptors, arresting hyperplastic tissue growth signaling: a distinct mechanism from all other herbal BPH agents.'
            },
            {
                title: 'Weak 5-Alpha Reductase & Aromatase Inhibition',
                detail: 'Supplementary reduction in DHT and estrogenic contributions to prostate enlargement.'
            },
            {
                title: 'Anti-inflammatory (COX-2, 5-LOX, NF-κB)',
                detail: 'Reduces prostatic edema and urethral obstruction via suppression of inflammatory prostaglandins and cytokines.'
            },
        ],
        uses: [
            'Symptomatic relief of mild-to-moderate BPH (LUTS Stages I–II)',
        ...
        howToUse: [
            {
                method: 'Standardized Root Extract (Capsules)',
                instruction: '300–600 mg/day standardized to β-sitosterol or scopoletin. Clinical trials use 360 mg twice daily with food. Combine with Saw Palmetto for superior efficacy.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adult Men (40+)',
                notes: 'Primary therapeutic target. Synergy with Saw Palmetto strongly recommended.'
            },
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Standardized Dry Root Extract (Capsules)',
                    dose: '300–600 mg/day standardized to β-sitosterol or scopoletin.'
                },
        ...
        storage: {
            forms: [{
                form: 'Root Extract Capsules / Dried Root',
                storage: 'Tightly sealed, moisture-resistant, light-resistant containers below 25°C. Humidity causes mold and degrades active lectins.'
            }],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'science',
                title: 'Unique SHBG Receptor Blockade',
                desc: 'Root lignans competitively occupy SHBG receptors on prostatic cells, blocking the entire androgen-SHBG signaling cascade: a hormone-modulating mechanism unique among herbal BPH agents.'
            },
            {
                icon: 'medical_services',
                title: 'EGF-Mediated Anti-proliferative',
                desc: 'UDA lectins bind and block EGF receptors on prostate cells, halting hyperplastic growth at the cell proliferation level: not shared by Saw Palmetto or Pygeum.'
            },
            {
                icon: 'shield',
                title: 'Superior Combination Therapy',
                desc: 'Multiple clinical trials show Urtica root + Serenoa repens produces LUTS resolution matching synthetic 5-alpha reductase inhibitors with significantly lower incidence of sexual side effects.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Standardized Root Capsule (+ Saw Palmetto)',
                desc: 'Take 300–600 mg standardized root extract with food. For optimal BPH efficacy, combine with 320 mg Saw Palmetto lipidosterolic extract. Allow 4–6 weeks for clinical response.',
                bestFor: 'BPH, LUTS, nocturia, urinary hesitancy'
            },
        ],
        ...
        references: [
            {
                text: 'National Center for Complementary and Integrative Health — Stinging Nettle.',
                url: 'https://www.nccih.nih.gov'
            },
            {
                text: 'Mount Sinai — Stinging Nettle.',
    ...
    'cranberry': {
        ...
        activeConstituents: [
            {
                name: 'A-type Proanthocyanidins (PACs)',
                detail: 'Unique structural A-type linkage (vs. B-type in other berries) prevents P-fimbriated E. coli from adhering to uroepithelial cell surfaces: the primary anti-adhesion mechanism.'
            },
            {
                name: 'Anthocyanins (Cyanidins), Flavonols (Quercetin, Myricetin)',
                detail: 'Antioxidant and anti-inflammatory polyphenols supporting systemic urinary and vascular health.'
            },
            {
                name: 'Benzoic Acid, Vitamin C',
                detail: 'Urinary acidification (benzoic acid → hippuric acid) and antioxidant immune support.'
            },
        ],
        moa: [
            {
                title: 'Bacterial Anti-adhesion (PAC-mediated)',
                detail: 'A-type PACs structurally prevent P-fimbriated E. coli from attaching to uroepithelial receptors, thereby inhibiting bacterial adhesion and reducing UTI risk'
            },
            {
                title: 'Antioxidant & Anti-inflammatory Support',
                detail: 'Polyphenols reduce oxidative stress in the urinary epithelium and suppress pro-inflammatory cytokines.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standardized PAC Capsules',
                instruction: '36 mg PAC (proanthocyanidins) daily: the clinically validated dose. Take with ample water. Preferred over juice for consistent dosing.'
            },
            {
                method: 'Unsweetened Cranberry Juice',
                instruction: '240–300 mL daily of pure unsweetened cranberry juice (not cocktail/sweetened: insufficient PAC content). Sweeten with honey if needed.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults (including pregnant women)',
                notes: 'Safe at standard doses for UTI prophylaxis during pregnancy.'
            },
        ...
        storage: {
            forms: [
                {
                    form: 'Store in a cool, dry place away from direct sunlight. Refrigerate juice after opening',
                    storage: 'Capsules: cool, dry, dark place below 25°C. Juice: refrigerate after opening; consume within 7–10 days.'
                },
            ],
        },
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'shield',
                title: 'Proven UTI Anti-adhesion',
                desc: 'A-type PACs structurally block the fimbriae of P-fimbriated E. coli from binding to uroepithelial cells: preventing the critical first step of UTI establishment without antibiotic resistance.'
            },
            {
                icon: 'pregnant_woman',
                title: 'Pregnancy-Safe UTI Prevention',
                desc: 'One of the few UTI-preventive agents deemed safe throughout pregnancy, offering antibiotic-sparing protection for expectant mothers prone to gestational UTIs.'
            },
            {
                icon: 'science',
                title: 'Prophylactic: Not Antibiotic',
                desc: 'Prevents bacterial adhesion rather than killing bacteria: does not disrupt the microbiome, does not cause antibiotic resistance, and does not impair beneficial flora.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Daily UTI Prevention Capsule',
                desc: 'Take one standardized cranberry capsule (36 mg PAC) with a full glass of water each morning. May be used for recurrent UTI prevention.',
                bestFor: 'Recurrent UTI prevention, pregnancy urinary health'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'PubMed Central — Cranberry and UTI prevention.',
                url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3924191'
            },
            {text: 'WebMD — Cranberry Supplement Guide.', url: 'https://www.webmd.com/diet/supplement-guide-cranberry'},
        ],
    ...
    'thyme': {
        ...
        activeConstituents: [
            {
                name: 'Phenolic Volatile Essential Oils (1.0% to 2.5%)',
                detail: 'Driven primarily by the volatile markers Thymol (30%–70%) and Carvacrol (3%–15%). These are robust, legally recognized natural antiseptics possessing intensive antibacterial and antifungal profiles.'
            },
            {
                name: 'Flavonoids',
                detail: 'Highly rich in polymethoxyflavones, including Luteolin, Apigenin, Thymonin, and Eriodictyol, which act as potent localized bronchodilators.'
            },
            {
                name: 'Rosmarinic Acid',
                detail: 'A specialized polyphenolic carboxylic acid that exhibits excellent cellular antioxidant, anti-inflammatory, and free-radical scavenging activities.'
            },
            {
                name: 'Saponins',
                detail: 'Minor triterpenoid saponins that assist significantly in the physical expectoration process by thinning systemic mucus matrices.'
            },
        ],
        moa: [
            {
                title: 'Spasmolytic & Bronchodilatory Pathway',
                detail: 'The flavonoids and volatile phenols competitively block voltage-dependent calcium channels and interact with beta-2 adrenergic receptors on the bronchial smooth muscles, inducing relaxation and suppressing spasmic coughing fits.'
            },
            {
                title: 'Secretomotoric & Mucolytic Action',
                detail: 'Thyme saponins and essential oils stimulate ciliary movement in the bronchial tree and chemically thin tenacious mucus, reducing its elasticity and accelerating expectoration.'
            },
            {
                title: 'Direct Antiseptic Action',
                detail: 'Thymol and carvacrol topically disrupt bacterial cellular membranes via lipophilic interactions, reducing the microbial load in the upper respiratory tract.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Preparation',
                instruction: 'Steep 1–2 teaspoons of dried thyme herb in 1 cup of boiling water for 10 minutes in a covered vessel to capture volatile components, filter carefully, and consume warm.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Children',
                notes: 'Only administered in small, calculated pediatric doses (via approved pharmaceutical syrups); raw essential oil is contraindicated.'
            },
            {
                group: 'Pregnant and Lactating Women',
                notes: 'Highly safe in normal culinary or dietary amounts; medicinal doses and concentrated extracts should be avoided due to uterine-stimulating potential.'
            },
        ...
        storage: {
            forms: [{
                form: 'Keep stored in a cool, structurally dry place, carefully isolated from light, humidity, and atmospheric air exposure.',
                instructions: ''
            }]
        },
        marketedProducts: [
        ...
        factsAndMyths: [
            {
                myth: 'Thyme extract can completely replace prescription synthetic antibiotics for severe bacterial lung abscesses.',
                fact: 'Thyme provides exceptional, clinically proven symptom management for bronchitis and coughing, but severe, invasive deep pulmonary infections strictly require clinical systemic antibiotics.'
            },
        ],
        botanicalFacts: {
            family: 'Lamiaceae (Labiatae)',
    ...
    'anise': {
        ...
        activeConstituents: [
            {
                name: 'Volatile Essential Oils (2% to 6%)',
                detail: 'The predominant active marker is trans-Anethole (accounting for 80%–90% of the total volatile oil composition). Secondary components include estragole (methyl chavicol), anise aldehyde, and pseudoisoeugenyl 2-methylbutyrate.'
            },
            {
                name: 'Flavonoids',
                detail: 'Rich in flavonol glycosides, primarily Quercitrin, Rutin, Isoquercitrin, and Luteolin, providing secondary cellular antioxidant and tissue-soothing support.'
            },
            {
                name: 'Coumarins',
                detail: 'Minor concentrations of Umbelliferone and scopoletin, which contribute to overall localized anti-inflammatory mechanisms.'
            },
            {
                name: 'Phenylpropanoids',
                detail: 'Organic compounds that structurally drive the characteristic flavor profile and physiological antispasmodic capabilities.'
            },
        ],
        moa: [
            {
                title: 'Expectorant & Secretolytic Pathway',
                detail: 'trans-Anethole stimulates the secretory activity of the ciliated epithelial cells of the respiratory tract, increasing the volume and reducing the viscosity of bronchial secretions, which facilitates effective mucociliary clearance.'
            },
            {
                title: 'Antispasmodic & Bronchial Relaxation',
                detail: 'Anise volatile oils act as a localized smooth muscle relaxant within the trachea and bronchi, counteracting spasmogens and relieving involuntary coughing fits.'
            },
            {
                title: 'Demulcent Effect',
                detail: 'The volatile and aqueous components exert a soothing effect on the mucosal lining, reducing the sensitivity of peripheral cough receptors in the throat.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Preparation',
                instruction: 'Steep 1 teaspoon of bruised anise seeds in 1 cup of boiling water for 10 minutes in a covered vessel (to prevent the loss of therapeutic volatile oils), strain completely, and consume warm.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Children',
                notes: 'Safe in small, traditional dietary amounts under adult supervision; avoid pure concentrated oils.'
            },
            {
                group: 'Pregnant and Lactating Women',
                notes: 'Use with extreme caution; avoid high medicinal doses due to potential estrogenic activity of anethole.'
            },
        ...
        storage: {
            forms: [{
                form: 'Store seeds in tightly sealed, airtight containers in a cool, dry environment away from ambient humidity and structural heat.',
                instructions: ''
            }]
        },
        marketedProducts: [
        ...
        factsAndMyths: [
            {
                myth: 'Drinking more aniseed infusion will immediately cure and treat severe bacterial pneumonia.',
                fact: 'Anise is a symptomatic, secretolytic phytotherapy that relieves coughing and loosens mucus, but it possesses no definitive systemic antibiotic power to eradicate deep bacterial pulmonary infections.'
            },
        ],
        botanicalFacts: {
            family: 'Apiaceae (Umbelliferae)',
    ...
    'pelargonium': {
        ...
        activeConstituents: [
            {
                name: 'Umckalin, various coumarins (e.g., 7-hydroxycoumarin derivatives), and oligomeric proanthocyanidins (tannins)',
                detail: 'Exhibits a dual anti-infective and immunomodulatory effect.'
            },
        ],
        moa: [
            {
                title: 'Immunomodulatory',
                detail: 'Stimulates non-specific immune mechanisms (increasing macrophage activation, Nitric Oxide, and Interferon-beta production) and enhances natural killer (NK) cell activity.'
            },
            {
                title: 'Anti-adhesive',
                detail: 'Exerts anti-adhesive activity preventing bacteria (such as Streptococcus) from adhering to host epithelial cells.'
            },
        ],
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Pediatrics',
                notes: 'Not recommended for children under 6 years of age due to the lack of adequate safety and efficacy data.'
            },
    ...
    'black-elderberry': {
        ...
        moa: [
            {
                title: 'Antiviral (Blocking Sialic Acid Receptors)',
                detail: 'The polyphenols and lectins exhibit antiviral properties by binding to viral surface proteins (blocking sialic acid receptors), thereby inhibiting viral entry and replication within host mucosal cells.'
            },
            {
                title: 'Anti-inflammatory',
                detail: 'Downregulates pro-inflammatory cytokines, reducing mucous membrane swelling.'
            },
        ],
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Pediatrics',
                notes: 'Widely utilized in commercial pediatric syrups for children over 2–6 years old.'
            },
            {group: 'Pregnancy & Lactation', notes: 'Not recommended due to a lack of robust clinical safety data.'},
            {
                group: 'Chronic Diseases',
                notes: 'Use with caution in patients with systemic autoimmune diseases (e.g., Lupus, RA) due to the plant\'s potent immunostimulatory properties.'
            },
        ],
    ...
    'guava': {
        ...
        activeConstituents: [
            {
                name: 'Flavonoids (Primary Markers)',
                detail: 'Highly concentrated in Quercetin and its glycosides (such as avicularin and guajaverin), which are responsible for the documented anti-inflammatory, antioxidant, and antimicrobial actions.'
            },
            {
                name: 'Tannins & Polyphenols',
                detail: 'High concentration of condensed and hydrolyzable tannins (such as pedunculagin, casuarinin, and stachyurin) providing an astringent effect that precipitates surface proteins, helping to reduce fluid and mucus secretions in the respiratory tract.'
            },
            {
                name: 'Volatile Essential Oils (0.1% to 0.4%)',
                detail: 'Composed primarily of sesquiterpene hydrocarbons, chiefly Caryophyllene, Limonene, and alpha-pinene, which contribute to its aromatic qualities and antiseptic properties.'
            },
            {
                name: 'Vitamins & Nutrient Co-factors',
                detail: 'Rich in Vitamin C (Ascorbic acid) and Vitamin A, which synergistically support immune function during acute respiratory infections.'
            },
        ],
        moa: [
            {
                title: 'Anti-inflammatory Pathway',
                detail: 'Quercetin and other flavonoids directly inhibit inflammatory mediators by suppressing cyclooxygenase (COX) enzymes and lipoxygenase (LOX) pathways, thereby decreasing the synthesis of pro-inflammatory cytokines in the respiratory tract.'
            },
            {
                title: 'Astringent & Mucus Regulation',
                detail: 'Tannins exert a localized astringent action on the mucosal lining of the pharynx, forming a protective complex layer over irritated tissue, which effectively minimizes further fluid exudation, reduces respiratory irritation, and tightens swollen tissues.'
            },
            {
                title: 'Antimicrobial Activity',
                detail: 'Volatile components disrupt microbial cellular membranes, providing secondary antiseptic benefits against opportunistic upper respiratory tract pathogens.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Preparation',
                instruction: 'Boil 5–7 fresh or dried leaves in 1 cup (approx. 200 mL) of water for 10 minutes, strain thoroughly, and drink warm. Natural honey may be added to enhance the demulcent effect.'
            },
        ],
        suitableAgeGroups: [
        ...
        storage: {
            forms: [{
                form: 'Store in a cool, dry place, strictly protected from direct sunlight, moisture, and microbial contamination.',
                instructions: ''
            }]
        },
        marketedProducts: [
        ...
        factsAndMyths: [
            {
                myth: 'Guava leaves can fully cure chronic respiratory diseases like asthma or COPD instantly.',
                fact: 'Guava leaves act purely as an evidence-based supportive phytotherapy that relieves acute symptoms (such as coughing and throat soreness) but cannot replace primary clinical treatments or inhalers for chronic pulmonary disorders.'
            },
        ],
        botanicalFacts: {
            family: 'Myrtaceae',
    ...
    'licorice-cough': {
        ...
        activeConstituents: [
            {
                name: 'Triterpene Saponins (Primary Marker)',
                detail: 'Driven directly by Glycyrrhizin (Glycyrrhizic acid, occurring as potassium and calcium salts). It is approximately 30–50 times sweeter than sucrose and possesses a chemical configuration structurally mimicking corticosteroids, which mediates its anti-inflammatory properties.'
            },
            {
                name: 'Flavonoids & Chalcones',
                detail: 'Rich in Liquiritin, Isoliquiritigenin, and liquiritigenin, which provide robust systemic antioxidant defense, ease smooth muscle spasms, and soothe mucous membranes.'
            },
            {
                name: 'Phytosterols',
                detail: 'Contains beta-sitosterol and stigmasterol, assisting in cellular defense modulation.'
            },
            {
                name: 'Polysaccharides',
                detail: 'High-molecular-weight glycan structures that bolster localized mucosal cell integrity and aid immunological defenses against viral threats.'
            },
        ],
        moa: [
            {
                title: 'Demulcent & Soothing Action',
                detail: 'Glycyrrhizin and mucosal-binding polysaccharides physically coat the inflamed epithelial tissues of the pharynx, shielding peripheral cough receptors from local irritation and reducing dry tickling coughs.'
            },
            {
                title: 'Expectorant Effect',
                detail: 'Glycyrrhizin and associated saponins reduce surface tension and stimulate tracheal mucus membrane secretions, effectively liquefying thick mucus plugs for productive clearance.'
            },
            {
                title: 'Corticosteroid-like Anti-inflammatory Pathway',
                detail: 'Glycyrrhizin inhibits the enzyme 11-beta-hydroxysteroid dehydrogenase (Type 1 & 2), leading to sustained local concentrations of endogenous cortisol, which reduces cellular inflammation and swelling within the respiratory mucosal structures.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Preparation',
                instruction: 'Steep 1 teaspoon (approx. 2–4 grams) of dried, crushed licorice root in 1 cup of boiling water for 10–15 minutes, filter completely, and drink warm.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Children',
                notes: 'Use only under strict medical supervision and in small, controlled traditional amounts.'
            },
            {
                group: 'Pregnant Women',
                notes: 'Strictly Contraindicated due to risks of uterine contractions and potential adverse embryofetal outcomes linked to glycyrrhizin.'
            },
            {
                group: 'Elderly',
                notes: 'Use with extreme clinical caution; highly restricted in patients with underlying cardiovascular conditions.'
            },
        ],
        dosage: {
        ...
        storage: {
            forms: [{
                form: 'Storage',
                instructions: 'Store raw crushed roots in a tightly sealed container, strictly protected from moisture, ambient humidity, and insect infestation.'
            }]
        },
        marketedProducts: [
        ...
        benefits: [],
        factsAndMyths: [{
            fact: 'Licorice root contains highly potent, steroid-like active ingredients (Glycyrrhizin). Chronic or high-volume intake can induce dangerous clinical pseudoaldosteronism, manifesting as severe hypertension and critically low potassium levels.',
            myth: 'Licorice root is completely safe without restrictions because it is 100% natural.'
        }],
        botanicalFacts: {
            family: 'Fabaceae (Leguminosae)',
    ...
    'aloe-vera-hair': {
        ...
        activeConstituents: [
            {
                ...
                detail: 'May assist in the safe removal of excess dead skin cells from the stratum corneum of the scalp surface.'
            },
            {
                name: 'Polysaccharides',
                detail: 'Chiefly Glucomannans and Acemannan, which provide deep hydration, humectant effects, and mucosal/cutaneous soothing properties.'
            },
            {
                name: 'Amino Acids',
                detail: 'A comprehensive profile of essential and non-essential amino acids contributing to hair conditioning and structural support.'
            },
            {
                name: 'Vitamins',
                detail: 'Vitamin A (Beta-carotene), Vitamin C, and Vitamin E acting as localized antioxidants, alongside crucial B-complex vitamins.'
            },
            {
                name: 'Minerals',
                detail: 'Significant trace elements including Zinc and Copper that support normal hair fiber synthesis and cellular integrity.'
            },
            {
                name: 'Anthraquinones',
                detail: 'Aloin and Emodin, localized primarily in the bundle sheath cells, contributing to documented antimicrobial and anti-inflammatory properties.'
            },
        ],
        moa: [
            {
                title: 'Mechanism of Action',
                detail: 'Aloe Vera acts fundamentally as an intensive soothing, anti-inflammatory, and moisturizing agent for the scalp tissue. Its high polysaccharide content forms a protective hydrogel barrier that optimizes skin hydration and counters localized dryness. Concurrently, the presence of specific proteolytic enzymes assists in gently clearing cellular debris and excessive sebum buildup from follicular openings. This synergy ensures a well-balanced, non-irritated scalp microenvironment necessary to maintain physiological hair conditioning, reduce pruritus, and minimize scaling.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standard Scientific Extraction',
                instruction: 'Cold stabilization and expression of the inner parenchymal gel layer to strictly preserve the bioactive high-molecular-weight polysaccharides and thermolabile enzymes.'
            },
            {
                method: 'Home-made Formulations (Fresh Aloe Gel Mask)',
                instruction: 'Excision of a mature, healthy leaf followed by a mandatory drainage period to completely eliminate the anthraquinone-rich yellow latex sap. The clear inner mucilaginous gel is then surgically extracted, homogenized utilizing clean equipment, applied evenly to the scalp and hair for 30 minutes, and completely rinsed with lukewarm water.'
            },
        ],
        suitableAgeGroups: [
            ...
            {
                group: 'Pregnancy & Lactation',
                notes: 'Deemed safe for topical/cosmetic application; systemic exposure is negligible.'
            },
            {
                group: 'Frequency',
                notes: 'Topically applied as a scalp mask or leave-on conditioner 2 to 3 times per week.'
            },
        ],
        overdose: {
            symptoms: [
        ...
        storage: {
            forms: [
                {
                    form: 'Fresh Parenchymal Gel',
                    instructions: 'Must be stored in airtight containers under refrigeration (2–8°C) and utilized within 48–72 hours to prevent microbial contamination and oxidative degradation.'
                },
                {
                    form: 'Commercial Formulations',
                    instructions: 'Store at controlled room temperature away from direct solar radiation and moisture.'
                },
            ],
        },
        marketedProducts: [
            {name: 'ALOE EVA ALOE VERA HAIR OIL (170 mL)', image: ''},
            {name: 'ALOE EVA HAIR MASK WITH ALOE VERA (250 g)', image: ''},
        ],
        benefits: [],
        factsAndMyths: [
            {
    ...
    'rosemary-hair': {
        ...
        activeConstituents: [
            {
                name: 'Bioactive Diterpenes',
                detail: 'Phenolic diterpenes, primarily Carnosic Acid and Carnosol, demonstrating powerful lipid antioxidant capacities.'
            },
            {
                name: 'Phenolic Carboxylic Acids',
                detail: 'Rosmarinic Acid and Caffeic Acid, providing validated anti-inflammatory and free-radical scavenging profiles.'
            },
            {
                name: 'Volatile Essential Oils (Aetheroleum)',
                detail: 'Highly concentrated fractions of 1,8-Cineole (Eucalyptol), Camphor, and Alpha-Pinene, responsible for counter-irritant, antimicrobial, and hyperemic actions.'
            },
        ...
        moa: [
            {
                title: 'Mechanism of Action',
                detail: 'Salvia rosmarinus exerts therapeutic actions on the hair apparatus via distinct biochemical pathways. Primarily, carnosic acid and rosmarinic acid mitigate oxidative damage within the follicular microenvironment, downregulating inflammatory cascades that accelerate follicular involution. Furthermore, the monoterpenes present in the volatile oil induce local vasodilation, enhancing microvascular blood flow to the dermal papilla. While selective in-vitro or pre-clinical models hint at subtle interactions with androgenic pathways, robust clinical trials have never established true, direct in-vivo inhibition of 5-alpha-reductase or competitive binding to androgen receptors in human scalps. Its clinical efficacy in pattern hair loss is driven by microvascular enhancement and tissue-protective antioxidant support, serving as an adjunct co-therapy rather than a direct hormonal block.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Standard Scientific Isolation',
                instruction: 'Industrial-scale steam distillation of fresh leaves and flowering tops to isolate the pure, concentrated European Pharmacopoeia-grade Essential Oil (Rosmarini aetheroleum).'
            },
            {
                method: 'Aqueous Infusion Rinse (Rosemary Water)',
                instruction: 'Steep 2–3 fresh green sprigs in boiling water (removed from active heat source) for 3–5 hours within a tightly sealed container to prevent the volatilization of active monoterpenes. Filter with sterile materials into a clean spray flask.'
            },
            {
                method: 'Infused Carrier Oil',
                instruction: 'Combine 1 cup of thoroughly dried rosemary leaves with a stable carrier lipid matrix (e.g., Jojoba or Olive Oil). Heat gently utilizing a water-bath double boiler setup for 2 hours, filter perfectly, and store.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Adults',
                notes: 'Indicated for regular topical use when essential oils are accurately diluted in appropriate vehicle bases.'
            },
            {
                group: 'Children',
                notes: 'Highly restricted. Avoid all concentrated essential oils on infants or young pediatric patients. Mild aqueous rinses may be utilized with high caution.'
            },
            {
                group: 'Pregnancy',
                notes: 'Pure concentrated essential oils are completely avoided due to trace systemic absorption risks of camphor; mild aqueous infusions should only be utilized after direct medical clearance.'
            },
            {
                group: 'Posology',
                notes: '5–10 sprays of the aqueous infusion applied directly onto the scalp 1–2 times daily as a leave-on routine. Infused oils are massaged 1–2 times per week as a pre-shampoo treatment.'
            },
        ],
        overdose: {
            symptoms: [
        ...
        storage: {
            forms: [
                {
                    form: 'Aqueous Infusion (Rosemary Water)',
                    instructions: 'Critically unstable. Because homemade water extractions completely lack anti-microbial preservative systems, they must be continuously stored under refrigeration (2–8°C) and discarded after a maximum of 7 calendar days to prevent heavy bacterial or fungal colonization.'
                },
                {
                    form: 'Essential / Infused Oils',
                    instructions: 'Safely stored in dark amber glass vessels, completely sealed away from ambient light and thermal fluctuations.'
                },
            ],
        },
        marketedProducts: [
            {name: 'ROOTAGE HAIR OIL (100 mL)', image: '/images/Rootage Hair Oil.webp'},
            {name: 'ROSEMARY HAIR BOOSTER OIL (50 mL)', image: '/images/Rosemary Hair Booster Oil.jpeg'},
        ],
        benefits: [],
        factsAndMyths: [
    ...
    'fennel-diarrhea': {
        ...
        activeConstituents: [
            {
                name: 'Trans-Anethole (50–80% of volatile oil)',
                detail: 'Primary active principle responsible for the characteristic sweet, anise-like aroma; exhibits potent antispasmodic, anti-inflammatory, and secretolytic properties.'
            },
            {
                name: 'Fenchone (5–20%)',
                detail: 'Monoterpene ketone providing the bitter flavor profile; contributes to antimicrobial, counter-irritant, and secretolytic effects.'
            },
            {
                name: 'Estragole / Methyl chavicol (2–10%)',
                detail: 'Phenylpropene derivative providing secondary cellular effects; minimized in selected medical chemotypes due to safety monitoring.'
            },
            {
                name: 'Phenolic Derivatives & Flavonoids (Quercetin, Rutin, Kaempferol)',
                detail: 'Rich in quercetin, rutin, and kaempferol derivatives alongside chlorogenic and rosmarinic acids, providing robust cellular antioxidant support and maintaining GI mucosal integrity.'
            },
            {
                name: 'Fixed Oils & Phytosterols',
                detail: 'Contain essential fatty acids (petroselinic and oleic acids) and phytosterols contributing to the regulation of smooth muscle tone.'
            },
        ],
        moa: [
            {
                title: 'Antispasmodic & Carminative Action',
                detail: 'Trans-anethole and fenchone exert a direct relaxant effect on GI smooth muscle cells by modulating intracellular calcium stores and acting as a weak antagonist to voltage-dependent calcium channels. This mitigates intestinal spasms, reduces intraluminal pressure, and facilitates gas expulsion (carminative effect).'
            },
            {
                title: 'Anti-inflammatory & Mucosal Protective Effect',
                detail: 'Suppresses pro-inflammatory mediators and cascades, reducing mucosal irritation and abdominal cramping during acute gastrointestinal distress.'
            },
            {
                title: 'Antioxidant Effect',
                detail: 'Directly scavenges reactive oxygen species (ROS), including superoxide and hydroxyl free radicals, while protecting cellular membranes within the mucosal linings from oxidative stress.'
            },
            {
                title: 'Secretolytic, Secretomotor & Antitussive Action',
                detail: 'In the respiratory tract, the volatile fractions stimulate ciliary activity and increase bronchial secretions, thinning mucus and aiding in the management of non-productive, spasmodic coughs.'
            },
            {
                title: 'Antimicrobial Action',
                detail: 'Demonstrates notable in vitro bacteriostatic and antifungal actions against common secondary pathogens.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Fennel Tea)',
                instruction: 'Steep 1.5–2.5 g of freshly crushed or bruised seeds in 150–200 mL of boiling water in a covered vessel for 10–15 minutes (to prevent the loss of volatile essential oils). Take 2–3 times daily.'
            },
            {
                method: 'Crude Dried Powder',
                instruction: '1–3 g daily, administered in divided doses mixed with warm water or food.'
            },
            {
                method: 'Standardized Oral Capsules / Extracts',
                instruction: '200–400 mg taken 2–3 times per day, typically standardized to volatile oil content (under medical guidance).'
            },
        ],
        suitableAgeGroups: [
            {group: 'Adults & Adolescents', notes: 'Safe at standard therapeutic doses.'},
            {
                group: 'Pediatrics (<4 years)',
                notes: 'Pure fennel essential oil Strictly Contraindicated due to risk of respiratory depression. Mild aqueous infusions (tea) for colic must be used with caution, under medical supervision, and within short durations to minimize estragole exposure.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Concentrated extracts, purifications, and pure essential oils are Strictly Contraindicated due to traditional emmenagogue properties and high estragole content. Safe during lactation only at standard culinary doses or under strict professional supervision in standardized formulations.'
            },
            {
                group: 'Geriatrics & Hormone-Sensitive Conditions',
                notes: 'Use with extreme caution or avoid in patients with a history of estrogen-dependent conditions (e.g., breast, ovarian, or uterine malignancies) due to mild phytoestrogenic profile. High risk of cross-reactivity in individuals allergic to other Apiaceae family members.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Fennel Tea',
                    dose: '1.5–2.5 g freshly crushed seeds steeped 10–15 min in 150–200 mL boiling water (covered). 2–3× daily.'
                },
                {form: 'Crude Dried Powder', dose: '1–3 g daily in divided doses mixed with warm water or food.'},
                {
                    form: 'Standardized Capsules/Extracts',
                    dose: '200–400 mg 2–3× daily, standardized to volatile oil content. Under medical guidance.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Dry Seeds / Powder / Capsules',
                    storage: 'Store in tightly sealed, light-resistant containers below 25°C in a dry environment to avoid moisture absorption and rapid volatilization of active trans-anethole.'
                },
                {
                    form: 'Fennel Essential Oil',
                    storage: 'Keep tightly closed in amber glass bottles away from direct light and heat sources.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Fennel can completely replace medical rehydration therapies and oral antibiotics to stop severe infectious diarrhea.',
                fact: 'Fennel does not stop diarrhea directly nor eradicate severe bacterial pathogens in vivo; rather, it acts as an exceptional supportive phytotherapy that significantly reduces the painful intestinal spasms, cramping, and bloating while primary medical rehydration and targeted therapies are established.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'air',
                title: 'Carminative Gas Relief',
                desc: 'Trans-anethole relaxes GI smooth muscle and reduces intraluminal pressure, facilitating rapid expulsion of trapped gas and relieving painful bloating and flatulence.'
            },
            {
                icon: 'spa',
                title: 'Antispasmodic for Diarrhea Cramps',
                desc: 'Calcium channel modulation relieves spasmodic abdominal pain during acute diarrheal episodes without arresting normal bowel elimination.'
            },
            {
                icon: 'child_care',
                title: 'Safe Infant Colic Relief',
                desc: 'Standardized mild fennel infusions have clinical evidence for safely reducing infantile colic through GI smooth muscle relaxation.'
            },
            {
                icon: 'healing',
                title: 'Mucosal Protection',
                desc: 'Quercetin and rosmarinic acid provide antioxidant and anti-inflammatory protection to the GI mucosa during acute digestive distress.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Fennel Seed Tea',
                desc: 'Lightly crush 1.5–2.5 g fennel seeds and steep in 150–200 mL boiling water in a covered vessel for 10–15 minutes. Drink warm 2–3× daily.',
                bestFor: 'Diarrhea-associated cramps, flatulence, bloating, infantile colic'
            },
        ],
        ...
        references: [
            ...
            {
                text: 'National Center for Complementary and Integrative Health (NCCIH) — Fennel.',
                url: 'https://www.nccih.nih.gov'
            },
    ...
    'peppermint-dyspepsia': {
        ...
        activeConstituents: [
            {
                name: 'Menthol (30–55%)',
                percentage: '30–55% of volatile oil',
                effect: 'Major monoterpene alcohol responsible for cooling sensation, local analgesic properties, and dominant smooth muscle relaxant activities'
            },
            {
                name: 'Menthone (14–32%)',
                percentage: '14–32%',
                effect: 'Monoterpene ketone structurally related to menthol providing secondary carminative actions'
            },
            {
                name: 'Menthofuran (1–10%) & Isomenthone',
                percentage: '1–10%',
                effect: 'Trace compounds essential for species identification; excessive menthofuran indicates lower pharmaceutical grade or aging'
            },
            {
                name: '1,8-Cineole (Eucalyptol) & Limonene',
                percentage: '',
                effect: 'Supplemental secretolytic, respiratory decongestant, and antiseptic mechanisms'
            },
            {
                name: 'Rosmarinic Acid',
                percentage: '',
                effect: 'Prominent phenolic carboxylic acid displaying profound systemic antioxidant, antiviral, and tissue-protective actions'
            },
            {
                name: 'Luteolin, Eriocitrin & Hesperidin',
                percentage: '',
                effect: 'Flavonoid glycosides providing systemic free-radical scavenging and complementary gastrointestinal spasmolysis'
            },
        ],
        moa: [
            {
                title: 'Direct Smooth Muscle Spasmolysis',
                detail: 'Menthol acts as a direct local blocker of L-type voltage-gated calcium channels in intestinal smooth muscle. By inhibiting calcium influx across the sarcolemma, it reduces the amplitude and frequency of gastrointestinal contractions, safely mitigating painful visceral spasms and localized hyper-motility.'
            },
            {
                title: 'Cooling, Decongestant & Local Analgesic Action',
            ...
            {
                title: 'Carminative & Choleretic Actions',
                detail: 'Relaxes the lower esophageal sphincter, permitting trapped gas to be expelled effortlessly. Concurrently, it stimulates hepatic bile secretion, facilitating effective fat digestion and reducing functional postprandial dyspepsia.'
            },
            {
                title: 'Antimicrobial Properties',
                detail: 'The lipophilic terpenes disrupt bacterial cell membranes, showing bacteriostatic actions against common intestinal and upper respiratory pathogens.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Peppermint Tea)',
                instruction: 'Infuse 1.5 to 3.0 g of dried leaves in 150–200 mL of boiling water in a tightly closed vessel for 10 minutes. Taken 3 times daily between or after meals.'
            },
            {
                method: 'Enteric-Coated Essential Oil Capsules',
                instruction: '0.2 mL to 0.4 mL of standardized essential oil per capsule, 2 to 3 times daily. Enteric coating is mandatory to prevent the oil from releasing prematurely in the stomach, which can cause heartburn.'
            },
            {
                method: 'Topical Liquid Formulations',
                instruction: '10% menthol or peppermint oil dissolved in ethanol, rubbed gently over temples for headaches, or applied over unbroken skin for local muscle pain.'
            },
            {
                method: 'Steam Inhalation',
                instruction: '3 to 4 drops of pure oil placed into hot water for inhalation to clear respiratory pathways.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Safe at normal dietary tea intakes (1–2 cups daily). Large therapeutic doses or pure essential oils are contraindicated due to risk of emmenagogue effects. Peppermint can slightly reduce breast milk supply when taken in massive quantities over extended periods.'
            },
            {
                group: 'Pediatrics (under 4 years)',
                notes: 'Strictly contraindicated in infants and young children under 4 years old. Applying menthol or peppermint oil directly onto or near the nostrils, face, or chest of an infant can trigger sudden, severe laryngeal or bronchial spasms, leading to acute respiratory arrest.'
            },
            {
                group: 'Geriatrics & Chronic Diseases',
                notes: 'Safe for elderly patients suffering from IBS, but contraindicated in individuals with severe gastroesophageal reflux disease (GERD) or hiatal hernia, as relaxation of the esophageal sphincter can exacerbate acid reflux.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Aqueous Infusion (Tea)',
                    dose: '1.5–3.0 g dried leaves in 150–200 mL boiling water, 10 min steep (covered vessel), 3× daily between or after meals.'
                },
                {
                    form: 'Enteric-Coated Oil Capsules',
                    dose: '0.2–0.4 mL standardized essential oil, 2–3× daily. Enteric coating mandatory.'
                },
                {
                    form: 'Topical Liquid',
                    dose: '10% menthol or peppermint oil in ethanol, applied gently over temples or unbroken skin.'
                },
                {
                    form: 'Steam Inhalation',
                    dose: '3–4 drops pure oil in hot water, inhale to clear respiratory pathways.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Leaves & Capsules',
                    storage: 'Store in airtight, light-resistant containers away from direct heat and moisture. Keep below 25°C to protect the volatile monoterpene profile from evaporation.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Peppermint oil is a great, natural remedy to rub on an infant\'s nose to help them breathe when they have a bad cold.',
                fact: 'Applying peppermint oil or menthol near an infant\'s nose can trigger life-threatening laryngeal spasms and reflex respiratory arrest. It must never be used on faces of children under 4 years old.'
            },
        ],
        marketedProducts: [
            {
                name: 'Colpermin Capsules (كولبرمين كبسولات - زيت نعناع فلفلي مغلف معوياً للقولون)',
                image: '/images/Peppermint-Dyspepsia-product.jpg'
            },
            {name: 'Sekem Peppermint Tea (سيكم نعناع)', image: ''},
            {name: 'Isis Peppermint Tea (إيزيس نعناع)', image: ''},
            {
                name: 'Menthol Crystals / Rubs (بلورات الميثول والدهانات الموضعية لتخفيف آلام الصداع والعضلات)',
                image: ''
            },
        ],
        benefits: [
            {
                icon: 'spa',
                title: 'IBS & Dyspepsia Relief',
                desc: 'Menthol\'s L-type Ca²⁺ channel blockade resolves painful intestinal spasms, postprandial fullness, and flatulence.'
            },
            {
                icon: 'thermostat',
                title: 'Visceral Analgesia via TRPM8',
                desc: 'TRPM8 cold receptor activation in GI nerve fibers induces cooling analgesia, desensitizing hyperalgesic visceral walls.'
            },
            {
                icon: 'water_drop',
                title: 'Choleretic & Digestive Aid',
                desc: 'Stimulates bile secretion, facilitating fat digestion and reducing functional dyspepsia.'
            },
            {
                icon: 'air',
                title: 'Respiratory Decongestant',
                desc: 'Volatile menthol thins mucus and relieves upper respiratory congestion via TRPM8 stimulation.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Aqueous Infusion (Tea)',
                desc: 'Infuse 1.5–3 g dried leaves in 150–200 mL boiling water in a tightly closed vessel for 10 minutes to retain volatile oils.',
                bestFor: 'Dyspepsia, flatulence, mild bloating'
            },
            {
                method: 'Enteric-Coated Oil Capsules',
                desc: '0.2–0.4 mL standardized essential oil capsules. Enteric coating prevents premature release in stomach.',
                bestFor: 'IBS, GI spasms, functional dyspepsia'
            },
            {
                method: 'Topical / Inhalation',
                desc: '10% menthol in ethanol for topical headache relief; 3–4 drops pure oil in hot water for steam inhalation.',
                bestFor: 'Tension headaches, respiratory congestion'
            },
        ],
    ...
    'chamomile-dyspepsia': {
        ...
        activeConstituents: [
            {
                name: 'Chamazulene',
                percentage: 'Formed from matricin during distillation',
                effect: 'Highly acclaimed anti-inflammatory, antioxidant, and antipyretic profile; imparts characteristic deep blue color to distilled oil'
            },
            {
                name: 'alpha-Bisabolol & Bisabolol Oxides A, B',
                percentage: '',
                effect: 'Profound direct antispasmodic action on GI smooth muscles; alongside significant antibacterial, antifungal, and skin-protective properties'
            },
            {
                name: 'Apigenin & Apigenin-7-glucoside',
                percentage: 'Predominant hydrophilic flavonoid',
                effect: 'Anxiolytic, mild sedative, and muscle relaxant properties via targeted central GABA-A benzodiazepine receptor binding'
            },
            {
                name: 'Luteolin & Quercetin',
                percentage: '',
                effect: 'Potent synergistic free radical scavenging, local tissue repair, and supplemental anti-inflammatory activity'
            },
            {
                name: 'Coumarins (Herniarin & Umbelliferone)',
                percentage: '',
                effect: 'Secondary antispasmodic and mild antifungal support within physiological therapeutic doses'
            },
        ],
        moa: [
            {
            ...
            {
                title: 'Anti-inflammatory & Tissue Repair Action',
                detail: 'Active chamazulene and alpha-bisabolol strongly suppress pro-inflammatory enzymes. They inhibit the synthesis of Prostaglandin E2 (PGE2) and downregulate the activity of cyclooxygenase-2 (COX-2) and 5-lipoxygenase (5-LOX) pathways. Additionally, they exhibit significant free radical scavenging actions, protecting cell membranes against lipid peroxidation.'
            },
            {
                title: 'Antispasmodic Gastrointestinal Effect',
                detail: 'Acts as a direct, non-specific relaxant on visceral smooth muscles. alpha-bisabolol and flavonoids diminish intestinal tone, decrease luminal hyper-motility, and exert an anti-peptic effect by protecting the gastric mucosa against mucosal damage.'
            },
            {
                title: 'Antimicrobial & Local Vulnerary Actions',
                detail: 'Topical essential oil constituents degrade bacterial and fungal cellular membranes, accelerating granulation, tissue epithelization, and minor wound healing.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Internal Aqueous Infusion (Chamomile Tea)',
                instruction: 'Steep 1.5 to 3.0 g of dried whole flower heads in 150–250 mL of boiling water in a sealed container for 10–15 minutes (crucial to prevent the escape of volatile essential oils). Administered 3 to 4 times daily as an anxiolytic or carminative.'
            },
            {
                method: 'Topical Wash or Compress',
                instruction: 'A prepared 3% to 10% aqueous infusion is applied locally using clean compresses, or applied as a sitz bath for perianal/genital mucosal inflammation.'
            },
            {
                method: 'Standardized Oral Capsules / Liquid Extracts',
                instruction: '200 to 500 mg standardized dry extract capsules (standardized to apigenin equivalents) or 1–4 mL of hydroethanolic fluid extract taken 3 times daily.'
            },
            {
                method: 'Steam Inhalation',
                instruction: 'Add 2 to 3 teaspoons of dried flowers or 2–4 drops of pure essential oil into a bowl of boiling water; deeply inhale the herbal steam for 5–10 minutes for respiratory relief.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Safe for consumption during pregnancy and lactation when limited strictly to standard dietary/culinary tea levels (1–2 cups per day). Large therapeutic doses, concentrated liquid extracts, and pure essential oils are strictly contraindicated due to structural emmenagogue qualities and theoretical risks of uterine stimulation.'
            },
            {
                group: 'Pediatrics',
                notes: 'Extremely safe for infants and toddlers when administered as a very mild, diluted aqueous infusion to alleviate infantile colic, teething distress, or mild restlessness. Pure, undiluted essential oils must never be applied near the face or ingested by infants.'
            },
            {
                group: 'Geriatrics',
                notes: 'Highly tolerated and safe for elderly populations, serving as an exceptional non-addictive herbal alternative to pharmaceutical sedatives (e.g., benzodiazepines) which carry significant fall and cognitive risks in the elderly.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Aqueous Infusion (Chamomile Tea)',
                    dose: '1.5–3.0 g dried whole flower heads in 150–250 mL boiling water, sealed container, 10–15 min. 3–4× daily as anxiolytic or carminative.'
                },
                {
                    form: 'Standardized Oral Capsules',
                    dose: '200–500 mg standardized dry extract (standardized to apigenin equivalents), 3× daily.'
                },
                {form: 'Hydroethanolic Fluid Extract', dose: '1–4 mL, 3× daily.'},
                {
                    form: 'Topical Wash or Compress',
                    dose: '3%–10% aqueous infusion applied locally using clean compresses or as a sitz bath.'
                },
                {
                    form: 'Steam Inhalation',
                    dose: '2–3 tsp dried flowers or 2–4 drops essential oil in boiling water; inhale deeply for 5–10 minutes.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Dried Flower Heads',
                    storage: 'Store in tightly sealed, light-resistant glass containers in a cool, dark, and dry environment. Protection from air and ambient light is critical to prevent the rapid oxidation, polymerization, and loss of volatile chamazulene and bisabolol oxides.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Chamomile tea can be safely used as an eye drop or wash to cure bacterial conjunctivitis and soothe eye redness.',
                fact: 'Applying chamomile infusions to the eyes is dangerous. Microscopic pollen particles and plant hairs remaining in the tea can cause severe allergic conjunctivitis, secondary corneal irritation, and exacerbate ocular inflammation.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Nervous Dyspepsia Relief',
                desc: 'Apigenin\'s GABA-A binding plus bisabolol\'s spasmolytic action resolve functional GI spasms and stress-related digestive discomfort.'
            },
            {
                icon: 'healing',
                title: 'Anti-inflammatory GI Protection',
                desc: 'Chamazulene and bisabolol inhibit COX-2 and 5-LOX, reducing mucosal inflammation and gastric irritation.'
            },
            {
                icon: 'bedtime',
                title: 'Mild Anxiolytic & Sleep Aid',
                desc: 'Apigenin competitively binds benzodiazepine receptors without withdrawal risks, easing anxiety and improving sleep onset.'
            },
            {
                icon: 'water_drop',
                title: 'Mucosal Healing',
                desc: 'Vulnerary and antimicrobial actions accelerate healing of aphthous ulcers, skin irritations, and GI mucosal damage.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Aqueous Infusion (Chamomile Tea)',
                desc: 'Steep 1.5–3.0 g dried flower heads in 150–250 mL boiling water in a sealed container for 10–15 minutes; sealing prevents loss of volatile oils.',
                bestFor: 'Nervous dyspepsia, GI spasms, anxiety, insomnia'
            },
            {
                method: 'Standardized Capsules',
                desc: '200–500 mg dry extract standardized to apigenin equivalents, 3× daily.',
                bestFor: 'IBS, functional digestive disorders, anxiety'
            },
            {
                method: 'Topical / Steam',
                desc: '3–10% aqueous infusion as compress or sitz bath; 2–4 drops oil in hot water for steam inhalation.',
                bestFor: 'Skin irritations, mucosal inflammation, respiratory congestion'
            },
        ],
    ...
    'fennel-dyspepsia': {
        ...
        activeConstituents: [
            {
                name: 'trans-Anethole (50–80%)',
                percentage: '50–80% of volatile oil',
                effect: 'Predominant constituent responsible for the characteristic sweet aroma, as well as its estrogenic, expectorant, and spasmolytic activities'
            },
            {
                name: 'Fenchone (5–20%)',
                percentage: '5–20%',
                effect: 'Bicyclic monoterpene ketone providing the bitter taste; contributes to antimicrobial properties; carries neurotoxic risks in high doses'
            },
            {
                name: 'Estragole / Methyl chavicol (3–20%)',
                percentage: '3–20%',
                effect: 'Natural phenylpropenoid requiring strict standardization due to potential genotoxic carcinogenicity concerns at isolated, massive doses'
            },
            {
                name: 'Phenolic Derivatives & Flavonoids',
                percentage: '',
                effect: 'Includes quercetin, kaempferol, and chlorogenic acid; provide systemic antioxidant support and cellular protection'
            },
        ],
        moa: [
            {
                title: 'Antispasmodic & Carminative Action',
                detail: 'Directly relaxes the intestinal smooth muscles. trans-anethole acts as a competitive calcium channel antagonist, reducing intracellular calcium influx and mitigating acetylcholine- and histamine-induced gastrointestinal spasms. This facilitates the expulsion of trapped gas and reduces luminal pressure.'
            },
            {
                title: 'Secretolytic & Expectorant Effect',
                detail: 'In the respiratory tract, volatile components stimulate the ciliated epithelium of the bronchial mucosa, increasing the production of fluid respiratory tract secretions and reducing mucus viscosity, which aids in ciliary clearance.'
            },
            {
                title: 'Estrogenic Modulation',
                detail: 'Compounds like trans-anethole and its polymers (such as dianethole) exhibit structural similarities to estrogen, weak binding to estrogen receptors, and stimulation of prolactin secretion.'
            },
            {
                title: 'Antimicrobial & Antifungal Action',
                detail: 'The essential oil components disrupt microbial cell membrane integrity, demonstrating notable in vitro bacteriostatic actions against common secondary pathogens.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Aqueous Infusion (Fennel Tea)',
                instruction: 'Steep 1.5 to 2.5 g of freshly crushed seeds in 150–200 mL of boiling water in a covered vessel for 10–15 minutes (to prevent the loss of volatile anethole). Take 3 times daily (Max: 7.5 g daily).'
            },
            {
                method: 'Standardized Oral Capsules',
                instruction: '200 to 400 mg of standardized dry extract or essential oil capsules, taken 2 to 3 times per day.'
            },
            {
                method: 'Pediatric Syrup / Aqueous Drops (for Colic)',
                instruction: 'Standardized aqueous extracts equivalent to 1–2 g of seeds daily for children over 4 years of age, or specialized lower doses for infants under strict medical supervision.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Pregnancy & Lactation',
                notes: 'Safe during lactation at standard culinary or mild infusion doses (supports milk production). However, the pure essential oil is strictly contraindicated during pregnancy due to potential emmenagogue and uterine-stimulating properties.'
            },
            {
                group: 'Pediatrics',
                notes: 'Pure essential oil must not be administered to infants or children under 4 years old due to potential central nervous system sensitivities to fenchone. Safe only when using strictly regulated, age-appropriate pediatric aqueous formulations.'
            },
            {
                group: 'Geriatrics & Chronic Diseases',
                notes: 'Hormone-Sensitive Conditions: must be avoided or used with extreme caution in patients with a history of breast cancer, uterine cancer, ovarian cancer, or endometriosis, due to the weak phytoestrogenic activity of anethole.'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Aqueous Infusion (Fennel Tea)',
                    dose: '1.5–2.5 g freshly crushed seeds in 150–200 mL boiling water, covered vessel, 10–15 min. 3× daily. Max 7.5 g daily.'
                },
                {
                    form: 'Standardized Oral Capsules',
                    dose: '200–400 mg standardized dry extract or essential oil capsules, 2–3× daily.'
                },
                {
                    form: 'Pediatric Syrup / Aqueous Drops',
                    dose: 'Standardized aqueous extracts equivalent to 1–2 g seeds daily for children over 4 years; lower specialized doses for infants under medical supervision.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Crushed / Whole Seeds & Standardized Capsules',
                    storage: 'Store in tightly sealed, airtight, and light-resistant containers in a cool, dry environment (below 25°C) to prevent the volatilization of anethole and degradation of active components.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Fennel essential oil is 100% safe for infants to swallow for colic since it\'s natural.',
                fact: 'Pure, undiluted fennel essential oil is highly concentrated and can be toxic to an infant\'s developing central nervous system; only specialized, ultra-diluted aqueous pediatric drops are clinically safe.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Dyspepsia & Flatulence Relief',
                desc: 'trans-Anethole\'s calcium channel antagonism relaxes GI smooth muscle, expelling trapped gas and relieving bloating and dyspeptic discomfort.'
            },
            {
                icon: 'child_care',
                title: 'Infantile Colic Management',
                desc: 'Clinically proven standardized aqueous extracts reduce crying time and abdominal spasms in infants.'
            },
            {
                icon: 'air',
                title: 'Respiratory Expectorant',
                desc: 'Volatile components stimulate bronchial ciliated epithelium, reducing mucus viscosity and aiding clearance of catarrh and productive coughs.'
            },
            {
                icon: 'water_drop',
                title: 'Galactagogue Support',
                desc: 'Estrogenic modulation via trans-anethole stimulates prolactin secretion, supporting breast milk production in lactating mothers.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Aqueous Infusion (Fennel Tea)',
                desc: 'Steep 1.5–2.5 g freshly crushed seeds in 150–200 mL boiling water in a covered vessel for 10–15 minutes; covering prevents anethole volatilization.',
                bestFor: 'Dyspepsia, flatulence, GI spasms, bloating'
            },
            {
                method: 'Standardized Capsules',
                desc: '200–400 mg standardized dry extract or essential oil capsules, 2–3× daily.',
                bestFor: 'Consistent dosing; respiratory support; lactation'
            },
            {
                method: 'Pediatric Aqueous Drops',
                desc: 'Specialized ultra-diluted aqueous extracts for infants with colic, under medical supervision.',
                bestFor: 'Infantile colic'
            },
        ],
    ...
    'peppermint-ibs': {
        ...
        activeConstituents: [
            {
                name: 'Menthol',
                percentage: 'Major component of the essential oil',
                effect: 'Natural calcium channel blocker on colonic smooth muscle; direct, dose-dependent antispasmodic effect; provides relief of abdominal pain, bloating, cramps, and gas in IBS'
            },
        ],
        moa: [
            {
                title: 'Calcium Channel Blockade (Antispasmodic)',
                detail: 'Menthol acts as a natural calcium channel blocker on the smooth muscle of the colon, leading to a direct, dose-dependent antispasmodic effect. This reduces colonic hypermotility and relieves abdominal pain, bloating, cramps, and gas associated with IBS.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Enteric-Coated Capsules (Preferred)',
                instruction: 'Administered as enteric-coated capsules to ensure the oil bypasses the stomach and is released directly in the intestines. 180 mg to 360 mg (approximately 0.2 mL to 0.4 mL) or 1–2 capsules, three times daily. Must be administered strictly in enteric-coated capsules.'
            },
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Pediatrics',
                notes: 'Use with extreme caution; avoid in infants and very young children due to the risk of respiratory depression and laryngospasm from menthol.'
            },
            {
                group: 'Pregnancy & Lactation',
                notes: 'Considered safe in standard culinary / food amounts; medical supervision is advised for concentrated medicinal oils.'
            },
            {
                group: 'Chronic Diseases',
                notes: 'Use with caution in patients with GERD or hiatal hernia (may relax the lower esophageal sphincter, exacerbating reflux).'
            },
        ],
        dosage: {
            ...
            forms: [
                {
                    form: 'Enteric-Coated Capsules',
                    dose: '180–360 mg (0.2–0.4 mL), or 1–2 capsules, 3× daily. Must be enteric-coated — swallow whole, do not crush or chew.'
                },
        ...
        storage: {
            forms: [
                {
                    form: 'Enteric-Coated Capsules',
                    storage: 'Store in a cool, dry place (< 25°C) away from direct sunlight.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Drinking regular peppermint tea is just as effective as enteric-coated capsules for IBS.',
                fact: 'Enteric-coated capsules are clinically superior for IBS because they target the colon directly without causing gastric irritation or heartburn. Peppermint oil is one of the few herbal medicines with high-quality clinical evidence (Level A recommendation) for short-term IBS symptom relief.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Level A Evidence for IBS',
                desc: 'One of the few herbal medicines with high-quality clinical evidence (Level A recommendation) for short-term IBS symptom relief.'
            },
            {
                icon: 'air',
                title: 'Colonic Smooth Muscle Relaxant',
                desc: 'Menthol\'s calcium channel blockade delivers direct, dose-dependent antispasmodic relief targeting the colon.'
            },
            {
                icon: 'bubble_chart',
                title: 'Relieves IBS Symptoms',
                desc: 'Provides symptomatic relief of abdominal pain, bloating, cramps, and gas associated with IBS.'
            },
        ],
        botanicalFacts: {
            origin: 'Hybrid species (Mentha aquatica × Mentha spicata). Family: Lamiaceae.',
        ...
        preparation: [
            {
                method: 'Enteric-Coated Capsules',
                desc: 'Pharmaceutical-grade enteric-coated capsules ensuring oil release directly in the intestines, bypassing the stomach.',
                bestFor: 'IBS — clinically superior delivery for colonic targeting'
            },
            {
                method: 'Herbal Tea',
                desc: 'Aqueous infusion of dried peppermint leaves for mild symptomatic relief.',
                bestFor: 'Mild IBS symptoms'
            },
        ],
    ...
    'ginger-ibs': {
        ...
        activeConstituents: [
            {
                name: 'Gingerols',
                percentage: '',
                effect: 'Primary active compounds; peripheral 5-HT3 receptor antagonist (anti-emetic); modulate cholinergic/5-HT4 receptors for prokinetic and intestinal motility regulation; anti-inflammatory in GI mucosa'
            },
            {
                name: 'Shogaols',
                percentage: '',
                effect: 'Formed from gingerols upon drying or heating; contribute to anti-emetic, prokinetic, and anti-inflammatory activities'
            },
        ],
        moa: [
            {
                title: 'Peripheral 5-HT3 Receptor Antagonism (Anti-emetic)',
                detail: 'Gingerols and shogaols act as peripheral 5-HT3 receptor antagonists, providing potent anti-emetic effects by blocking serotonin-mediated emetic signals in the GI tract.'
            },
            {
                title: 'Cholinergic / 5-HT4 Modulation (Prokinetic)',
                detail: 'Modulates cholinergic and 5-HT4 receptors to stimulate gastric emptying and regulate intestinal motility, producing a prokinetic effect that accelerates gastric emptying by stimulating the antrum and corpus of the stomach.'
            },
            {
                title: 'Anti-inflammatory Activity in the GI Mucosa',
                detail: 'Possesses anti-inflammatory activities in the GI mucosa, reducing local mucosal inflammation contributing to functional dyspepsia and nausea associated with IBS.'
            },
        ],
        uses: [
        ...
        howToUse: [
            ...
            {
                method: 'Standardized Capsules',
                instruction: '1 g to 2 g of dried powder or standardized extract daily, divided into multiple doses.'
            },
        ...
        suitableAgeGroups: [
            ...
            {
                group: 'Pregnancy',
                notes: 'Commonly used for pregnancy-induced nausea and morning sickness. Must be strictly limited to a maximum of 1 g/day of dried extract under medical guidance.'
            },
        ...
        factsAndMyths: [
            {
                myth: 'Ginger can "cure" IBS.',
                fact: 'Ginger is a powerful prokinetic agent that accelerates gastric emptying by stimulating the antrum and corpus of the stomach. However, it only helps manage specific secondary symptoms like bloating, nausea, and dyspepsia rather than correcting the underlying gut-brain axis disorder.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'Powerful Prokinetic Agent',
                desc: 'Accelerates gastric emptying by stimulating the antrum and corpus of the stomach, improving digestive motility.'
            },
            {
                icon: 'water_drop',
                title: 'Anti-emetic Relief',
                desc: 'Peripheral 5-HT3 receptor antagonism provides potent anti-emetic effects, reducing nausea associated with IBS.'
            },
            {
                icon: 'healing',
                title: 'GI Mucosal Anti-inflammatory',
                desc: 'Reduces local mucosal inflammation contributing to functional dyspepsia co-existing with IBS.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Standardized Capsules',
                desc: '1–2 g dried powder or standardized extract daily, divided into multiple doses.',
                bestFor: 'Nausea, dyspepsia, IBS secondary symptoms'
            },
            {
                method: 'Herbal Infusion (Tea)',
                desc: 'Fresh or dried ginger root steeped in hot water.',
                bestFor: 'Mild nausea, GI comfort'
            },
        ],
    ...
    'psyllium-ibs': {
        ...
        activeConstituents: [
            {
                name: 'Mucilage (Soluble, Gel-forming Polysaccharide Fiber)',
                percentage: '',
                effect: 'Bulk-forming agent; absorbs water in the intestinal lumen forming a viscous gel; normalizes stool consistency in both IBS-C and IBS-D'
            },
        ],
        moa: [
            {
                title: 'Bulk-Forming (Normalizes Stool Consistency)',
                detail: 'Psyllium mucilage absorbs water in the intestinal lumen to form a viscous gel. This action normalizes stool consistency: it softens hard stool in IBS-C (Constipation) and delays gastric emptying while adding bulk to loose stools in IBS-D (Diarrhea).'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Powder or Husks in Water / Juice',
                instruction: 'Mix powder or husks thoroughly into a full glass of water or juice (at least 250 mL), followed immediately by drinking an extra glass of water to ensure proper hydration.'
            },
        ],
        suitableAgeGroups: [
            ...
            {
                group: 'Pregnancy',
                notes: 'Completely safe; it acts locally and is the preferred, non-absorbable choice for pregnancy-induced constipation.'
            },
        ...
        dosage: {
            ...
            forms: [
                {
                    form: 'Powder / Husks',
                    dose: '5–10 g mixed in at least 250 mL water or juice, 1–3× daily. Start at low doses. Follow immediately with an extra glass of water.'
                },
            ],
        },
        overdose: {
        ...
        storage: {
            forms: [
                {
                    form: 'Powder / Husks',
                    storage: 'Store in a dry environment in tightly sealed containers to prevent premature moisture absorption and clumping.'
                },
            ],
        },
        factsAndMyths: [
            {
                myth: 'Psyllium can be safely swallowed dry or in capsule form with minimal water.',
                fact: 'This is a dangerous practice that can cause acute esophageal obstruction or severe choking. Soluble fiber (Psyllium) is highly recommended and well-tolerated by IBS patients, whereas insoluble fiber (e.g., wheat bran) can severely exacerbate abdominal pain and bloating.'
            },
        ],
        marketedProducts: [
        ...
        benefits: [
            {
                icon: 'spa',
                title: 'First-Line IBS Management',
                desc: 'Highly recommended and well-tolerated by IBS patients as a first-line dietary intervention for normalizing bowel habits.'
            },
            {
                icon: 'healing',
                title: 'Normalizes Stool in Both IBS-C and IBS-D',
                desc: 'Viscous gel softens hard stool in IBS-C and adds bulk to loose stools in IBS-D — addressing both extremes.'
            },
            {
                icon: 'water_drop',
                title: 'Safe in Pregnancy',
                desc: 'Acts locally, non-absorbable, and is the preferred choice for pregnancy-induced constipation.'
            },
        ],
        botanicalFacts: {
        ...
        preparation: [
            {
                method: 'Powder / Husks in Water',
                desc: 'Mix 5–10 g thoroughly in at least 250 mL water or juice; drink immediately followed by an extra glass of water. Never swallow dry.',
                bestFor: 'IBS-C (constipation), IBS-D (diarrhea), alternating IBS'
            },
        ],
    ...
    'uva-ursi-antiseptic': {
        ...
        moa: [
            {
                title: 'Urine Alkalinity',
                detail: 'The hydrolysis of arbutin conjugates into active hydroquinone is most effective and efficient in an alkaline urinary environment (pH > 7).'
            },
            {
                title: 'Tannin Astringency',
                detail: 'Uva Ursi is also rich in tannins, which provide an astringent effect. These compounds help tone and soothe inflamed mucosal tissues in the urinary tract.'
            },
            {
                title: 'Diuretic Action',
                detail: 'The plant possesses mild diuretic properties, which increase urine flow and promote the flushing of bacteria out of the urinary system.'
            },
        ],
        uses: [
        ...
        howToUse: [
            {
                method: 'Dried Leaf (Tea/Infusion)',
                instruction: 'Dried leaves are typically steeped in boiling water for 15 to 30 minutes.'
            },
            {method: 'Liquid Tincture', instruction: 'Liquid preparations are often mixed with water.'},
            {
                method: 'Standardized Extract',
                instruction: 'Capsules or tablets are available, often standardized for their arbutin content.'
            },
        ],
        suitableAgeGroups: [
        ...
        storage: {
            forms: [
                {
                    form: 'All Uva Ursi Forms',
                    instructions: 'Store Uva Ursi in a cool, dry place away from direct sunlight (under 25°C) and keep out of reach of children.'
                },
            ],
        },
        marketedProducts: [
        ...
        references: [
            ...
            {
                text: 'EDAE Egypt — Arctostaphylos uva-ursi monograph.',
                url: 'https://dev.edaegypt.gov.eg/media/krehbcjl/arctostaphylos-uva-ursi_1.pdf'
            },
            {
                text: 'WebMD — Uva Ursi supplement information.',
                url: 'https://www.webmd.com/vitamins/ai/ingredientmono-350/uva-ursi'
            },
        ],
    },
    ...
    'cranberry-antiseptic': {
        ...
        moa: [
            {
                title: 'Inhibition of E. coli Adhesion (Anti-Adhesion Activity)',
                detail: 'The active compounds, specifically A-type proanthocyanidins (PACs), interfere with the ability of P-fimbriated Escherichia coli (E. coli) to attach to the epithelial cells lining the urinary tract.'
            },
            {
                title: 'Structural Disruption of Fimbriae',
                detail: 'Cranberry constituents may change the conformation of surface molecules on E. coli and interfere with fimbrial adhesion mechanisms.'
            },
            {
                title: 'Fructose Inhibition',
                detail: 'Fructose present in cranberries acts in conjunction with PACs to inhibit the adhesion of type 1 pili to the bladder wall.'
            ...
            {
                title: 'Direct Antibacterial and Anti-inflammatory Effects',
                detail: 'Beyond adhesion prevention, components of cranberry demonstrate direct antibacterial activity against various uropathogens and possess antioxidant properties that reduce inflammation caused by infections.'
            },
            {
                title: 'Modification of Urinary Environment',
                detail: 'Metabolites from ingested cranberry, when excreted in urine, decrease the adherence capacity of E. coli and other Gram-negative bacteria to uroepithelial cells.'
        ...
        howToUse: [
            ...
            {
                method: 'Capsules or Tablets',
                instruction: 'If you take supplements, follow the specific dosing instructions on the packaging.'
            },
            {
                method: 'Timing',
                instruction: 'Consume cranberry products in the morning and evening to maintain a consistent bacterial anti-adhesion effect.'
            },
        ],
        suitableAgeGroups: [
            {
                group: 'Children (2 years and older)',
                notes: 'Cranberry juice or cranberry products may be used in age-appropriate amounts under adult supervision.'
            },
            {
                group: 'Adolescents and Adults',
                notes: 'Commonly used for prevention of recurrent urinary tract infections (UTIs).'
            },
            {
                group: 'Pregnant Women',
                notes: 'Generally considered safe in moderate dietary amounts and commonly used for urinary tract health support.'
            },
            {
                group: 'Elderly Patients',
                notes: 'May be used for recurrent UTI prevention with monitoring for potential drug interactions (especially Warfarin).'
            },
        ],
        dosage: {
            forms: [
                ...
                {
                    form: 'Cranberry Capsules/Tablets',
                    dose: 'Commonly standardized to provide 36 mg of A-type proanthocyanidins (PACs) daily, the amount most frequently studied for prevention of recurrent UTIs.'
                },
        ...
        storage: {
            forms: [
                ...
                {
                    form: 'Dried Cranberry Products',
                    instructions: 'Keep in a cool, dry place away from moisture and direct sunlight in a tightly closed container.'
                },
                {
                    form: 'Cranberry Juice',
                    instructions: 'Refrigerate after opening and consume according to the manufacturer\'s instructions.'
                },
                {
                    form: 'Cranberry Capsules/Tablets',
                    instructions: 'Store at room temperature (15–25°C) in a dry place away from heat, humidity, and direct light.'
                },
            ],
        },
        marketedProducts: [
        ...
        references: [
            ...
            {
                text: 'ScienceDirect — Cranberry polyphenols and health.',
                url: 'https://www.sciencedirect.com/science/article/pii/S2405456924001226'
            },
            {
                text: 'PubMed — Cranberry supplementation for recurrent UTIs.',
        ...
        subcategories: [
            {
                ...
                description: 'Support for cycle regulation and hormonal balance.',
                image: '/images/categories/sub-menstrual.jpeg',
                plants: ['ginger-menstrual', 'cinnamon-menstrual', 'dill-seed-menstrual']
            },
            {
                id: 'pregnancy-support',
                name: 'Pregnancy Support Plants',
                description: 'Gentle, nourishing botanicals for expectant mothers.',
                image: '/images/categories/sub-pregnancy.jpeg',
                plants: ['ginger-pregnancy', 'psyllium-pregnancy', 'peppermint-pregnancy', 'cranberry-pregnancy']
            },
            {
                id: 'breast-feeding',
                name: 'Breast Feeding Support Plants',
                description: 'Herbs to support lactation and nursing.',
                image: '/images/categories/sub-breastfeeding.jpeg',
                plants: ['fenugreek-breastfeeding', 'fennel-breastfeeding', 'moringa-breastfeeding']
            },
            {
                id: 'hair-care',
                name: 'Hair Care Plants',
                description: 'Botanical extracts for scalp health and hair vitality.',
                image: '/images/categories/sub-hair-care.jpeg',
                plants: ['aloe-vera-hair', 'rocket', 'rosemary-hair', 'garlic']
            },
            {
                id: 'skin-care',
                name: 'Skin Care Plants',
                description: 'Botanicals for a radiant, healthy complexion.',
                image: '/images/categories/sub-skin-care.jpeg',
                plants: ['aloe-vera', 'licorice', 'tea-tree', 'green-tea']
            },
        ],
    },
    {
        ...
        subcategories: [
            {
                id: 'constipation-relief',
                name: 'Constipation Relief Plants',
                description: 'Support healthy bowel motility and regularity.',
                image: '/images/categories/sub-constipation.jpeg',
                plants: ['senna-constipation', 'psyllium-constipation', 'castor-constipation']
            },
            {
                id: 'diarrhea-support',
                name: 'Diarrhea Support Plants',
                description: 'Astringent herbs to soothe and settle the tract.',
                image: '/images/categories/sub-diarrhea.jpeg',
                plants: ['peppermint-diarrhea', 'chamomile-diarrhea', 'fennel-diarrhea']
            },
            {
                id: 'dyspepsia',
                name: 'Dyspepsia',
                description: 'Herbal relief for indigestion and stomach discomfort.',
                image: '/images/categories/sub-dyspepsia.jpeg',
                plants: ['peppermint-dyspepsia', 'chamomile-dyspepsia', 'fennel-dyspepsia']
            },
            {
                id: 'ibs',
                name: 'IBS',
                description: 'Calming carminatives to manage IBS symptoms.',
                image: '/images/categories/sub-ibs.jpeg',
                plants: ['peppermint-ibs', 'ginger-ibs', 'psyllium-ibs']
            },
        ],
    },
    {
        ...
        subcategories: [
            {
                id: 'cold',
                name: 'Cold',
                description: 'Herbs to ease cold symptoms and speed recovery.',
                image: '/images/categories/sub-cold.jpeg',
                plants: ['eucalyptus', 'ginger-cold']
            },
            {
                id: 'rhinitis',
                name: 'Rhinitis',
                description: 'Botanical support for nasal inflammation and runny nose.',
                image: '/images/categories/sub-rhinitis.jpeg',
                plants: ['butterbur', 'stinging-nettle', 'black-seed-rhinitis']
            },
            {
                id: 'sinusitis',
                name: 'Sinusitis',
                description: 'Clear congestion and sinus pressure naturally.',
                image: '/images/categories/sub-sinusitis.jpeg',
                plants: ['pelargonium', 'eucalyptus', 'black-elderberry']
            },
            {
                id: 'cough',
                name: 'Cough',
                description: 'Soothing herbs for irritated throats and airways.',
                image: '/images/categories/sub-cough.jpeg',
                plants: ['guava', 'anise', 'thyme', 'licorice-cough']
            },
        ],
    },
    {
        ...
        subcategories: [
            {
                id: 'immune-boosting',
                name: 'Immune Boosting Plants',
                description: 'Deep immune system support with powerful botanicals.',
                image: '/images/categories/sub-immune-boosting.jpeg',
                plants: ['echinacea-immunity', 'black-seed-immunity', 'astragalus-immunity']
            },
            {
                id: 'anti-inflammatory',
                name: 'Anti-Inflammatory Plants',
                description: 'Modulate the inflammatory response naturally.',
                image: '/images/categories/sub-anti-inflammatory.jpeg',
                plants: ['turmeric-immunity', 'rosemary-immunity', 'garlic-immunity']
            },
        ],
    },
    {
        ...
        subcategories: [
            {
                id: 'anti-septic',
                name: 'Anti-Septic Plants',
                description: 'Antimicrobial botanicals for urinary tract antisepsis.',
                image: '/images/categories/sub-antiseptic.jpeg',
                plants: ['uva-ursi-antiseptic', 'cranberry-antiseptic']
            },
            {
                id: 'diuretics',
                name: 'Diuretic Plants',
                description: 'Aquaretic herbs that flush the urinary tract naturally.',
                image: '/images/categories/sub-diuretics.jpeg',
                plants: ['dandelion', 'parsley', 'halfabar']
            },
            {
                id: 'bph',
                name: 'BPH Support Plants',
                description: 'Phytomedicines for benign prostatic hyperplasia management.',
                image: '/images/categories/sub-bph.jpeg',
                plants: ['saw-palmetto', 'stinging-nettle-root', 'pygeum']
            },
        ],
    },
];
